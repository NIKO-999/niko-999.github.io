...
window.DMPrograms = (function () {
  ...
  const programs = [
...

    {
      ...
      name: 'Pride',
      category: 'Social Status & Self-Worth',
      title: `Pride ‚Äî 6-5-17`,
      tagline: `A Design of Unbought Worth`,
      mastery: `Your worth doesn't need a witness. You know what you value and you act from it, full stop ‚Äî you're not performing integrity for anyone watching. That's real dignity, the kind that doesn't need defending because it was never up for debate in the first place.`,
    ...
    // ── INTELLECTUAL & MINDSET ALIGNMENT ──────────────────────────────────────

    {
      numbers: [17, 22, 5],
      name: 'Academic Knowledge / Rigid Dogma',
      category: 'Intellectual & Mindset Alignment',
      title: `Academic Knowledge / Rigid Dogma ‚Äî 17-22-5`,
...

    {
      ...
      category: 'Intellectual & Mindset Alignment',
      title: `Displacement / In Someone Else's Place ‚Äî 8-13-5`,
      ...
      shadow: `You feel like a guest in your own life ‚Äî like the seat could be taken back the second someone realizes you don't belong. You keep reshaping yourself to fit wherever you land until you lose track of which version is actually you. Waiting to be found out costs you the authority you've already earned.`,
      invitation: `Say "this is mine" about something you've been quietly treating as borrowed ‚Äî a role, a title, a relationship. Say it out loud, even just to yourself. Stop waiting for permission you already have.`,
    },
...

    {
      ...
      category: 'Abundance & Financial Flow',
      title: `The Revenge Pattern ‚Äî 9-14-5`,
      tagline: `A Design of the Unpaid Debt`,
      mastery: `You can turn an injustice into forward motion instead of retaliation. You see the whole arc a grievance sits inside, not just the sting of the moment ‚Äî and letting it go doesn't cost you anything, it's actually the win. You're not bound to anyone who hurt you by a debt you're still trying to collect.`,
      ...
      invitation: `Pick the one grudge you've been carrying longest. Write down exactly what you're still waiting for from that person. Then ask yourself honestly if you're actually going to get it ‚Äî and if not, let the waiting stop today.`,
    },
...

    {
      ...
      title: `The Love Addict ‚Äî 6-15-3`,
...

    {
      ...
      title: `Physical Suffering ‚Äî 3-18-12`,
      tagline: `A Design Built on an Old Wound`,
      mastery: `You know how to survive something hard and keep functioning. You don't fall apart, you carry it, and that resilience is real ‚Äî most people would have folded under what you've been through. You've turned pain into proof that you can handle anything.`,
      shadow: `You never actually let the wound close, because some part of you doesn't know who you are without it. You lead with the hardship. You keep the story current in rooms that have nothing to do with it. And when things are finally going well, it feels wrong instead of earned ‚Äî because wellness threatens the only identity you've built in years.`,
...

    {
      ...
      category: 'Relationship & Love',
      title: `The Invisible Partner ‚Äî 2-11-9`,
      tagline: `A Design of the Unreturned Gaze`,
      mastery: `You see people with real precision ‚Äî what they need before they say it, what's true underneath what's performed. You hold space better than almost anyone, and you do it without needing credit. That's genuine emotional skill, not just niceness.`,
      shadow: `You give everyone else your full attention and you've stopped expecting it back. You pick people who take without noticing they're taking, because staying half-hidden feels safer than being fully seen and possibly rejected. You know exactly how one-sided it's gotten, and you never say it out loud ‚Äî until it comes out sideways, as sudden distance or sudden anger nobody saw coming.`,
...

    {
      ...
      category: 'Health & Vitality',
      title: `The Self-Dissolution Pattern ‚Äî 18-9-4`,
      tagline: `A Design of the Steady Shore`,
      mastery: `You can sit in someone else's crisis, or your own deep feeling, without drowning in it. Most people either shut the feeling down or get completely swept away by it. You do neither ‚Äî you stay standing while the wave moves through, which is exactly why people trust you in the hardest moments.`,
      shadow: `You disappear inside whatever you're feeling, or whoever you're caring for, until there's no "you" left in the room. You call it empathy. It's actually erasure. And underneath it, you start believing this is just permanent ‚Äî "this is how it is" ‚Äî instead of something that's actually moving through and will pass.`,
...

    {
      ...
      category: 'Health & Vitality',
      title: `The Burnout Spiral ‚Äî 16-7-14`,
      tagline: `A Design of Relentless Output`,
      mastery: `You can push through what would stop most people cold ‚Äî illness, exhaustion, loss ‚Äî and keep moving forward without missing a beat. That drive is real, and it's rare. You get more done in a hard month than most people manage in a good year.`,
      shadow: `You've gotten so good at ignoring the warning signs that you don't notice them anymore. You keep going until your body makes the decision for you, because stopping voluntarily feels like failure instead of intelligence. Your identity is built entirely on output, so the moment you're not producing, you don't know who you are ‚Äî and that fear is exactly what keeps driving you into the wall.`,
...

    {
      ...
      category: 'Health & Vitality',
      title: `The Chronic Resistance ‚Äî 13-4-8`,
      tagline: `A Design of the New Foundation`,
      mastery: `You don't fight change, you build the thing that lets it land safely. You can hold the scariest part of transformation ‚Äî the part where the old form is gone and the new one isn't solid yet ‚Äî and actually construct something in that gap instead of panicking through it.`,
      shadow: `The instant real change shows up, you dig in. You use your own strength to defend a structure that's already dead instead of building the one that's supposed to replace it. Change happens to you anyway ‚Äî just slower, messier, and harder than it needed to be, because you spent your energy holding the door instead of walking through it.`,
      invitation: `Name one thing in your life you're defending purely out of habit, not because it's still working. Take one real step toward letting it go this week ‚Äî not researching it, not thinking about it. An actual step.`,
    },
...

    {
      ...
      title: `The Trailblazer ‚Äî 1-10-19`,
      tagline: `A Design of the First Move`,
      mastery: `You go first. Nobody has to validate the direction before you move in it ‚Äî you generate it from nothing, you read timing like a second language, and people follow you because your confidence is obviously real, not performed. Most people wait for a map. You draw one just by walking.`,
      shadow: `You're addicted to starting and allergic to staying. The moment a project gets unglamorous ‚Äî the maintenance, the slow middle ‚Äî you call it "the timing shifting" and you're gone, chasing the next beginning instead of finishing the one you're in. Nothing you build ever compounds, because you've never once stayed long enough to let it.`,
...

    {
      ...
      category: 'Purpose & Mission',
      title: `The Awakening Teacher ‚Äî 20-11-2`,
      tagline: `A Design of Lived Knowledge`,
      mastery: `You see people with total clarity ‚Äî their actual state, their actual potential, the exact gap between the two ‚Äî and that perception changes whoever's on the receiving end of it. You don't teach from a book. You teach from what you've actually survived, which is why it lands.`,
      shadow: `You're hardest on the exact flaw in other people that you haven't fixed in yourself. Your standards go rigid where they should stay human, and compassion gets crowded out by precision. You perform having it figured out instead of admitting you're still in it ‚Äî and that performance is the one thing standing between you and the people you're actually trying to reach.`,
...

    {
      ...
      category: 'Purpose & Mission',
      title: `The Artist's Sacrifice ‚Äî 21-12-3`,
      tagline: `A Design of the Withheld Work`,
      mastery: `You have real mastery in you ‚Äî actual creative depth, not a hobby, an entire language you were built to speak. When you do share your work, it carries weight, because it comes from a well that's genuinely full, not from someone faking confidence they don't have.`,
      shadow: `You're always almost ready, and you've been almost ready for years. You call it standards. It's actually fear wearing a costume ‚Äî you'd rather stay unseen and theoretical than risk being seen and ordinary. Your best work sits in a drawer while you wait for a feeling of "ready" that was never going to arrive on its own.`,
