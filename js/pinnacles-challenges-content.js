...
window.DPinnaclesContent = (function () {
  ...
  const pinnacles = {
    ...
    9: {
      ...
      shadow: `The risk of a stage like this is clinging to what it's actually trying to close, prolonging an ending that's already quietly begun. Resisting a closing chapter doesn't stop it from closing — it just makes the closing harder. Old identities or commitments may start to feel like they no longer fit, and holding on past that point can cost more than the ending itself ever would have. The discomfort of letting go can feel like evidence the chapter isn't actually finished, when it's often the opposite.`,
...
window.DChallengesContent = (function () {
  ...
  const challenges = {
    ...
    4: {
      ...
      shadow: `The risk of this challenge is abandoning genuinely solid work right before it would have actually paid off, mistaking the difficulty of the unglamorous middle for proof that you're on the wrong path entirely, when the difficulty was simply part of the route. You may feel a strong pull to quit right around the point where progress becomes invisible, and long stretches without visible reward can feel disproportionately discouraging. The absence of feedback can feel identical to the absence of progress, even when the two have nothing to do with each other. The timing of a quit rarely announces itself as a mistake until well after the fact.`,
    ...
    7: {
      ...
      shadow: `The risk of this challenge is over-analyzing a genuinely real instinct into total silence, waiting for a certainty that this particular kind of knowing was simply never going to offer you. Genuine hunches likely get talked out of existence before you act on them, and certainty probably feels safer to you than trusting an unproven instinct, even a strong one. The demand for proof can quietly function as a way of never having to act on what you already sense. The window for acting on a hunch tends to close well before the proof would ever have arrived.`,
