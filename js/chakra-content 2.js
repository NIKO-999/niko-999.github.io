  ...
  const nodes = {
    ...
    muladhara: {
      1: {
        ...
        shadow: `The risk is a root system with no roots, safety that exists only while you're actively producing it, so the moment your momentum pauses, the ground feels like it's disappearing too. Underneath the compulsive need to always have a project moving is often a genuine fear that stillness means the floor drops out, not ambition. A quiet week doesn't feel peaceful, it feels precarious, because a nervous system that's learned, accurately, that this particular ground disappears the moment you stop making it.`,
      ...
      3: {
        ...
        shadow: `The risk is grounding yourself entirely in what you provide for others, so your own safety quietly becomes contingent on being needed. If the nurturing stops being required, the ground can feel like it's going with it. Your own environment, your comfort, your rest, your fed and warm body, gets tended last, if at all, because the security system runs almost entirely outward.`,
      ...
      5: {
        ...
        shadow: `The risk is a security that collapses the moment the framework is questioned, because your ground was never separated from the institution itself. Doubting the tradition, even in small, reasonable ways, produces a disproportionate sense of unsafety, as though the structure and your own footing were the same thing rather than related but distinct. You avoid examining the structure too closely, not from blind loyalty but from an accurate fear that your footing depends on not looking.`,
      ...
      12: {
        ...
        shadow: `The risk is that this capacity for surrender tips into passivity, where you stop acting on things that are actually within your control because you've generalized "let go" into "do nothing." You've stayed too long in situations that needed your intervention, mistaking the wisdom of release for a reason not to act. That leaves you technically at peace and practically stuck.`,
      ...
      16: {
        ...
        shadow: `The risk is staying braced for the next collapse indefinitely, so genuine current stability never gets to register as safe, you're too busy scanning for the next sudden failure to actually stand on the ground you've already rebuilt. You can't fully trust anything that hasn't already been tested by falling apart once. That keeps you defended against a threat that isn't currently present.`,
      ...
      17: {
        ...
        mastery: `That hope genuinely grounds you, though you likely keep it deliberately small, protecting it from disappointment by never letting it get too big or too loud. You're capable of letting your hope be fully sized, without the protective downgrade. Your sense of safety can have more substance once the hope underneath it is no longer deliberately kept small.`,
