...
window.DTalentContent = (function () {
  ...
  const positions = {
    ...
    personal: {
      1: {
        heading: `You Present Yourself by Simply Starting`,
        why: `Your self-expression in this lifetime is decisive and immediate — you're known by what you initiate, not by what you deliberate about. People read your identity through your actions the moment you take them, often before you've said anything about your intentions at all.`,
        shadow: `The risk is that people only get to know the mover, never the reasoning behind the moves, so your social presence reads as capable but somewhat opaque, since you rarely narrate the why behind the what.`,
        blocks: `What can block this talent: acting without ever explaining the reasoning, leaving your social presence capable but hard to actually know.`,
        path: `Try narrating the why behind one action, out loud, before or after you take it. You are allowed to be known for your reasoning, not just your results. What have you done recently that people never actually understood the motive for?`,
        positive: `You still present yourself through decisive action — that hasn't changed and it's still how people first know you — but you've started narrating the reasoning behind at least some of it, letting people know the mover and the motive. Your social presence has depth now, not just visible capability.`,
        negative: `Your self-expression stays almost entirely in the doing, so people know your actions without ever really knowing your reasoning, leaving your social presence capable but genuinely opaque. You might notice people trust your competence and still feel they don't quite know you.`,
      },
      2: {
        heading: `You Present Yourself Carefully, Revealing Only What's Been Earned`,
        why: `Your self-expression in this lifetime is deliberately selective — you're known by what you choose to reveal, and the revealing itself is a considered act, not an accident. This gives your social presence a real, felt depth: people sense there's more, and that sense is accurate.`,
        shadow: `The risk is that the selectivity becomes so complete that almost no one actually gets past the surface, so your social presence stays intriguing but essentially unknown, even to people who've genuinely earned more access.`,
        blocks: `What can block this talent: keeping the selectivity so tight that even people who've earned more access rarely get it.`,
        path: `Try revealing something real to one person who's already shown they can be trusted with it. You are allowed to let someone in faster than feels automatic. Who has already earned a level of access they're not currently getting?`,
        positive: `Your careful, considered way of presenting yourself is still real and still protects something genuine — that hasn't changed — but you've let someone who's earned it in a little further, at least once. Your social presence still carries real depth; it's just accessible now to the people who've actually proven trustworthy.`,
        negative: `Your selective self-presentation is genuine, and it's staying so tightly closed that even people who've earned more access rarely get it. You might notice someone trustworthy still only knows the surface of you, simply because the selectivity never actually opened for them.`,
      },
      3: {
        heading: `You Present Yourself Through What You Provide`,
        why: `Your self-expression in this lifetime shows through generosity and care — people know you by what you make for them, how you tend to them, the warmth you generate in a room. That's genuine self-expression, embodied in giving rather than only in speaking.`,
        shadow: `The risk is that people know the giver so thoroughly that they never get introduced to your own needs or opinions, so your social identity becomes almost entirely defined by what you do for others.`,
        blocks: `What can block this talent: being known almost entirely for what you provide, with your own needs and opinions staying largely invisible.`,
        path: `Try presenting an opinion or a need, plainly, without wrapping it in something you're providing. You are allowed to be known for what you want, not just what you give. What have you never said because you were too busy being useful?`,
        positive: `You're still known for your generosity and care — that's real and it's not diminishing — but you've stated an opinion or a need plainly at least once, without wrapping it in something you were providing. People know more of you now, not just what you do for them.`,
        negative: `Your self-expression stays almost entirely in what you provide, so people know the giver thoroughly and rarely meet your own needs or opinions. You might notice you're deeply appreciated and only partially known, because your own wants have stayed quietly offstage.`,
      },
      4: {
        heading: `You Present Yourself as Someone in Command`,
        why: `Your self-expression in this lifetime carries real authority — people know you as someone capable of structure and direction, and that read tends to be accurate. You're identified by your competence at holding things together.`,
        shadow: `The risk is that this authoritative presentation leaves little room for people to see you uncertain or in need, so your social identity becomes the capable one, permanently, even in moments that would benefit from being seen otherwise.`,
        blocks: `What can block this talent: being seen only as capable and in-command, with little room left to be seen uncertain or in need.`,
        path: `Try letting one moment of genuine uncertainty be visible, rather than defaulting to the capable presentation. You are allowed to be known as more than the person in charge. Where have you performed competence when you actually needed something else to be seen?`,
        positive: `You're still genuinely known as someone capable of real authority and structure — that hasn't changed — but you've let a moment of real uncertainty be visible too, instead of defaulting to the capable presentation. People know the whole of you now, not just the person in charge.`,
        negative: `Your self-expression stays almost entirely in the capable, in-command register, leaving little room for people to see genuine uncertainty or need. You might notice you're respected and somewhat unreachable, because the presentation never lets anyone see past it.`,
      },
      5: {
        heading: `You Present Yourself Through What You Believe`,
        why: `Your self-expression in this lifetime is grounded in conviction — people know you by your principles, your framework, what you stand for. That's genuine, consistent self-presentation, and it gives people something real to trust.`,
        shadow: `The risk is that people know your positions thoroughly and rarely meet the parts of you that are still uncertain, so your social identity becomes the person who always has an answer, even in moments you genuinely don't.`,
        blocks: `What can block this talent: being known only for settled conviction, with genuine uncertainty rarely shown or admitted.`,
        path: `Try presenting one genuine uncertainty, out loud, instead of your usual settled conviction. You are allowed to be known for not-knowing sometimes too. What do you actually feel unsure about that you've been presenting as settled?`,
        positive: `You're still genuinely known for your convictions and principles — that hasn't changed — but you've presented real uncertainty at least once, instead of defaulting to settled answers. People know a fuller version of you now, including the parts still being worked out.`,
        negative: `Your self-expression stays almost entirely in settled conviction, so people rarely meet the parts of you that are genuinely still uncertain. You might notice you're seen as someone who always has an answer, which leaves little room to actually not know something out loud.`,
      },
      6: {
        heading: `You Present Yourself Most Fully in Chosen Relationship`,
        why: `Your self-expression in this lifetime opens most completely in close, chosen connection — people who are genuinely close to you know a different, fuller version of you than casual acquaintances ever get to see.`,
        shadow: `The risk is that this relational gating means most people only ever meet a more guarded, general-purpose version of you, since your fullest self-expression is reserved almost entirely for the inner circle.`,
        blocks: `What can block this talent: reserving your fuller self-expression so tightly for close relationships that most people only meet a guarded version.`,
        path: `Try letting a little more of your real self show in a less intimate setting than usual. You are allowed to be known beyond just your closest relationships. Where have you presented a more guarded version simply because the setting wasn't intimate enough?`,
        positive: `Your fullest self-expression still genuinely happens in close, chosen relationship — that's real and it's not going anywhere — but you've let a bit more of your real self show in a less intimate setting too. More people get to know an actual version of you now, not just the general-purpose one.`,
        negative: `Your self-expression stays gated almost entirely behind close relationship, so most people only ever meet a more guarded version of you. You might notice you're well-liked broadly and genuinely known narrowly, because the fuller self rarely leaves the inner circle.`,
      },
      7: {
        heading: `You Present Yourself Through Forward Momentum`,
        why: `Your self-expression in this lifetime shows through drive — people know you as someone in motion, pursuing something, rarely standing still. That momentum is a real and visible part of your social identity.`,
        shadow: `The risk is that people rarely see you at rest, so your social identity becomes almost entirely the mover, with little room for anyone to know what you're like when you're not actively pursuing something.`,
        blocks: `What can block this talent: being known almost entirely in motion, with little social space left for who you are at rest.`,
        path: `Try letting someone see you at rest, on purpose, without a project or pursuit attached. You are allowed to be known for stillness too, not just momentum. Who has never seen you simply not moving toward something?`,
        positive: `You're still genuinely known for your drive and momentum — that's real and it's not softening — but you've let someone see you at rest too, without a project attached. People know a fuller version of you now, not just the person always in motion.`,
        negative: `Your self-expression stays almost entirely in motion, so people rarely see who you are at rest, and your social identity becomes nearly synonymous with pursuit. You might notice people know your drive well and your stillness barely at all.`,
      },
      8: {
        heading: `You Present Yourself as Someone Who Deals Fairly`,
        why: `Your self-expression in this lifetime carries real integrity — people know you as someone who's honest and equitable, and that reputation is earned and accurate. You're identified by your fairness.`,
        shadow: `The risk is that this fairness-forward presentation makes it hard to be seen wanting something for purely selfish reasons, so you dress your actual wants in the language of fairness even when a plain want would be more honest.`,
        blocks: `What can block this talent: dressing plain, personal wants in the language of fairness rather than just naming them directly.`,
        path: `Try stating one want plainly, as a want, without framing it as fair or justified first. You are allowed to be known for wanting things, not just for deserving them. What do you actually want that you've been justifying instead of just stating?`,
        positive: `You're still genuinely known for your fairness and integrity — that hasn't changed — but you've stated a plain want at least once, without dressing it in justification first. People know you're honest, and now they also know you're allowed to just want things.`,
        negative: `Your self-expression stays tied to fairness, so plain personal wants get dressed in the language of justification rather than simply stated. You might notice you've argued for something as fair when you could have just said you wanted it.`,
      },
      9: {
        heading: `You Present Yourself Sparingly, in Person and in Groups`,
        why: `Your self-expression in this lifetime is genuinely more solitary — you're known less through constant social presence and more through what surfaces when you do choose to engage. That's a real, legitimate mode of self-presentation.`,
        shadow: `The risk is that this sparing presence means most people simply don't know much about you at all, since the withdrawal that protects your energy also limits how much of you actually reaches anyone.`,
        blocks: `What can block this talent: withdrawing so consistently that most people simply don't get enough exposure to actually know you.`,
        path: `Try showing up a little more than feels automatic in one social setting that matters to you. You are allowed to need solitude and still let yourself be known somewhat. Where has your withdrawal cost you being known by people you'd actually want to know you?`,
        positive: `Your genuinely more solitary self-expression is still real and still yours to protect — that hasn't changed — but you've shown up a bit more in at least one setting that matters to you. People who matter to you know you a little better now, without you losing the solitude you actually need.`,
        negative: `Your self-expression stays genuinely sparing, and the withdrawal that protects your energy is also limiting how much of you actually reaches people, even ones you'd want to know you. You might notice you're a mystery to people you'd actually like to be known by.`,
      },
      10: {
        heading: `You Present Yourself Differently Depending on the Season`,
        why: `Your self-expression in this lifetime genuinely shifts with circumstance — how you show up socially isn't constant, it moves with your own cycles. That's an accurate read of how you actually present, not inconsistency.`,
        shadow: `The risk is that people meeting you in a quieter season assume that's simply who you are, missing the fuller range you actually have, since your presentation in any given moment is only ever a partial sample.`,
        blocks: `What can block this talent: letting people assume a quiet-season version of you is your whole range, rather than naming the variation.`,
        path: `Try naming the cycle to someone, so a quieter presentation doesn't get mistaken for your whole range. You are allowed to explain that you vary. Who might have only ever met one season of you?`,
        positive: `Your self-expression still genuinely varies with your own cycles — that rhythm hasn't changed — but you've named it to at least one person, so a quieter season doesn't get mistaken for your whole range. People understand more of your actual variation now.`,
        negative: `Your self-expression genuinely shifts with circumstance, and people who've only met you in one season can mistake that sample for your whole range. You might notice someone has an inaccurate, narrow read on you, simply because they never saw a different season.`,
      },
      11: {
        heading: `You Present Yourself as Gentle, Which Can Be Mistaken for Simple`,
        why: `Your self-expression in this lifetime is soft rather than forceful — people know you as calm and steady, and that read is accurate, even though it doesn't announce the actual strength underneath it.`,
        shadow: `The risk is that the gentleness gets read as an absence of real capability, so people underestimate you socially, missing the considerable strength that's simply not presenting itself loudly.`,
        blocks: `What can block this talent: presenting so gently that real strength and capability get underestimated by the people around you.`,
        path: `Try letting your actual capability be visible once, plainly, alongside the gentleness. You are allowed to be known as strong, not just calm. Where has your gentle presentation left people underestimating what you're actually capable of?`,
        positive: `Your gentle, steady way of presenting yourself is still real and still genuinely you — that hasn't changed — but you've let your actual capability be visible at least once, alongside the calm. People know your real strength now, not just your gentleness.`,
        negative: `Your gentle self-presentation is genuine, and it's letting real capability go underestimated, since the strength underneath isn't presenting itself loudly. You might notice people are surprised by what you can actually do, because the gentleness never announced it.`,
      },
      12: {
        heading: `You Present Yourself Most Clearly After You've Had Time to Reflect`,
        why: `Your self-expression in this lifetime needs space to form — you're known most accurately by the considered version of you, the one that shows up after reflection, not the immediate reaction.`,
        shadow: `The risk is that real-time, in-the-moment presentation suffers, since your best self-expression needs the pause you don't always get, leaving spontaneous interactions feeling like a lesser version of who you actually are.`,
        blocks: `What can block this talent: needing reflection time so completely that real-time, spontaneous self-expression feels like a lesser version of you.`,
        path: `Try presenting something in the moment, unpolished, before you've had the usual time to reflect. You are allowed to be known in real time too, not just after reflection. What have you held back in a live moment, waiting for time to consider it first?`,
        positive: `Your need for reflection time before your clearest self-expression is still real — that hasn't changed — but you've presented something unpolished, in real time, at least once. People get access to more of you now, not only the fully considered version.`,
        negative: `Your self-expression genuinely needs reflection time to form clearly, which leaves real-time interactions feeling like a lesser version of who you actually are. You might notice you come across better after the fact than you did live, and rarely get credit for the in-the-moment version.`,
      },
      13: {
        heading: `You Present Yourself as Someone Who's Been Remade`,
        why: `Your self-expression in this lifetime carries the marks of real transformation — people know you as someone who's ended and rebuilt versions of themselves, and that history is genuinely part of how you present.`,
        shadow: `The risk is that people expect you to keep transforming indefinitely, so a stable, unchanging period of your life can read to others — and to you — as somehow incomplete or overdue for another ending.`,
        blocks: `What can block this talent: expecting yourself to keep transforming, so a genuinely stable period feels incomplete rather than simply settled.`,
        path: `Try letting one stable period of your self-presentation just be stable, without needing it to be evidence of the next transformation. You are allowed to be known as settled sometimes, not only as someone mid-change. What part of you has been stable long enough to just be presented as itself?`,
        positive: `Your history of real transformation is still genuinely part of who you are — that hasn't changed — but you've let a stable period simply be stable, without needing it to signal another ending coming. People can know a settled version of you now, not only the one mid-change.`,
        negative: `Your self-expression carries real transformation history, and there's an expectation — yours and others' — that you'll keep transforming, so genuine stability can read as incomplete. You might notice you feel restless in a period that's actually just settled, simply because settled feels unfamiliar to present.`,
      },
      14: {
        heading: `You Present Yourself as Balanced, Consistently`,
        why: `Your self-expression in this lifetime is calibrated — people know you as measured, rarely swinging to extremes, and that consistency is a real and valuable part of your social identity.`,
        shadow: `The risk is that this balanced presentation filters out genuinely intense moments, so people rarely see you at full volume even when a situation actually calls for it, and your range reads narrower than it actually is.`,
        blocks: `What can block this talent: presenting so consistently balanced that genuinely intense moments rarely get shown, even when warranted.`,
        path: `Try letting one moment be presented at full intensity, without the usual calibration softening it. You are allowed to be known at full volume sometimes. Where have you toned down a presentation that actually deserved more intensity?`,
        positive: `Your calibrated, consistent way of presenting yourself is still real and still your natural register — that hasn't changed — but you've let at least one moment be shown at full intensity, when it actually called for it. Your range reads wider now, not just steady.`,
        negative: `Your balanced self-presentation is genuine, and it's filtering out moments that actually deserved more intensity, so people rarely see your full range. You might notice something important got presented in your usual measured tone when it actually needed more.`,
      },
      15: {
        heading: `You Present a Version of Yourself That Isn't the Whole Story`,
        why: `Your self-expression in this lifetime carries real intensity that you may not fully show — people know a calibrated version of you, while a stronger, more appetite-driven layer stays mostly private.`,
        shadow: `The risk is that the concealment itself, not the intensity, becomes the actual problem, since hiding a real part of yourself takes ongoing effort and creates a gap between the presented self and the actual one.`,
        blocks: `What can block this talent: hiding a genuinely intense part of yourself so consistently that maintaining the gap becomes its own quiet cost.`,
        path: `Try letting one person see a truer, more intense version of you than you usually present. You are allowed to be known more fully, without it meaning something's wrong with you. Who might be trusted with more of your actual intensity?`,
        positive: `The intensity underneath your presentation is still exactly as real as it's always been — that was never the issue — but you've let at least one person see a truer version, closing some of the gap between presented and actual. Being known now costs less effort than hiding did.`,
        negative: `Your presented self is genuine, and it's leaving out a real intensity that stays mostly hidden, which means maintaining the gap between presented and actual self takes ongoing, quiet effort. You might notice that effort is more tiring than the intensity itself would be.`,
      },
      16: {
        heading: `You Present Yourself as Someone Who Survived Something`,
        why: `Your self-expression in this lifetime carries the marks of real disruption — people can sense you've been through something and come out the other side, and that history genuinely informs how you present.`,
        shadow: `The risk is that you present a slightly guarded version of yourself as a precaution against another sudden rupture, holding back the full extent of who you are in case presenting fully invites the same kind of disruption again.`,
        blocks: `What can block this talent: presenting a guarded version of yourself as an unconscious precaution against another disruption.`,
        path: `Try presenting yourself fully, once, without the protective hedge you've built in since the disruption. You are allowed to be known completely again. What have you been holding back out of a caution that might not be necessary anymore?`,
        positive: `Your history of surviving real disruption is still genuinely part of you — that hasn't changed — but you've presented yourself fully at least once, without the protective hedge. Being fully known is starting to feel safe again, not just theoretically possible.`,
        negative: `Your self-expression carries a real disruption in its history, and you're still presenting a guarded version as an unconscious precaution against it happening again. You might notice you hold back the full extent of who you are, as though full presentation would invite the same rupture.`,
      },
      17: {
        heading: `You Present Yourself With Quiet, Guarded Hope`,
        why: `Your self-expression in this lifetime carries a hopeful undertone — people sense that you trust things can be good, even though you tend to present that hope modestly rather than loudly.`,
        shadow: `The risk is that the modesty meant to protect your hope also makes you present as less optimistic than you actually are, so people underestimate how much you genuinely believe things can work out.`,
        blocks: `What can block this talent: presenting your hope so modestly that people underestimate how much you actually trust things can work out.`,
        path: `Try presenting your hope at full size once, without the protective downgrade. You are allowed to be known as genuinely hopeful, not just quietly so. Where have you presented a smaller hope than the one you actually carry?`,
        positive: `Your hopeful undertone is still real and still genuinely yours — that hasn't changed — but you've presented it at full size at least once, instead of the pre-guarded version. People know how much you actually trust things can work out now, not just the modest version.`,
        negative: `Your hopeful self-expression stays deliberately modest, which means people consistently underestimate how much you actually believe things can be good. You might notice you're read as more guarded than you actually feel, because the hope has been presented smaller than it really is.`,
      },
      18: {
        heading: `You Present Yourself in a Way That's Hard to Fully Pin Down`,
        why: `Your self-expression in this lifetime is genuinely harder to read clearly than most people's — there's real depth there, but it often comes across as slightly foggy rather than sharply defined, which isn't a flaw in who you are.`,
        shadow: `The risk is that this fog leaves people with an inaccurate or incomplete sense of you, since what you're actually presenting doesn't always land as clearly as what you intend.`,
        blocks: `What can block this talent: presenting in a way that's genuinely harder to read, leaving people with an incomplete sense of who you actually are.`,
        path: `Try presenting one thing about yourself more plainly than feels natural, accepting the loss of some nuance for the gain in clarity. You are allowed to be known plainly sometimes, not only atmospherically. What have you never said clearly because the clear version felt like it lost something?`,
        positive: `Your presentation is still genuinely harder to pin down than most people's — that hasn't fully changed — but you've stated something plainly at least once, trading some nuance for real clarity. People have a more accurate sense of you now, even if the full depth still takes time to reach.`,
        negative: `Your self-expression is genuinely foggy in a way that isn't a flaw but does leave people with an incomplete read on you. You might notice someone's sense of who you are doesn't quite match who you actually are, simply because the clearer version has never quite been said.`,
      },
      19: {
        heading: `You Present Yourself as Warm and Easy to Be Around`,
        why: `Your self-expression in this lifetime comes across easily and warmly — people know you as approachable and bright, and that read is genuine, not performed. It's a real social gift.`,
        shadow: `The risk is that this easy warmth makes it hard for you to present as genuinely struggling, since your default social mode pulls toward brightness even in moments that would call for something more serious to be shown.`,
        blocks: `What can block this talent: presenting warmly even in moments that actually call for showing genuine difficulty instead.`,
        path: `Try presenting a real difficulty without the automatic warmth softening it first. You are allowed to be known as struggling sometimes, not only as easy to be around. What hard thing have you smoothed over in how you present it?`,
        positive: `Your easy, warm way of presenting yourself is still real and still a genuine gift — that hasn't changed — but you've presented a real difficulty plainly at least once, without the automatic warmth softening it first. People know the whole of you now, not just the bright, easy version.`,
        negative: `Your easy warmth is genuine, and it makes presenting genuine struggle difficult, since your default social mode pulls toward brightness even when something more serious needs to be shown. You might notice you've come across as fine when you were actually not.`,
      },
      20: {
        heading: `You Present Yourself as Someone Waiting to Answer Something`,
        why: `Your self-expression in this lifetime carries an undertone of unfinished business — people can sense you're oriented toward something you haven't fully done yet, even if they couldn't name what it is.`,
        shadow: `The risk is that this waiting-to-answer quality becomes a permanent feature of how you present, rather than something that resolves once you actually respond to the call, leaving your presentation perpetually a little unsettled.`,
        blocks: `What can block this talent: presenting as perpetually unresolved, when the unsettled quality would actually resolve if the call were answered.`,
        path: `Try answering the thing you already sense you're meant to answer, in some concrete form. You are allowed to let your presentation settle by actually responding. What have you been sensing you're meant to do that you haven't yet acted on?`,
        positive: `You've answered the thing you'd been sensing, and your self-presentation has settled measurably because of it — not because everything is resolved, but because the waiting has ended. People notice something has genuinely shifted in how you come across.`,
        negative: `Your self-expression carries a persistent, unsettled quality that traces back to a call you haven't yet answered, and it's becoming a permanent feature of how you present rather than something temporary. You might notice people sense something unresolved in you without either of you being able to name it.`,
      },
      21: {
        heading: `You Present Yourself Most Fully Once Everything Connects`,
        why: `Your self-expression in this lifetime deepens with integration — people know the fullest version of you once you can see how the pieces of your life fit together, rather than in isolated fragments.`,
        shadow: `The risk is that this need for integration delays presenting something you're actually ready to show, waiting for a comprehensive coherence that isn't always necessary before letting people see a piece of you.`,
        blocks: `What can block this talent: waiting for full integration before presenting something you're actually ready to show now.`,
        path: `Try presenting one isolated piece of yourself, without waiting for it to connect to the whole picture first. You are allowed to be known in fragments sometimes, not only wholly. What have you held back because it hadn't yet connected to everything else?`,
        positive: `Your fullest self-expression through integration is still real and still meaningful — that hasn't changed — but you've presented an isolated piece of yourself too, without waiting for the whole picture first. People get to know parts of you sooner now, not only the fully integrated version.`,
        negative: `Your self-expression tends to wait for integration, so pieces of you that are actually ready to be shown get delayed while you wait to see how they connect to everything else. You might notice you've held back something simple because the larger context wasn't yet clear to you.`,
      },
      22: {
        heading: `You Present Yourself Openly, Trusting the Reception as You Go`,
        why: `Your self-expression in this lifetime is genuinely spontaneous — you present yourself as you actually are in the moment, trusting how it lands rather than managing the impression carefully in advance.`,
        shadow: `The risk is that this spontaneous openness avoids the different value of a more considered presentation in situations that actually call for it, so something that deserved more forethought gets the same unguarded approach as everything else.`,
        blocks: `What can block this talent: presenting with the same spontaneous openness even in situations that actually deserved more consideration first.`,
        path: `Try presenting yourself a little more deliberately in one situation that actually calls for it. You are allowed to combine your natural openness with real consideration sometimes. What upcoming presentation of yourself could use more forethought than your usual openness provides?`,
        positive: `Your spontaneous, trusting way of presenting yourself is still fully real — that openness isn't going anywhere — but you've presented yourself more deliberately at least once, in a situation that actually called for it. Your presence is more grounded now, not just more open.`,
        negative: `Your trust in spontaneous self-presentation is genuine, and it's being applied even to situations that actually deserved more consideration, so something that needed forethought got the same unguarded approach as everything else. You might notice a presentation that could have used more care instead came across too openly, and it showed.`,
      },
    },
