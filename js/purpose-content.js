  ...
  const positions = {
    ...
    PP: {
      ...
      4: {
        ...
        invitation: `Ask yourself, plainly, what you're afraid would happen if you actually loosened your grip. Let one thing that matters be run badly by someone else today, without taking it back. Resist the urge to correct it. Notice that the structure holds even when you're not the one enforcing it.`,
    ...
    SOP: {
      ...
      2: {
        ...
        invitation: `Notice honestly what you're protecting by staying silent about what you already see. Name one thing today you've been privately seeing for years, to someone with the standing to act on it. Say it plainly, not as a hint. Notice that the naming doesn't make you responsible for what happens after.`,
      ...
      3: {
        ...
        invitation: `Ask yourself, plainly, what you're afraid teaching someone else's independence would cost you. Teach one person today to make what you've been making for them. Show them the actual process, not just the result. Notice that being less needed doesn't mean being less valued.`,
      ...
      8: {
        ...
        synthesis: `Your paternal and maternal lines both feed this purpose, and with Justice they may well have handed you the two sides of an old imbalance — one line's account of what happened and the other's, not matching. Your middle years put both in one person for the first time. That's what makes resolution possible and what makes it hard: you're the first one positioned to see the whole thing, and therefore the first who can't claim ignorance. This position doesn't ask you to determine who was right. It asks you to end it.`,
      },
      ...
      9: {
        ...
        synthesis: `This purpose forms at the point your paternal and maternal lines converge, and with the Hermit they may have taught the same self-sufficiency in two different registers — one line handling things alone as duty, the other as necessity. Your middle years ask you to be the first in either line to make the inner work available. That's the assignment and it runs against both inheritances at once, which is why it feels less like growth and more like exposure. Depth accumulated over two lineages was not meant to terminate in a private conclusion.`,
      },
      ...
      15: {
        ...
        invitation: `Notice honestly what you're afraid naming this would make you responsible for. Say the unsayable thing today, to one person who can act. Say it plainly, without softening it into a hint. Notice that naming the concealment isn't what breaks the family — the concealment already was.`,
    ...
    SPP: {
      ...
      1: {
        ...
        tagline: `A Design of the Handed-Over Fire`,
        mastery: `You've handed it over. The initiating capacity that ran your whole life — first for yourself, then for others — now operates in other people, and you can watch them use it differently without needing to correct the grip. You recover fast when a handover goes sideways, treating it as information rather than proof they weren't ready. And you can watch beginnings happen around you that you made possible and had no hand in, without needing the credit back.`,
        shadow: `You hold the fire because no one will carry it properly. You keep initiating past the point where initiating is yours to do, and each time you take something back you confirm what you suspected. Underneath the reclaiming is often a fear that letting the capacity leave your hands entirely would mean it dies with you rather than continuing. People around you have stopped offering, and you experience this as proof rather than as consequence.`,
        invitation: `Notice honestly what you're afraid would happen if you let something be done worse than you'd do it. Hand something over today and let it be done worse than you'd do it. Don't take it back when it wobbles. Notice that the fire survives being carried by someone else's hands.`,
      ...
      2: {
        ...
        tagline: `A Design of the Held Disclosure`,
        mastery: `People bring you things. A lifetime of perception has resolved into something rare — you can be told the worst of a person's situation and they leave feeling less alone rather than more exposed. You still see everything; you've simply stopped needing to demonstrate it. And that restraint is what made you safe, which is what this whole capacity was always for.`,
        shadow: `The knowing has curdled into judgement. Decades of accurate perception can settle into a habit of seeing through everyone, and people can feel it. Underneath the seeing-through is often a fear that withholding your read would mean the perception itself wasn't worth having. You understand your family better than anyone and are told less than anyone.`,
        invitation: `Ask yourself honestly whether your accuracy has made you unsafe to confide in. Receive one disclosure today without interpreting it out loud. Let it sit without offering your read. Notice that not commenting is what actually makes someone feel safe with you.`,
      ...
      3: {
        ...
        tagline: `A Design of the Released Authorship`,
        mastery: `What you grew belongs to the people who have it now. You can watch them change it, in ways you wouldn't have chosen, without experiencing it as loss. You cultivate patiently across a lifetime, and what you tend now includes the willingness to let it stop needing you. And the fertility of your whole life has ended in genuine handover, which is the difference between a legacy and a monument.`,
        shadow: `The claim never lifts. You continue to hold what you grew — offering guidance that functions as ownership, taking changes to it personally. Underneath the ownership is often a fear that a thing that stops requiring your approval was never really yours to begin with. The people who inherited it end up managing your feelings about their own inheritance.`,
        invitation: `Ask yourself honestly what you're still holding that has belonged to someone else for years. Let something you made change today in a way you dislike, without comment. Resist the urge to correct it. Notice that your pride in it survives the change.`,
      ...
      4: {
        ...
        tagline: `A Design of the Unneeded Structure`,
        mastery: `It stands without you. You built structures that hold when you're not holding them, and you've been able to watch that happen without reading it as diminishment. You built things that actually last, thinking in decades rather than moments. And what you're responsible for will outlast you functionally, not just sentimentally, which is the only real completion this position offers.`,
        shadow: `Indispensability gets defended to the end. You keep the structure dependent because dependence is evidence you mattered, and each demonstration that things falter without you confirms your value while proving your work incomplete. Underneath the defending is a fear that stepping back would reveal the structure — and you — were never actually needed. You cannot be away for long, and you've come to read this as commitment.`,
        invitation: `Ask yourself honestly what would actually break if you stepped away for a year. Be genuinely absent today, even in a small way, and let the results be what they are. Resist the urge to check in. Notice that valuing the thing above being needed by it doesn't diminish you.`,
        synthesis: `This is where your Personal and Social Purposes actually combine. The personal task was building something that held; the social task was holding it for other people. With the Emperor, the final task inverts both: making yourself unnecessary to the thing you built. That can only come last, because it requires having actually built something and actually carried it — you cannot meaningfully step back from a structure you never bore the weight of. This is authority's completion, and it looks from the inside like being no longer needed.`,
      },

      5: {
        title: `5 in Spiritual Purpose — The Hierophant`,
        tagline: `A Design of the Argued-With Framework`,
        mastery: `They believe differently and you've let them. What you taught got taken up, tested, partly kept and partly discarded, which is what happens to any framework genuinely transmitted rather than imposed. You examine your own framework as readily as you once examined your inheritance. And you can hear someone you taught contradict you and recognise it as the process working, not as a threat.`,
        shadow: `Orthodoxy gets enforced past your actual authority. You continue correcting, and because you're often right, the correcting works, producing people who repeat your framework without owning it. Underneath the correcting is often a fear that revision by someone you taught would mean the framework wasn't sound. Your children or students agree with you conspicuously and think about it very little.`,
        invitation: `Ask yourself honestly whose disagreement you've been correcting instead of actually considering. Let someone you taught be wrong today about something important, and say nothing. Let the disagreement stand. Notice that what you passed on is alive precisely because it's being argued with.`,
        synthesis: `This is where your Personal and Social Purposes actually resolve. The personal task was finding out what you actually believed; the social task was transmitting only what survived that test. With the Hierophant, the late task completes the sequence: allowing the next generation to run the same test on you. That has to come last — you cannot let your framework be examined by others until you've examined it yourself, or the challenge feels like destruction rather than continuation.`,
      },

      6: {
        title: `6 in Spiritual Purpose — The Lovers`,
        tagline: `A Design of the Unpriced Love`,
        mastery: `You love without terms. The people who went their own way, chose others, or simply couldn't give you what you wanted have your full warmth anyway. You hold the fact that they chose differently without needing it to have been about you. And that's changed your whole family's atmosphere — people come back to someone who never made returning conditional.`,
        shadow: `Love stays conditional to the end. You maintain a quiet ledger of who chose you sufficiently, and it governs your warmth in ways you'd deny. Underneath the ledger is often a fear that warmth given without reciprocity would mean the earlier disappointments didn't matter. Your family can sense a ranking you've never stated, and the ones lower in it have stopped trying.`,
        invitation: `Ask yourself honestly who you've been loving at a discount because of an old disappointment. Be fully warm today to someone who disappointed you relationally, without them having repaired it. Offer the warmth without the ledger attached. Notice that it doesn't erase what the disappointment cost you.`,
        synthesis: `Here, your Personal and Social Purposes meet and combine. The personal task was choosing at all; the social task was choosing consciously among competing loyalties. With the Lovers, the late task releases the mechanism entirely: loving without the choosing being the point. That can only come third, because you cannot give unconditionally what you never learned to give deliberately. Undiscriminating warmth at twenty is just avoidance; the same warmth at seventy, after a lifetime of costly choices, is something else entirely.`,
      },

      7: {
        title: `7 in Spiritual Purpose — The Chariot`,
        tagline: `A Design of the Chosen Stop`,
        mastery: `You stopped, and it was enough. The drive that carried you and then carried others has come to rest, and you can look at the distance without needing to extend it. You can let a good journey be good without needing to grip it in place or add more to it. And there's a settledness in you now that no amount of further movement would have produced.`,
        shadow: `You drive until something stops you. You keep the momentum going past the point of usefulness, taking on new campaigns. Underneath the continued momentum is a fear that arriving would mean facing what the movement has been outrunning. Stillness produces a specific dread, and you've never once in your life stopped voluntarily.`,
        invitation: `Ask yourself honestly what you'd have to feel if you weren't moving. Stop before something stops you, and stay stopped long enough to feel it. Don't reach for the next campaign to fill the space. Notice that the distance already travelled counts without needing to be extended.`,
        synthesis: `Here, your Personal and Social Purposes settle into resolution. The personal task was finding a direction; the social task was bringing people with you. With the Chariot, the late task is the one neither prepared you for: stopping. It comes last because arrival is meaningless without a journey, and you had to have gone somewhere real, with others, before rest could be completion rather than surrender. The vehicle was always meant to reach somewhere and be left there.`,
      },

      8: {
        title: `8 in Spiritual Purpose — Justice`,
        tagline: `A Design of the Closed Account`,
        mastery: `The accounts are closed. You've forgiven things that were never repaid and apologised for things you can't undo, without requiring the other party to participate. You hold yourself to the same standard you release others by, which is what makes the closing genuine rather than convenient. And the precision never left you; it simply stopped being the thing that governs who you can be close to.`,
        shadow: `The ledger gets carried to the grave. You keep the accounts open because closing them unresolved feels like endorsing the injustice. Underneath the open ledger is often a fear that releasing a genuine debt would mean the original wrong didn't matter. Your sense of fairness has become the reason you're estranged from people whose wrongs were, at this distance, fairly ordinary.`,
        invitation: `Ask yourself, plainly, what you're still owed that you're prepared to die holding. Close one account today that will never be settled fairly. Forgive it, or apologise for your part, without waiting for the other side. Notice that releasing the debt doesn't erase that it was real.`,
        synthesis: `Your Personal and Social Purposes come together at this exact point. The personal task was learning what your standard actually costs; the social task was repairing imbalances larger than your own. With Justice, the late task is the release of the instrument itself — closing accounts by decision rather than by settlement. It can only come last, because forgiveness offered before you've fully reckoned with a wrong isn't mercy, it's avoidance. You had to keep the ledger accurately for decades to be able to close it meaningfully.`,
      },

      9: {
        title: `9 in Spiritual Purpose — The Hermit`,
        tagline: `A Design of the Reachable Solitude`,
        mastery: `You're alone and it isn't loneliness. The interior life you built has become the actual shape of your days, and it's generative rather than merely quiet — you're still working something out. You can be self-sufficient without it curdling into isolation. And the doors are open: people reach you, and you let them, without the solitude being threatened by it.`,
        shadow: `Isolation dresses itself as arrival. You mistake having withdrawn for having transcended, and the late years become a slow closing of doors narrated as spiritual maturity. Underneath the narration is often a fear that admitting the solitude has stopped producing would mean admitting it's just isolation. Your solitude has stopped producing anything — no insight, no attention — and has simply become the absence of people.`,
        invitation: `Ask yourself honestly whether your solitude is producing anything, or has just become quiet. Keep one door genuinely open today. Let one person interrupt the solitude, whether or not you feel like it. Notice that being reachable doesn't threaten the aloneness you've built.`,
        synthesis: `Your Personal and Social Purposes find their resolution at this exact point. The personal task was going in and coming back; the social task was being findable. With the Hermit, the late task holds both simultaneously — a genuinely interior life that remains open. That's why it comes last: solitude before you've learned to return is escape, and availability before you've been genuinely alone is just company. Only after both does aloneness stop being a movement away from anything.`,
      },

      10: {
        title: `10 in Spiritual Purpose — Wheel of Fortune`,
        tagline: `A Design of the Unaudited Arc`,
        mastery: `You see the whole thing and you've stopped auditing it. The arc had stretches where effort produced nothing and stretches where it produced far more than it should have, and you can hold both without needing them reconciled. You can read the whole shape of your life the way you once read a single cycle, without needing it proportional. And that's produced a genuine steadiness — not resignation, but the calm of someone who's stopped requiring the pattern to be fair.`,
        shadow: `A life gets audited for fairness and found wanting. You review the whole arc looking for proportion — where you were owed, where others got what you didn't. Underneath the reviewing is often a fear that accepting the arc as unfair would mean the effort was wasted. A bitterness arrives late and attaches to things you'd long thought settled.`,
        invitation: `Notice honestly what you're still trying to make add up. Look at the whole shape today, including the unfair parts, without adjusting the account. Let it stand as it actually was. Notice that the arc doesn't need to be proportional to be accepted as yours.`,
      ...
      11: {
        ...
        tagline: `A Design of the Costless Gentleness`,
        mastery: `Your gentleness costs nothing now. You're still soft — that was never going to change — but it's stopped being load-bearing for anyone else's unresolved situation. You can stay present with what's difficult without needing to absorb it. And what people receive from you is kindness rather than absorption, which means you're not depleted by it.`,
        shadow: `You keep absorbing to the end. You keep carrying, because carrying is what you know and because there's always someone who benefits. Underneath the carrying is often a fear that putting something down would mean the strength was never real. You're still the one holding something, and no one has asked whether you should be.`,
        invitation: `Ask yourself honestly what you're still absorbing at this stage of your life. Put down the thing you're still carrying today, even if no one else picks it up. Let it fall without replacing it. Notice that gentleness doesn't require you to still be strong.`,
      ...
      12: {
        ...
        tagline: `A Design of the Rewritten Story`,
        mastery: `You see it differently now. The story you carried for decades has turned over, and from this angle the losses did something other than take — not redeemed exactly, but revealed. You can pause your own certainty about what your life meant without anxiety. And you can hold your own history without needing it to mean what you always insisted it meant.`,
        shadow: `The story stays fixed in place. You reach this stage with the meaning of your life already settled — usually settled early, and usually around a wound. Underneath the fixed story is often a fear that revising it now would make the suffering feel wasted. You tell your history the same way you've told it for forty years, arriving at the same conclusion.`,
        invitation: `Ask yourself honestly what you've been certain your life was about. Tell one part of your life story today with a different emphasis and see whether it's also true. Let it sit alongside the old version instead of replacing it outright. Notice that revising the meaning doesn't erase what actually happened.`,
        synthesis: `This is where your Personal and Social Purposes actually combine. The personal task was letting the pause teach you; the social task was holding a different angle for other people. With the Hanged Man, the late task turns that same capacity on your own history. It comes last necessarily — a life can't be reframed from the middle, because you need the whole shape before the inversion shows you anything. This is the one position where the final stage completes a movement the first two only rehearsed.`,
      },

      13: {
        title: `13 in Spiritual Purpose — Transformation`,
        tagline: `A Design of the Voluntary Release`,
        mastery: `You let go before it's taken. A lifetime of endings taught you something most people never learn — that releasing on your own terms is entirely different from being stripped. You can let something die so a truer version of the moment can arrive, without needing the process to be dramatic. And what goes, goes cleanly, with a dignity that has nothing to do with control.`,
        shadow: `Everything gets held until it's pried away. You keep everything until circumstance takes it, so every ending arrives as a loss rather than a decision. Underneath the holding is often a fear that releasing something voluntarily would mean admitting it was already over. You're gripping things that are already going, and it feels like fighting rather than what it is.`,
        invitation: `Ask yourself honestly what you're holding that would be easier to put down than to have removed. Release one thing today on your own terms while you still could have kept it. Let it go deliberately, not because circumstance forced it. Notice the dignity in a clean release versus a stripped one.`,
        synthesis: `This is where your Personal and Social Purposes actually resolve. The personal task was letting your own old version die; the social task was ending a pattern for the whole line. With Transformation, the late task is the same movement applied to what you can't replace. It comes last because you need both prior endings to know the difference between release and loss — and this stage, more than any other, is where that distinction determines what the years actually feel like.`,
      },

      14: {
        title: `14 in Spiritual Purpose — Temperance`,
        tagline: `A Design of the Settled Ratio`,
        mastery: `The proportion has settled. After a lifetime of adjustment you've found the weighting that's actually yours, and you've stopped treating it as provisional. You blend in the right proportion because you've now tested it across decades, not by rote formula. And that settling produced something you never had while still calibrating, which is rest.`,
        shadow: `The adjusting never stops. The calibrating continues so there's no stage of life that simply is what it is — every arrangement remains provisional. Underneath the constant calibrating is often a fear that letting something be final would mean losing the responsiveness that's defined you. You've never once felt settled, and you'd describe this as staying responsive rather than as never arriving.`,
        invitation: `Ask yourself honestly what you've been calibrating for so long that you've forgotten it could simply be settled. Let one arrangement in your life be final today rather than provisional. Stop adjusting it. Notice that the responsiveness is still available even once something is settled.`,
        synthesis: `Here, your Personal and Social Purposes meet and combine. The personal task was finding proportions that worked; the social task was reconciling things outside yourself. With Temperance, the late task is to stop — to let the ratio you found be the answer rather than the current working hypothesis. It comes last because a settled proportion is only meaningful after decades of testing, and settling early would have been rigidity rather than resolution.`,
      },

      15: {
        title: `15 in Spiritual Purpose — The Devil`,
        tagline: `A Design of the Genuine Unbinding`,
        mastery: `You're free of it. The thing that gripped you — in whatever form it took across the decades — no longer has purchase, and not because you're suppressing it. You look at your own appetites, past and present, without flinching away from what they were. And you know exactly what you're capable of wanting, you're not ashamed of it, and none of it is running you.`,
        shadow: `The bind stays maintained to the end, usually in a quieter form. The compulsion may have softened into something respectable — a resentment, a control, a small private arrangement. Underneath the quiet form is often a fear that naming it now would undo the respectability it's earned over the decades. Something still has you, and you've stopped even framing it as something that could end.`,
        invitation: `Ask yourself honestly what still owns a piece of you that you've stopped calling by its name. Name the thing that still has purchase today, in its current quiet form. Say it plainly, even though it's easier to justify than it once was. Notice that naming it loosens the grip rather than tightening it.`,
        synthesis: `Here, your Personal and Social Purposes settle into resolution. The personal task was honesty about your own wanting; the social task was naming what a whole system was accommodating. With the Devil, the late task closes the arc: being genuinely unbound. It comes last because freedom here isn't achieved by will — it's the residue of decades of not hiding, from yourself first and then from others. The concealment was always the engine, and this is where its absence finally shows.`,
      },

      16: {
        title: `16 in Spiritual Purpose — The Tower`,
        tagline: `A Design of the Named Foundation`,
        mastery: `You know what didn't fall. Across every rupture something remained, and you can name it — not as consolation, but as the actual ground you've been standing on the whole time. You recover fast from real collapse, integrating what it showed you rather than just surviving it. And that's the specific completion this position offers: very little frightens you now.`,
        shadow: `A life gets defined by the falls. You reach this stage with your history organised around what collapsed, still bracing, still identifying primarily as someone things happened to. Underneath the bracing is often a fear that naming what survived would jinx it into being taken too. You can list your ruptures precisely and struggle to name what came through them.`,
        invitation: `Ask yourself honestly what's still here that nothing ever took. Name what has never gone today, across every collapse you've been through. Say it plainly, as fact rather than consolation. Notice that naming the foundation doesn't put it at risk.`,
        synthesis: `Your Personal and Social Purposes come together at this exact point. The personal task was discovering you weren't the structure that fell; the social task was being steady while others' structures went. With the Tower, the late task is naming the foundation both stages revealed. It comes last because it takes more than one collapse to distinguish what's genuinely permanent from what merely hadn't fallen yet — and this position, more than any other, is given the collapses required to find out.`,
      },

      17: {
        title: `17 in Spiritual Purpose — The Star`,
        tagline: `A Design of the Transferred Hope`,
        mastery: `The hope has somewhere to go. You handed the vision to people who'll outlive you, and they hold it differently than you did, which is what makes it theirs and durable. You carry hope that hasn't hardened into naivety, even in handing it to someone else's care. And you've stopped needing to see it realised, which is the actual condition for it being passed on.`,
        shadow: `Hope dies with you. You keep the vision personal to the end, and because it was always yours, no one else is carrying it when you stop. Underneath the keeping is often a fear that handing it over would mean admitting you won't see it realised yourself. What you most wanted for the world exists nowhere except in you.`,
        invitation: `Ask yourself honestly who would carry what you've wanted, if you asked them plainly. Give the vision today to one specific person, explicitly, and let them hold it differently. Name it out loud as theirs now, not just yours. Notice that the hope surviving you doesn't require you to see it finished.`,
        synthesis: `Your Personal and Social Purposes find their resolution at this exact point. The personal task was hoping without pre-shrinking it; the social task was carrying hope for others who couldn't. With the Star, the late task completes the sequence: releasing the hope to people who will outlast you. It comes last because you can only hand over a vision you've held at full size and already carried for someone else — anything smaller isn't worth transferring, and anything you've never carried for another person you don't yet know how to give away.`,
      },

      18: {
        title: `18 in Spiritual Purpose — The Moon`,
        tagline: `A Design of the Final Sorting`,
        mastery: `The sorting is done. You can distinguish, with real clarity, between what originated in you and what you absorbed from two lines that never named anything, and you've set the second category down. You navigate ambiguity without needing everything resolved before you'll trust the distinction. And what's left is genuinely yours, a considerably lighter load than what you carried for most of your life.`,
        shadow: `You die inside the fog. The sorting never gets finished, so the inherited material stays attached to your name. Underneath the unfinished sorting is often a fear that tracing the dread to its source would mean reliving where it started. You go out carrying a shame or a dread that started two generations before you.`,
        invitation: `Ask yourself honestly what you've believed about yourself that actually belongs to someone before you. Do the sorting once more today, thoroughly, and set down what traces to someone else. Name it plainly as not yours. Notice how much lighter the remaining load actually is.`,
      ...
      19: {
        ...
        tagline: `A Design of the Unrequired Warmth`,
        mastery: `The warmth is nothing but itself now. Nothing depends on it — no role, no group cohesion, no expectation — and it's still there, which is how you know it was always real. You bring genuine vitality without needing an audience to justify it. And you can be flat, tired, or difficult in front of people who love you, and the light comes back on its own.`,
        shadow: `You perform to the last. The role became so total that there's no version of you available without it. Underneath the performing is often a fear that a flat day observed by others would let them down after decades of brightness. You cannot be flat around anyone, and your own difficulty gets managed privately even now.`,
        invitation: `Ask yourself honestly what you'd be like if nothing at all depended on your brightness. Be entirely unperformed today with one person, for one afternoon. Let yourself be cool if that's what's true. Notice that the warmth doesn't disappear just because it isn't required.`,
      ...
      20: {
        ...
        tagline: `A Design of the Unproven Response`,
        mastery: `You answered. Not at the scale you once imagined and not on any schedule that would have impressed anyone, but genuinely — with nothing riding on it except that it was yours to do. You act on the summons with nothing left to prove, trusting the response mattered on its own terms. And the low hum of postponement that ran under most of your life is gone.`,
        shadow: `You wait for a call that already came. You reach this stage still anticipating clarity, still preparing. Underneath the preparing is often a fear that answering imperfectly now would confirm the delay was never justified. You've been almost-ready for decades.`,
        invitation: `Ask yourself honestly what you've been waiting your whole life to be sure about. Answer it now, today, in whatever reduced form is actually available. Respond without the certainty you've been waiting for. Notice that it still counts, even answered late.`,
        synthesis: `This is where your Personal and Social Purposes actually combine. The personal task was answering your own call; the social task was completing what your family left unfinished. With Judgement, the late task strips away every remaining external stake. It comes last because only now is there nothing to gain — no career it advances, no reputation it builds, no outcome you'll witness. Answering under those conditions is the only version that was ever really being asked for.`,
      },

      21: {
        title: `21 in Spiritual Purpose — The World`,
        tagline: `A Design of the Declared Wholeness`,
        mastery: `You see it whole. The arc includes everything you didn't get to and you can still call it complete, not because the list is empty, but because wholeness was never the same as exhaustiveness. You integrate everything, the finished and the unfinished, into one honest whole. And you can name what you finished, and the naming holds.`,
        shadow: `A life gets read as incomplete. You reach the end with a running list of what you didn't get to, and the breadth that let you see so much becomes the reason nothing ever measures up. Underneath the running list is often a fear that calling the life complete would mean stopping the striving that's defined you. You can enumerate the unfinished business precisely and struggle to state what you actually completed.`,
        invitation: `Ask yourself honestly what you actually completed. Name it today, out loud, and let the list of what you didn't stand unaddressed. Don't let the unfinished list cancel out the finished one. Notice that wholeness was always going to be a decision, not an achievement.`,
        synthesis: `This is where your Personal and Social Purposes actually resolve. The personal task was finishing something at its actual scope; the social task was completing what two lineages began. With the World, the late task applies the same judgement to your own arc. It comes last necessarily — a life can only be called whole from its end, and this position's entire education has been in the difference between complete and exhaustive. Everything before was practice for this particular declaration.`,
      },

      22: {
        title: `22 in Spiritual Purpose — The Fool`,
        tagline: `A Design of the Final Leap`,
        mastery: `The openness held. A life spent stepping off before the ground was proven has produced exactly what it was always going to produce: someone who can face the last unknown without needing it explained first. You step forward without needing a guarantee, the same trust that carried every earlier leap. And there's no bravado in it — just the same willingness you had at twenty, arriving where it's actually needed.`,
        shadow: `The openness deserts you precisely when it's needed. A life of leaping ends in gripping — clutching at certainty, at continuation, at any assurance about what comes next. Underneath the gripping is a fear that this leap, unlike every earlier one, has no visible other side to land on. You've become more frightened rather than less as the years narrow.`,
        invitation: `Ask yourself honestly what you're gripping that you spent a lifetime proving you didn't need. Practise not knowing today, deliberately, in something small. Go forward without the map, one more time. Notice that the willingness that carried every earlier leap is still available now.`,
        synthesis: `Here, your Personal and Social Purposes meet and combine. The personal task was leaping without justification; the social task was taking the risk your lines never would. With the Fool, the late task is the same movement with nothing on the far side that anyone can describe. It comes last for the plainest reason there is. Every earlier leap had ground you could eventually stand on and report back from — and each one, whether you knew it or not, was practice for the one that doesn't.`,
      },
