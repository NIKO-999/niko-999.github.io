  ...
  const positions = {
    ...
    PP: {
      ...
      1: {
        ...
        invitation: `Finish one thing today that stopped being exciting a while ago.`,
      ...
      2: {
        ...
        mastery: `You arrived knowing things — not facts, but patterns, undercurrents, the shape of what someone isn't saying. Before forty, your read of a person or a room repeatedly turns out to be accurate long before any evidence surfaces, and the purpose is whether you'll act on your own perception when no one has validated it yet.`,
        shadow: `You withhold what you know. Because it arrives without a chain of reasoning attached, you learn to keep it to yourself rather than defend it, and that privacy hardens into a habit of watching — understanding people more accurately than they understand themselves while staying just outside reach.`,
        invitation: `Say one thing you sense today, out loud, before you can fully justify it, to someone who might disagree.`,
      ...
      3: {
        ...
        mastery: `There's a generative quality in you that wants to bring things into existence — work, beauty, a home, other people's confidence. Before forty, your life keeps arranging conditions where something can grow if you tend it, and the purpose is learning that what you create is allowed to bear your name.`,
        shadow: `You create for others until there's nothing of your own. You pour real, sustained fertility into someone else's project or household and call it generosity, while your own unmade work sits untouched, always scheduled for after — because a thing made purely for yourself would expose what you actually value.`,
        invitation: `Make one thing today that has no recipient — something that exists because you wanted it to exist.`,
      ...
      4: {
        ...
        mastery: `You are here to make structure — order comes naturally to you, and you see what's disorganised and something in you moves to fix it. Life keeps giving you responsibility earlier than feels fair, and the purpose is discovering that structures exist to hold life, not to contain it.`,
        shadow: `You mistake control for care. When things feel uncertain, you tighten — more rules, more oversight, more of the load carried personally — and because you're genuinely competent, tightening usually works short-term. Over years it produces a life where everything depends on you and nothing can move without you.`,
        invitation: `Let one thing that matters be run badly by someone else today, without taking it back.`,
      ...
      5: {
        ...
        mastery: `You were handed a framework — religious, familial, cultural, professional — and absorbed it early and well. Before forty, life keeps testing that inheritance, usually by placing you somewhere it doesn't quite fit, and the purpose is working out which parts are genuinely yours.`,
        shadow: `You transmit borrowed certainty. Because the framework works and you can articulate it convincingly, you spend years speaking with an authority you haven't personally earned — passing along answers that have never been stress-tested against your own experience.`,
        invitation: `Take one belief you've always held today, and actually check it against your own scrutiny.`,
      ...
      6: {
        ...
        mastery: `Your first half of life is shaped by real choices between genuine goods — two paths, two people, two versions of yourself, both defensible. The purpose is learning to choose at all, and to stay with what you chose after the alternative starts looking better in hindsight.`,
        shadow: `You stay unchosen. Keeping options alive feels like openness and fairness to everyone involved, but it functions as a way of never being accountable to a direction — relationships and roles held close enough to feel real and far enough to leave.`,
        invitation: `Choose one thing today and let the other genuinely go — not shelved, not maybe-later, gone.`,
      ...
      7: {
        ...
        mastery: `You move. Where other people deliberate, you're already three steps down the road, and momentum opens doors careful planning wouldn't have found. The purpose is discovering what you're actually driving toward, because directed force with no destination just becomes speed.`,
        shadow: `You use momentum as avoidance. Motion feels like progress, and as long as you're moving you never have to sit still long enough to feel what's underneath — and the people closest to you experience your drive as something they're dragged behind rather than travelling with.`,
        invitation: `Stop the vehicle once today, on purpose, and ask where you're actually going and who's still in the car.`,
      ...
      8: {
        ...
        mastery: `You have an unusually exact internal scale, noticing imbalance in a room, a contract, a friendship often before anyone else does. The purpose is to learn what your own standard actually costs, and to choose it knowingly rather than reflexively.`,
        shadow: `You judge without mercy, starting with yourself. The same scale that catches unfairness in the world runs constantly on your own conduct — you hold people to standards you'd never state out loud, and carry a running ledger of who owes what.`,
        invitation: `Let one imbalance stand today, to find out whether your sense of order can survive something unresolved.`,
      ...
      9: {
        ...
        mastery: `You need more solitude than you've been given permission to need. Something in you does its actual processing in private, and the purpose isn't the withdrawal — it's the return. What you find in there is meant to come back with you.`,
        shadow: `Solitude stops being a passage and becomes an address. Withdrawal is genuinely restorative, which makes it easy to justify — until the periods lengthen, re-entry gets harder, and the depth you've cultivated has no one to reach.`,
        invitation: `Bring one thing back today — tell someone what you actually worked out in there, in plain language.`,
      ...
      10: {
        ...
        mastery: `Your life moves in cycles more visibly than most people's — things rise, things fall, and the timing rarely correlates with how hard you worked. The purpose is learning the difference between what's yours to steer and what's yours to ride, and spending your strength only on the first.`,
        shadow: `You either grip — trying to control variables that were never in your hands, reading every downturn as personal failure — or you go slack, treating everything as fate and quietly abandoning the parts that genuinely were yours to influence.`,
        invitation: `Name one thing today that is genuinely not yours to control, and stop spending on it.`,
      ...
      11: {
        ...
        mastery: `You have real endurance, and it doesn't look like endurance. Where others harden under pressure, something in you stays soft and simply doesn't break. The purpose is coming to recognise your own particular strength as strength, not fragility that's gotten away with it so far.`,
        shadow: `You endure what should have been ended. Your capacity to stay open under strain makes you very good at tolerating situations a harder person would have walked out of years earlier — strength becomes the reason you're still there.`,
        invitation: `Use your strength today to leave something, not just to withstand it.`,
      ...
      12: {
        ...
        mastery: `Your life includes suspension — periods where forward motion simply isn't available and you're held in place while something reorganises. The purpose is letting it change your angle of view, treating the pause as the work rather than dead time.`,
        shadow: `Suspension becomes identity. What began as a genuine fallow period slowly becomes the arrangement — waiting for conditions, for clarity, for permission — and the waiting acquires its own justification.`,
        invitation: `Name today, in concrete terms, what would have to be true for the waiting to be over.`,
      ...
      13: {
        ...
        mastery: `You will not get to keep who you were. This position tends to end things structurally — a career, an identity, a relationship — and the purpose is learning to release rather than be pried loose.`,
        shadow: `You hold the corpse. You keep something alive well past its actual life — a role you've outgrown, a relationship that ended in every way but formally — because letting go feels like admitting the whole thing failed.`,
        invitation: `Let one thing finish properly today — say it's over, out loud, and don't immediately replace it.`,
      ...
      14: {
        ...
        mastery: `You're here to blend things that don't obviously go together — pace and patience, ambition and ease, other people's needs and your own. The purpose is developing the judgement to keep adjusting, not arriving at balance as a final destination.`,
        shadow: `You use moderation as avoidance. Because you're genuinely good at finding the middle, you use the middle to never fully commit to anything — every position hedged, every intensity diluted, every strong feeling immediately balanced by its counterweight.`,
        invitation: `Let one thing today be disproportionate — give it more than its fair share of you.`,
      ...
      15: {
        ...
        mastery: `You have appetites — for pleasure, intensity, power, being wanted — stronger than the version of yourself you present. The purpose is honesty: knowing exactly what you want, without acting it out compulsively or pretending it isn't there.`,
        shadow: `Something has you — a habit, a person, a hunger — and the relationship has quietly inverted so you're serving it. You usually know, and the lucid awareness running alongside the compulsion produces shame, and the shame produces concealment.`,
        invitation: `Say the true thing about what you want today, out loud, to one person who won't flinch.`,
      ...
      16: {
        ...
        mastery: `Something in your first half of life collapses — suddenly, usually the thing you'd built the most identity on. The purpose isn't the collapse itself; it's what you learn about the difference between what fell and who you are.`,
        shadow: `You live braced. After the fall, you spend the rest of the half-life waiting for the next one — never fully committing to anything rebuildable, keeping an exit visible, treating stability itself as a trap you're too smart to fall for.`,
        invitation: `Build one thing today you'd genuinely grieve — that's the only evidence the collapse didn't take your capacity to invest.`,
      ...
      17: {
        ...
        mastery: `You carry a genuine sense of what could be — a clear picture of a better arrangement, for yourself or for the world. The purpose isn't achieving the vision — it's refusing to pre-shrink it.`,
        shadow: `You practice pre-emptive modesty. You scale the hope down before anyone can test it, so the disappointment can't reach you — and call it realism, or humility, or not wanting to jinx it.`,
        invitation: `Say one hope today at its real size, to one person, without the qualifiers.`,
      ...
      18: {
        ...
        mastery: `You take in more than you can account for — moods, atmospheres, what someone means underneath what they said, arriving without a source label. The purpose is developing the discrimination to reliably ask: is this mine?`,
        shadow: `You treat fog as fact. Anxiety arrives without a cause and you construct one, usually pointing at yourself, so the inherited or absorbed feeling becomes evidence about your character.`,
        invitation: `Take one recurring anxiety today and trace it — when did it start, whose is it, does your present life actually match it.`,
      ...
      19: {
        ...
        mastery: `There's a warmth in you that other people orient toward — you brighten rooms without especially trying. The purpose is finding out whether you can be seen as you actually are, rather than as the version that reliably gets a good response.`,
        shadow: `Brightness becomes an obligation rather than an expression. You're the one who lifts the mood, so your own difficulty has nowhere to go and gets managed privately.`,
        invitation: `Let someone see you flat today — not in crisis, just unbright, ordinary, without the lift.`,
      ...
      20: {
        ...
        mastery: `There's a call in your life you already know about — a direction, a piece of work, a reckoning with something unfinished. The purpose isn't discovering it, since you're not actually unclear. It's answering.`,
        shadow: `You stay in perpetual almost. You gather more information, wait for better conditions, prepare a little further — and each delay is individually reasonable, which is what makes the pattern so durable.`,
        invitation: `Take one step today that's expensive enough to be real — money, a conversation, a door closing behind you.`,
      ...
      21: {
        ...
        mastery: `You're built for completion — for the full arc rather than the promising start. The purpose is discovering what it feels like to be someone who completes, because that changes your relationship to every future beginning.`,
        shadow: `You practice scope creep as evasion. Because you can genuinely see the bigger picture, you keep widening the frame — one more element, one more region — and the thing never closes.`,
        invitation: `Close one thing today at its current scope, and let it be judged as it is.`,
      ...
      22: {
        ...
        mastery: `You're here to begin without guarantees — some doors only open to someone willing to step through without proof. This position carries real freedom and real exposure in the same gesture.`,
        shadow: `You leap constantly, so nothing accumulates and freedom becomes a kind of homelessness — always new, never deep — or you talk about leaping for years while arranging a life with no actual openness in it.`,
        invitation: `Take one leap today, and commit to staying long enough for it to become something.`,
    ...
    SOP: {
      ...
      1: {
        ...
        mastery: `Somewhere after forty the initiating force stops being about your own trajectory. Both lineages handed you the capacity to make things happen, and the second half asks you to spend it on ventures whose main beneficiaries aren't you.`,
        shadow: `You keep running a personal campaign past its season. You initiate for your own advancement, and because you're good at it, it keeps partially working — while the people who could have been launched by that same energy stand slightly outside it.`,
        invitation: `Start something today whose success won't be credited to you.`,
      ...
      2: {
        ...
        mastery: `Both lineages gave you perception, and probably a matching instruction to keep it to yourself. After forty, the social task is disclosure — becoming the person who names the thing everyone senses and no one has said.`,
        shadow: `Your discretion hardens into complicity. You see the dynamic clearly — the family pattern, the thing that's slowly harming someone — and you hold it, because holding is what your lines modelled.`,
        invitation: `Name one thing today you've been privately seeing for years, to someone with the standing to act on it.`,
      ...
      3: {
        ...
        mastery: `The generative capacity that ran through your first half turns communal after forty. Both lineages contributed something fertile — the ability to grow, tend, provide — and the social task is to build what nourishes a group rather than a household.`,
        shadow: `Your nurturing keeps everyone dependent. Because providing is genuinely what you do, you build a system where the flow only runs one direction and nobody around you develops their own capacity.`,
        invitation: `Teach one person today to make what you've been making for them.`,
      ...
      4: {
        ...
        mastery: `After forty you become load-bearing for a group. Both lineages contributed something about order and responsibility, and the social task is to provide the framework inside which other people can operate safely.`,
        shadow: `Your authority never distributes. You hold the frame so completely that no one else develops the capacity to hold anything, and because you're competent, the arrangement persists for decades.`,
        invitation: `Give one piece of real authority away today — with the right to do it differently than you would.`,
      ...
      5: {
        ...
        mastery: `You become a transmitter after forty. Both lineages handed down frameworks, and the social task is to pass on the parts that survived your own testing and let the rest stop with you.`,
        shadow: `You transmit without filtering. You pass along the whole inheritance intact, including the parts that harmed people, because it arrived as a package and questioning any of it feels like betraying all of it.`,
        invitation: `Name one inherited rule today you're choosing not to pass on, and say why.`,
      ...
      6: {
        ...
        mastery: `After forty the question stops being who you love and becomes who you're actually for. Both lineages carried patterns about alliance and loyalty, and the social task is to make those choices consciously rather than inheriting them.`,
        shadow: `You keep every allegiance half-open. You maintain loyalty to a family faction, an old obligation, and a new set of people all at once — and nobody quite realises they don't have you.`,
        invitation: `Make one allegiance explicit today, including what it costs the other side.`,
      ...
      7: {
        ...
        mastery: `The drive both lineages gave you turns directional after forty — not your own advancement, but moving a group from where it is to where it needs to be. What's asked isn't speed; it's responsibility for other people's arrival.`,
        shadow: `You drive without passengers. You move at your own pace and treat the people who can't keep up as a drag on the mission, arriving somewhere real with almost no one behind you.`,
        invitation: `Set today's pace to the slowest person who genuinely has to arrive.`,
      ...
      8: {
        ...
        mastery: `After forty you become the one who can settle something. Both lineages carried imbalances — a favouritism, an unacknowledged debt — and the social task is to be the person with enough standing to address it.`,
        shadow: `You judge without repairing. You see the imbalance with unusual precision, and precision alone becomes the whole contribution — accurate about who wronged whom, and useless for actually resolving it.`,
        invitation: `Take one long-standing imbalance today and do the repairing part, not just the naming part.`,
      ...
      9: {
        ...
        mastery: `The depth you built alone becomes a public resource after forty. The social task inverts what both lineages likely modelled — being genuinely reachable by people who need what you spent decades understanding.`,
        shadow: `Your wisdom stays kept at a distance. You remain the one who is respected, consulted rarely, and known by almost no one — and you frame that as discernment about who's worth your time.`,
        invitation: `Make yourself available today to one person who needs what you know, before they work up the nerve to ask.`,
      ...
      10: {
        ...
        mastery: `You've seen enough cycles by now to know they turn. The social task after forty is to be the person who holds perspective for a group in the middle of one — the steadiness that comes from having genuinely survived a few reversals.`,
        shadow: `Your perspective dismisses. Because you know it turns, you wave away other people's crises with a philosophical calm that lands as indifference — technically true and completely unhelpful to someone whose life is currently coming apart.`,
        invitation: `Sit with someone today in a downturn, without telling them it will pass.`,
      ...
      11: {
        ...
        mastery: `After forty you're asked to carry a situation that would make most people brittle, and to do it without becoming rigid. The social task is to demonstrate the endurance that stays open.`,
        shadow: `Your endurance enables. Your capacity to absorb difficulty without breaking makes it possible for a harmful situation to continue indefinitely, because you keep making it survivable.`,
        invitation: `Set one limit today inside something you've been holding open indefinitely.`,
      ...
      12: {
        ...
        mastery: `You become the one who sees it differently. After forty the social task is to be the perspective a group can't generate from inside itself — occupying a position not leading, not following, visibly outside the consensus.`,
        shadow: `Your sacrifice gets performed rather than offered. You take the outsider's position and let everyone know what it costs you, so the perspective arrives wrapped in a bill.`,
        invitation: `Offer the different angle today, once, plainly, without the cost attached.`,
      ...
      13: {
        ...
        mastery: `You are positioned to stop a pattern. Both lineages carried something forward, and after forty you have enough standing and clarity to be the place it terminates.`,
        shadow: `Transmission happens by default. Patterns continue unless someone actively ends them, and ending one means naming it, which means implicating people you love — so it passes through you intact.`,
        invitation: `Name one inherited pattern today out loud, and state that it stops with you.`,
      ...
      14: {
        ...
        mastery: `You're built to blend what doesn't naturally mix. After forty that becomes social work: being the person who can hold two opposed parties in the same room, mediating something unreconciled longer than you've been alive.`,
        shadow: `Your neutrality resolves nothing. Because you can see every side, you decline to weight any of them, and mediation becomes an endless holding of positions rather than movement toward settlement.`,
        invitation: `Take a position today inside a conflict you've been holding neutrally.`,
      ...
      15: {
        ...
        mastery: `Every family and institution has something it doesn't discuss. Both your lineages carried some version of this, and after forty you're positioned to be the one who says it — not to destroy anything, but to end the concealment doing the actual damage.`,
        shadow: `Your complicity feels like loyalty. You know exactly what's happening, you've known for years, and the arrangement continues with your tacit participation — your knowledge slowly becoming part of what protects it.`,
        invitation: `Say the unsayable thing today, to one person who can act.`,
      ...
      16: {
        ...
        mastery: `Something structural breaks in the world around you during this period, and the social task is to be the one who stays functional while it does. What both lineages hand you is the knowledge that people do come through.`,
        shadow: `You forecast instead of catch. Because you can see the structure failing before others can, you spend the whole period warning and being demonstrably right — while doing very little to actually hold anyone through it.`,
        invitation: `Pick one person today and be the thing that holds when their structure goes.`,
      ...
      17: {
        ...
        mastery: `After forty, hope becomes something you hold on behalf of others. The social task is to be the one who can see a future for a group that currently can't — the specific work of keeping a possibility alive.`,
        shadow: `Your optimism refuses to look. You keep the hope alive by declining to fully acknowledge the situation, so people can't bring you the real state of things.`,
        invitation: `Say the hopeful thing today immediately after saying the true one, in that order.`,
      ...
      18: {
        ...
        mastery: `Both lineages transmitted atmosphere — a dread, a shame, an unspoken thing everyone absorbed. After forty you're positioned to be the first to put it into words.`,
        shadow: `You stay inside the fog with everyone else. You feel the inherited unease as accurately as any of them and treat it as weather, as simply how the family is.`,
        invitation: `Ask one older relative today a direct question about something that's never been discussed.`,
      ...
      19: {
        ...
        mastery: `After forty you become a centre. The social task is to be the person whose warmth makes a family or community cohere — the one whose presence changes the temperature of a room.`,
        shadow: `Your centre can't be a person. Everyone organises around your warmth, which means your own difficulty has nowhere to go — showing it would destabilise the thing you've become for them.`,
        invitation: `Let the group see today that you need something.`,
      ...
      20: {
        ...
        mastery: `There's unfinished business in your lines. After forty you're the one with enough standing to complete it — not to build something new, but to close something old.`,
        shadow: `Your deference reads as respect. You know what's unresolved, and you leave it — out of deference to the people involved, or because the moment never seems right, while it continues to shape people who don't know why.`,
        invitation: `Address the unfinished thing today, while the people involved are still alive to be part of it.`,
      ...
      21: {
        ...
        mastery: `Both lineages were working on something and neither finished. After forty your social task is completion: taking whatever they began and bringing it to an actual conclusion.`,
        shadow: `You expand the inheritance rather than complete it. You add more scope, more scale, another generation of ongoing effort — because completing it would mean deciding it was enough.`,
        invitation: `Declare one inherited project complete today, and stop working on it.`,
      ...
      22: {
        ...
        mastery: `Both lineages had a leap they didn't take. After forty your social task is to take it, visibly enough that it changes what the people around you believe is permitted.`,
        shadow: `You inherit the caution and call it wisdom. You reach the age where the leap becomes possible and produce excellent reasons not to — the same reasons both lines gave.`,
        invitation: `Take one visible risk today that your family would consider unnecessary.`,
