  ...
  const positions = {
    ...
    SPP: {
      ...
      1: {
        ...
        invitation: `Ask yourself honestly what you're afraid would happen if you let something be done worse than you'd do it. Hand something over today and let it be done worse than you'd do it. Don't take it back when it wobbles. Notice that the fire survives being carried by someone else's hands.`,
      ...
      8: {
        ...
        invitation: `Ask yourself honestly what you're still owed that you're prepared to die holding. Close one account today that will never be settled fairly. Forgive it, or apologise for your part, without waiting for the other side. Notice that releasing the debt doesn't erase that it was real.`,
      ...
      10: {
        ...
        invitation: `Ask yourself honestly what you're still trying to make add up. Look at the whole shape today, including the unfair parts, without adjusting the account. Let it stand as it actually was. Notice that the arc doesn't need to be proportional to be accepted as yours.`,
