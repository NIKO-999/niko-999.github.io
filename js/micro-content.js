...
window.DMicroContent = (function () {
  ...
  const nodes = {
    ...
    '21_LOVE': {
      ...
      path: `Let the relationship actually expand — a new place, a shared vision genuinely built together, room for both of you to keep growing rather than settling for what's already familiar. Real partnership here is meant to open outward, not just hold steady.`,
    ...
    '6_MON': {
      ...
      path: `Choose a direction built around genuine connection and commit to it fully, even without perfect certainty. Income builds through sustained commitment to a people-centered path, not through endlessly comparing options.`,
    ...
    '11_MON': {
      ...
      path: `Let your natural charisma become the explicit center of your professional offer, not just a pleasant side effect of it. Name the influence you carry, and build or seek work that pays for it directly.`,
    ...
    '12_MON': {
      ...
      path: `Let the pull toward sustained, patient service resolve into an actual professional path, even a modest first step into it. The depth only pays off once you build real practice around it.`,
    ...
    '21_MON': {
      ...
      path: `Let one part of your work deliberately cross a border — a client, a platform, a market — rather than assuming your reach has to stay local. Your financial growth tends to track how far your work is actually allowed to travel.`,
