...
window.DMicroContent = (function () {
  ...
  const nodes = {
    ...
    '1_F1': {
      ...
      mastery: `You carry a real, inherited pull to initiate a venture your paternal line wanted but never actually began. You recognize the shape of the unstarted thing the moment it crosses your path, as though you'd been briefed on it. That recognition is a genuine inheritance, not a random ambition — the line handed you both the pull and the capability to act on it. And when you do act, the launch tends to actually take, unlike the false starts before you.`,
      shadow: `You keep almost-launching something significant without ever fully committing to it. Underneath the almost-launching is often a fear that finishing what the line couldn't would somehow indict the ones who tried and stopped. You gather momentum right up to the actual commitment point and then quietly let it stall. The venture stays permanently at ninety percent, inherited and re-abandoned rather than completed.`,
      invitation: `Ask yourself honestly what finishing this would actually mean about the people who didn't. Take one real, committed step today on the venture you keep almost-starting. Make it the step that can't be quietly walked back. Notice that completing it honors the line rather than betraying it.`,
    },
    ...
    '2_F1': {
      ...
      mastery: `You carry real, sharp intuition, inherited from a line that was never given permission to trust its own instinct. You sense the accurate read on a situation before you can fully explain why. That instinct runs unusually deep precisely because it was never allowed expression before you. And when you follow it, it holds up, vindicating the trust the line withheld from itself.`,
      shadow: `You override a strong instinct the moment it can't be logically justified, silencing exactly what should be trusted. Underneath the override is often a fear that acting on unproven feeling would repeat whatever cost the line paid for trusting instinct once before. You demand rational proof for something that was never going to arrive rationally. The demand for justification kills the instinct before it ever gets tested.`,
    ...
    '3_F1': {
      ...
      mastery: `You carry real creative and nurturing capacity, inherited from a line that rigid masculinity never let fully express it. You generate warmth and make things grow, in relationships or in work, with a genuine gentleness. That capacity runs deep precisely because it was suppressed for a generation before reaching you. And expressing it openly doesn't cost you any of the strength people already recognize in you.`,
      shadow: `You keep that gentler, generative side private or minimized out of an old, unexamined caution about how it will be read. Underneath the caution is often a fear that visible warmth would be mistaken for weakness the way it may have been once before. You soften or hide the nurturing instinct in front of exactly the people who'd benefit most from seeing it. The hiding costs you closeness that visible warmth would otherwise create.`,
    ...
    '4_F1': {
      ...
      mastery: `You carry real leadership capacity, capable of holding authority with both firmness and genuine care at the same time. You give a clear directive and stay attuned to the person receiving it, without needing to sacrifice one for the other. That integrated authority is a real inheritance, correcting a pattern the line never quite balanced. And people trust the leadership because it's consistent, not because it's either harsh or permissive.`,
    ...
    '7_F1': {
      ...
      mastery: `You carry real, genuine drive toward ambitious goals, the capacity to set a large target and actually move toward it. You sustain momentum through the middle stretch where most drive quietly evaporates. That endurance is a real inheritance, one the line handed you along with the ambition itself. And you're capable of carrying a goal all the way to its actual completion, not just its early excitement.`,
    ...
    '8_F1': {
      ...
      invitation: `Ask yourself honestly whether this reaction fits the present situation or an older one underneath it. Name, as specifically as you can today, what the original unfairness in your paternal line actually was. Write it down or say it out loud, however incomplete the picture is. Notice whether the present reaction settles once the old one has a name.`,
    },
    ...
    '9_F1': {
      ...
      mastery: `You carry a real need for withdrawal, reflection, and solitary space, one your line likely never had permission to honor. You know precisely when you need to step back, and the insight you return with afterward is genuine. That self-knowledge is a real inheritance, correcting a pattern of constant availability the line couldn't break. And the solitude actually restores you, rather than becoming another form of avoidance.`,
      shadow: `You fill every available space with obligation to others, unable to justify solitude even when it's genuinely needed. Underneath the inability is often a fear that claiming withdrawal would be read as selfishness or abandonment, the way it may have been once before. You keep saying yes to presence long after your capacity for it has run out. The unclaimed solitude costs you the clarity it would have restored.`,
    ...
    '12_F1': {
      ...
      tagline: `A Design of the Named Need`,
      mastery: `You carry a real capacity for care and devotion to others, the ability to hold someone else's needs with genuine attention. You show up consistently for people who depend on you, in a way that actually meets what they need. That devotion is a real inheritance, one the line practiced deeply even at real cost to itself. And you can offer this care without it draining you completely, once you also count yourself in it.`,
      shadow: `Your own needs go perpetually unconsidered underneath that devotion, so thoroughly you struggle to even name them when asked. Underneath the struggle is often a fear that naming a need of your own would compete with, or diminish, the devotion the line built its identity on. You can list what everyone else requires in detail while drawing a blank on your own. The blank spot costs you a version of care that was never actually reciprocated.`,
    ...
    '13_F1': {
      ...
      mastery: `You carry a real capacity to meet necessary change directly, ending what's actually finished instead of dragging it forward. You recognize the exact moment a chapter is over, even when it's uncomfortable to admit. That directness is a real inheritance, correcting a pattern the line struggled with itself. And what follows the ending tends to be better than what you were protecting by delaying it.`,
      shadow: `You grip tightly to something you already know has run its course, simply because letting go feels dangerous in a way you can't quite name. Underneath the grip is often a fear that ending it would mean repeating a loss the line never fully recovered from. You maintain a relationship, role, or commitment well past the point you privately know it's over. The grip costs you the energy and space the ending would have freed up.`,
    ...
    '16_F1': {
      ...
      mastery: `You carry a real capacity to rebuild fully after loss, reconstructing something genuinely solid from what's left. You can commit completely to a new structure once the old one has actually fallen. That rebuilding capacity is a real inheritance, proven through whatever collapse the line actually survived. And what you build afterward holds up, because you're not holding part of yourself back from it.`,
    ...
    '17_F1': {
      ...
      mastery: `You carry a real capacity for genuine hope and faith in a better future, able to believe things can improve without it being naive. You hold ambition and realism together, imagining a better outcome you can actually work toward. That hopefulness is a real inheritance, one worth claiming even where the line struggled to sustain it. And speaking a real hope out loud tends to make it more, not less, achievable.`,
      shadow: `You default to reflexive cynicism, protecting against disappointment at the cost of ever genuinely believing things could improve. Underneath the cynicism is often a fear that hoping and then being let down would repeat a disappointment the line already absorbed once. You dismiss a genuine possibility before testing it, preferring the safety of low expectations. The cynicism costs you outcomes that real hope, tested, might actually have produced.`,
    ...
    '18_F1': {
      ...
      mastery: `You carry a real capacity to see clearly what's been operating in the background, naming a fear or pattern others leave unexamined. You can bring an unspoken dynamic into the light without flinching from what it reveals. That clarity is a real inheritance, one that starts to interrupt a fog the line lived inside without questioning. And naming what's actually there tends to be less frightening than the vague version was.`,
    ...
    '22_F1': {
      ...
      mastery: `You carry a real, genuine desire for freedom, adventure, and an unconventional path, one the line likely never got to follow. You can imagine and choose a less secure route because it's more genuinely yours. That desire is a real inheritance, worth honoring rather than trading away automatically for safety. And the unconventional choice tends to serve you well precisely because it's actually chosen, not defaulted into.`,
      shadow: `You default to the secure option reflexively, even in situations where the risk would actually be worth taking. Underneath the reflex is often a fear that choosing freedom would mean repeating an instability the line worked hard to escape. You pick the safe path automatically, without weighing whether this particular moment actually calls for caution. The reflex costs you a life more genuinely yours, traded quietly for a security you didn't actually need.`,
