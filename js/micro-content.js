...
window.DMicroContent = (function () {
  ...
  const nodes = {
    ...
    '2_LIFEPATH': {
      ...
      shadow: `Peace bought by staying quiet isn't peace — it's a debt with interest. You watch a conflict clearly enough to see what's true and still say nothing, because agreeing feels safer. That silence can read to others as agreement you never actually gave. Over time, the accumulated unsaid things can turn into a resentment nobody else even knows is there.`,
    ...
    '4_LIFEPATH': {
      ...
      shadow: `The same conviction that builds something durable hardens into a refusal to be moved on anything, including the small stuff that was never worth the fight. Structure that once protected you can quietly become structure that confines the people around you too. Over time, that rigidity can cost you exactly the flexibility a genuinely good plan sometimes needs. Being right in ten years is small comfort to the people who needed flexibility from you today.`,
    ...
    '11_LIFEPATH': {
      ...
      shadow: `You live in the gap between the size of what you can imagine and the size of what you've actually built, holding people to a standard the real world was never going to meet. That gap can leave the vision feeling more real to you than the ordinary progress actually being made. Over time, holding everything to an ideal can quietly rob real, solid progress of the credit it deserves. Ordinary days can feel like a letdown next to a vision this vivid.`,
    ...
    '22_LIFEPATH': {
      ...
      shadow: `The size of what you're capable of building doesn't leave much room for your own limits, and the body carrying this ambition tends to lag behind the mind driving it. That mismatch rarely announces itself until it's already cost you something. Over time, the scale of what feels achievable can quietly outpace what's actually sustainable to carry. Tirelessness this consistent can look like strength right up until it becomes the thing that finally breaks down.`,
    ...
    '33_LIFEPATH': {
      ...
      shadow: `Giving without limit slowly starts to look like disappearing — your needs quietly moved to the bottom of a list you never actually wrote down. The scale of what you're able to give can make it easy to mistake constant giving for the only acceptable version of this gift. Over time, that pattern can leave you depleted in the exact role meant to feel like purpose. Gentleness this consistent rarely gets the same gentleness offered back to it.`,
    ...
    '3_BIRTHDAY': {
      ...
      shadow: `You deflect anything that asks for real vulnerability behind one more joke, becoming the person everyone enjoys and nobody quite knows. The charm works so well that even you can lose track of what's underneath the performance. Over time, that pattern can leave you well-liked and genuinely lonely at the same time. Being the fun one can quietly become the only role anyone expects you to play.`,
    ...
    '4_BIRTHDAY': {
      ...
      shadow: `Your steadiness calcifies into rigidity — one right way to do a thing, and real frustration with anyone who suggests another. That certainty about the right approach can shut down a genuinely useful alternative before it's even been considered. Over time, that pattern can leave collaborators feeling managed rather than included. Consistency this reliable can be mistaken, even by you, for the only correct way to do things.`,
    ...
    '5_BIRTHDAY': {
      ...
      shadow: `Your adaptability becomes an excuse to never actually land anywhere, mistaking restlessness for growth. The ease of moving on can substitute for the harder work of actually staying with something difficult. Over time, that pattern can leave a long trail of interesting starts and comparatively few things carried through. Novelty is easy to chase and quick to fade, which is exactly what keeps the pattern running.`,
    ...
    '9_BIRTHDAY': {
      ...
      shadow: `Your compassion becomes depleting — giving until there's nothing left over, feeling everyone's pain so thoroughly your own gets lost in the noise. That sensitivity to other people can make your own needs genuinely hard to locate, let alone name. Over time, that pattern can leave you generous toward everyone except yourself. Feeling everything this fully rarely leaves much left over for feeling your own.`,
    ...
    '11_BIRTHDAY': {
      ...
      shadow: `This heightened sensitivity stays trapped in your own head, insight that never gets spoken because the intensity of it feels safer kept private. Keeping it private can feel protective, but it also means the insight never actually gets to help anyone. Over time, that pattern can leave real perception sitting unused, known only to you. The intensity of the knowing can make it feel too strange to say out loud, even when it's exactly right.`,
    ...
    '22_BIRTHDAY': {
      ...
      shadow: `This rare capability stalls at the planning stage — ambition so large it never fully commits to a first, imperfect, small step. The scale of the vision can make any single starting move feel too small to matter. Over time, that pattern can leave genuinely achievable projects stuck permanently at the blueprint stage. The bigger the vision, the easier it becomes to keep refining it instead of actually starting it.`,
    ...
    '33_BIRTHDAY': {
      ...
      shadow: `This depth of care becomes self-erasing — giving so completely that your own needs quietly stop registering as needs at all. The scale of what you're able to give can make it easy to mistake constant giving for the only acceptable version of this gift. Over time, that pattern can leave you depleted in the exact role that was meant to feel like purpose. Being this reliably needed rarely leaves room to notice when you need something back.`,
    ...
    '3_PYEAR': {
      ...
      shadow: `You scatter this abundant energy across too many fun, low-stakes distractions, leaving the creative work you care about unfinished. The sheer number of appealing options this year can make any single one feel less urgent to actually finish. Over time, that pattern can leave a year full of activity and comparatively little to show for it. A season built for visibility still needs something finished to actually show.`,
    ...
    '4_PYEAR': {
      ...
      shadow: `Necessary structure tips into rigid over-control — becoming so committed to the plan you can't adjust it even when it clearly needs revising. The seriousness of this year's work can make any deviation from the plan feel riskier than it actually is. Over time, that rigidity can cost you exactly the flexibility a genuinely good plan sometimes needs. A foundation is meant to hold weight, not to be so fixed it can never be corrected.`,
    ...
    '5_PYEAR': {
      ...
      shadow: `You chase every new option this year offers without letting any single one have the time it needs to actually become something real. The appeal of the next new thing can make whatever you already started feel finished before it actually is. Over time, that pattern can leave this year full of beginnings and comparatively few things carried through. Motion isn't the same as growth, even during a stretch built around motion.`,
    ...
    '8_PYEAR': {
      ...
      shadow: `You measure the entire year purely by results, letting anything that doesn't show up on a scoreboard quietly stop counting. The bigger the stakes get this year, the easier it becomes to justify ignoring what the pursuit is actually costing you. Over time, that pattern can leave real, meaningful progress feeling hollow simply because it wasn't measurable. Real consequence doesn't have to mean a year narrowed down to only what's countable.`,
    ...
    '9_PYEAR': {
      ...
      shadow: `You cling to what this year is trying to close, dragging an ending out well past the point it needed to end. Resisting a closing chapter doesn't stop it from closing — it just makes the closing harder. Over time, that resistance can cost more than the ending itself ever would have. Old identities or commitments may start to feel like they no longer fit, and holding on past that point rarely serves you.`,
    ...
    '11_PYEAR': {
      ...
      shadow: `You stay purely inspired without grounding any of it into something real, feeling electric all year with nothing actually built to show for it. The charge itself can feel like enough, right up until the year ends and little concrete is left to show for it. Over time, that pattern can leave real insight sitting unused, sealed inside you. A calling this intense still needs an actual outlet, or the intensity just becomes exhausting.`,
    ...
    '22_PYEAR': {
      ...
      shadow: `You overextend past your actual capacity, letting the scale of what's possible outpace what your body and nervous system can sustain. That mismatch rarely announces itself until it's already cost you something. Over time, the scale of what feels achievable this year can quietly outpace what's actually sustainable to carry. A year built for building something lasting still requires you to survive building it.`,
    ...
    '33_PYEAR': {
      ...
      shadow: `You give so completely to others this year that your own needs get quietly deprioritized, until sustainable service becomes depleting instead. The scale of what you're able to give this year can make it easy to mistake constant giving for the only acceptable version of this calling. Over time, that pattern can leave you depleted in the exact year meant to feel purposeful. A year built around deep service was never meant to be a year built around self-abandonment.`,
