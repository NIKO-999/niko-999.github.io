...
window.DMicroContent = (function () {
  ...
  const nodes = {
    ...
    '1_A': {
      ...
      why: `Wherever the Magician sits in your Core Character, it's describing the very first impression you make — the persona you carry into a room before a single word is spoken. People sense competence radiating off you: a coiled readiness, the sense that you could make things happen if you decided to. This is the mask of the doer, the one who looks like they already have a plan. It's not performance, exactly — it really is how you're wired — but it is the specific way your character presents itself to the world, distinct from what's actually happening underneath.`,
    ...
    '2_A': {
      ...
      why: `The High Priestess in your Core Character means the very first impression you give off is quiet depth — an unreadable quality that makes people sense there's more to you than what's on the surface, without being able to say exactly what. This is the persona of the keeper: composed, observant, giving away only what you choose to. People often feel like they have to earn access to you, and most of the time, they're right.`,
    ...
    '3_A': {
      ...
      why: `The Empress in your Core Character means your persona radiates warmth before you've said a word — people feel instinctively cared for, comfortable, like there's room for them around you. This is the nurturer's mask: soft where others are guarded, generous with attention, the kind of presence that makes people exhale. It's a real gift, and it's also the very first thing anyone registers about you.`,
    ...
    '4_A': {
      ...
      why: `The Emperor in your Core Character means people sense authority off you before you've claimed any — a solidity, a sense that you're someone who holds things together. This is the persona of natural command: steady posture, decisive presence, the kind of energy that makes a room quietly organize itself around you. People often defer to you by instinct, sometimes before you've even offered an opinion.`,
    ...
    '5_A': {
      ...
      why: `The Hierophant in your Core Character means your very presence reads as someone who knows how things are properly done — a persona of quiet authority on right and wrong, correct and incorrect, earned and unearned. People often come to you instinctively for guidance, assuming before you've said anything that you'll have a grounded, reliable answer. It's the mask of the trusted elder, regardless of your actual age.`,
    ...
    '6_A': {
      ...
      why: `The Lovers in your Core Character means your persona carries a quiet, magnetic quality of selectiveness — people sense that your attention and approval aren't handed out freely, which makes being genuinely chosen by you feel like it means something. This is the mask of discernment: warm, but visibly weighing, visibly valuing. People want to be picked by you, specifically because it's clear you don't pick everyone.`,
    ...
    '7_A': {
      ...
      why: `The Chariot in your Core Character gives you a persona of visible momentum — people sense direction in you, the impression of someone who's going somewhere and knows it, even in casual moments. This is the mask of forward motion: purposeful posture, a kind of contained urgency. People often assume you're busy, driven, or already in the middle of something important, whether or not that's literally true in the moment.`,
    ...
    '9_A': {
      ...
      why: `The Hermit in your Core Character gives off a persona of thoughtful reserve — people can tell, almost immediately, that you process things internally and need space to do it. This is the mask of quiet self-containment: measured, unhurried in conversation, giving the impression of someone with a rich internal world they're not in a rush to narrate. People often instinctively give you room without being asked.`,
    ...
    '10_A': {
      ...
      why: `The Wheel of Fortune in your Core Character means your persona carries an association with change — people sense that things move around you, that you're someone whose circumstances (and moods, and plans) turn more visibly than most. This is the mask of the mercurial: interesting, a little unpredictable, someone people watch with a kind of curiosity about what's coming next for you.`,
    ...
    '11_A': {
      ...
      why: `Strength in your Core Character gives you a persona of quiet, embodied steadiness — people sense, almost physically, that you can hold weight without cracking. This is the mask of calm capability: not loud confidence, but a grounded presence that makes people feel safe bringing you difficult things. Others often confide in you faster than they mean to, simply because something about your presence tells them it's safe.`,
    ...
    '12_A': {
      ...
      why: `The Hanged Man in your Core Character gives your persona a distinct, unhurried quality — people sense you're not moved by the same urgency everyone else runs on, that you see situations from an angle they hadn't considered. This is the mask of the patient outlier: calm in chaos, faintly unconventional, the person whose stillness in a crisis reads as almost strange until it turns out to be useful.`,
    ...
    '13_A': {
      ...
      why: `Transformation in your Core Character gives your persona a quiet intensity — people sense, without being told, that you've been through something that changed you, and it shows in a kind of grounded gravity most people your age or in your position don't carry. This is the mask of the survivor-turned-something-else: not fragile, not performing toughness, just visibly someone who's already met a version of collapse and kept going.`,
    ...
    '14_A': {
      ...
      why: `Temperance in your Core Character gives your persona a natural sense of balance — people read you as even-keeled, diplomatic, the one who can hold two opposing views in the same room without either side feeling dismissed. This is the mask of the mediator: easy to talk to, hard to offend, quietly trusted to keep things from tipping over. People often assume, correctly, that you're good in the middle of tension.`,
    ...
    '15_A': {
      ...
      why: `The Devil in your Core Character gives your persona a magnetic, slightly untamed edge — people sense something compelling and a little dangerous about you, even if you're genuinely gentle underneath it. This is the mask of raw appeal: intensity that draws people in, a sense that you know something about desire, power, or the material world that most people keep more carefully hidden.`,
    ...
    '16_A': {
      ...
      why: `The Tower in your Core Character gives your persona a charged, unpredictable edge — people sense that you're capable of cutting straight through a polite fiction the rest of the room is maintaining. This is the mask of the truth-jolt: not chaotic for its own sake, but carrying a kind of electric honesty that makes people both a little nervous around you and quietly relieved when you use it.`,
    ...
    '17_A': {
      ...
      why: `The Star in your Core Character gives your persona a quiet, steady optimism — people sense hope in you that hasn't hardened into naivety, a warmth that makes you feel like a genuinely safe person to be discouraged around. This is the mask of the believer: not blindly positive, but visibly unwilling to give up on things mattering, which draws people who are running low on their own hope.`,
    ...
    '18_A': {
      ...
      why: `The Moon in your Core Character gives your persona an unmistakable emotional depth — people sense there's a rich, shifting interior life behind your expression, even when you're not saying much. This is the mask of the dreamer: a little mysterious, hard to fully predict, someone people intuit is feeling more than they're showing. It draws people in with genuine curiosity about who you really are underneath it.`,
    ...
    '19_A': {
      ...
      why: `The Sun in your Core Character means your persona radiates genuine warmth and ease — people feel lighter, more themselves, simply by being around you. This is the mask of natural brightness: unforced joy, an authentic openness that puts people at ease almost instantly. It's one of the most immediately likable presentations in the whole system, and it usually is exactly what it looks like.`,
    ...
    '20_A': {
      ...
      why: `Judgement in your Core Character gives your persona a distinct sense of unfinished momentum — people sense you're in the middle of becoming someone, that a bigger version of you is actively arriving even if it isn't fully visible yet. This is the mask of imminent arrival: alert, a little restless, carrying the quiet charge of someone who's about to be called toward something larger.`,
    ...
    '21_A': {
      ...
      why: `The World in your Core Character means your persona radiates a sense of completion — people sense wholeness in you, an ease that reads as someone who's already arrived somewhere most people are still working toward. This is the mask of quiet mastery: put-together, self-possessed, the kind of presence people assume has already solved the things they're still struggling with.`,
    ...
    '22_A': {
      ...
      why: `The Fool in your Core Character gives your persona a genuine, unguarded openness — people sense there's no elaborate performance between you and them, that you meet each moment freshly rather than through a rehearsed social mask. This is the persona of uncomplicated presence: approachable, easy, the kind of person who makes others feel like they don't need to perform either.`,
    ...
    '2_B': {
      ...
      why: `Wherever the High Priestess lives in your Sky Line, it isn't just describing a personality trait — it's naming an actual spiritual talent: fluency in symbol, dream, and the kind of knowing that arrives before language catches up to it. You're built to sense what's forming before it's announced, to read the undercurrent in a room, a text, a life, before anyone else names it out loud. That's not a personality quirk. It's a genuine gift for interpretation — access to a layer of meaning most people walk straight past.`,
    ...
    '3_B': {
      ...
      why: `The Empress at the top of your matrix names a genuinely rare spiritual talent: your presence itself is generative. Ideas that were stuck start moving in rooms you're in. People who felt creatively barren find themselves suddenly fertile around you, often without being able to explain why. This isn't about what you produce — it's about what you activate in others simply by being fully, warmly present. Your divine gift is closer to a blessing than a skill: an ability to make things want to grow.`,
    ...
    '4_B': {
      ...
      why: `The Emperor in your Sky Line isn't about material ambition — it's a spiritual talent for structure itself: the gift of taking something vast, formless, or purely felt and building it a frame sturdy enough to actually hold. Where others have a spiritual experience and let it dissolve back into feeling, you have the instinct to organize it — into a discipline, a practice, a teachable system — so it can be returned to and built on rather than just remembered. Your divine talent is architecture in service of the sacred.`,
    ...
    '6_B': {
      ...
      why: `The Lovers at the top of your matrix marks a genuine spiritual gift: discernment. Not simply making choices, but sensing, almost bodily, the difference between a path that's spiritually true for you and one that's merely appealing — the pull of what looks impressive versus the quieter, harder-to-argue-with pull of what's actually yours to walk. Your divine talent is this exact clarity: an inner compass for calling, capable of distinguishing genuine resonance from borrowed conviction, even when the borrowed version is louder.`,
    ...
    '7_B': {
      ...
      why: `The Chariot in your Sky Line names a spiritual talent for sustained forward motion — the discipline to keep a practice going long after the initial inspiration that started it has faded. Where many people need continual proof that a spiritual path is "working" to stay on it, you carry something more durable: the capacity to keep moving on will alone, trusting the direction even through long stretches where nothing visibly confirms it. Your divine gift is spiritual perseverance — the ability to actually arrive somewhere, because you didn't stop.`,
    ...
    '8_B': {
      ...
      why: `Justice at the top of your matrix marks a spiritual talent most people don't have: an accurate, almost involuntary sense for when something claiming to be sacred has actually gone hollow — performance dressed as devotion, doctrine used to control rather than illuminate. Your divine gift is truth-sensing in the specific domain of meaning itself. You're not easily fooled by spiritual spectacle, and you carry a real responsibility to hold a clear, honest line about what's genuine and what's borrowed authority.`,
    ...
    '9_B': {
      ...
      why: `The Hermit in your Sky Line is naming something more specific than wisdom — it's naming a capacity for direct communion. Left alone with enough quiet, you don't just think clearly, you access a different register of consciousness altogether: a felt sense of something larger than the personal self, available to you in a way it isn't for most people without years of trained practice. Your divine talent is contemplative range — a natural aptitude for the states mystics spend lifetimes trying to reach.`,
    ...
    '10_B': {
      ...
      why: `Wherever the Wheel sits in your Sky Line, it marks a genuine talent for reading larger timing — not your own moods or rhythms, but the sense of an unfolding pattern bigger than any single event, a felt knowledge of when something is truly ready to turn. You have an instinct for divine timing: knowing when to wait and when the moment has actually arrived, even when nothing external has announced it yet. This is closer to a gift of trust than a gift of prediction — faith that the larger pattern is intelligent, even from inside a turn that looks like descent.`,
    ...
    '11_B': {
      ...
      why: `Strength in your Sky Line isn't physical toughness — it's a spiritual talent for staying present with raw, unruly inner states without needing to suppress or be ruled by them: fear you can sit inside without fleeing, desire you can feel fully without being driven by it, anger you can hold instead of either exploding or burying. Your divine gift is a gentle hand on your own wildness — the capacity to tame through presence and patience rather than force, which is a rarer and harder-won spiritual skill than it looks.`,
    ...
    '12_B': {
      ...
      why: `The Hanged Man in your Sky Line marks a spiritual talent for genuine surrender — not helplessness, but the deliberate, skilled release of control that opens a channel most people can only reach by accident, in crisis. You have a natural aptitude for the kind of stillness that isn't passive: choosing to stop pushing, stop directing, stop needing to understand from your usual angle, and finding that revelation arrives precisely in that release. Your divine gift is comfort inside not-knowing — genuine ease with paradox and mystery that most spiritual seekers spend years trying to develop.`,
    ...
    '13_B': {
      ...
      why: `Transformation in your Sky Line points to a specific spiritual talent: a capacity for genuine ego-death — the kind of dissolution where an old sense of self actually ends, not metaphorically, and something truer rises in its place. You likely carry more than one experience of this already, whether you have language for it or not. Your divine gift is a real aptitude for spiritual initiation, and often a corresponding gift for recognizing and accompanying that same process in other people going through their own.`,
    ...
    '14_B': {
      ...
      why: `Temperance in your Sky Line marks a genuine mediator's gift — the capacity to stand at the meeting point between different truths, different traditions, even the ordinary and the sacred, and hold both without needing either to collapse into the other. Where most people have to pick a side, you have real aptitude for the harder, rarer work: translating between worlds, carrying something true from one domain into a place that couldn't otherwise receive it. Your divine talent is genuine spiritual healing — the pouring between vessels that restores what's been separated.`,
    ...
    '15_B': {
      ...
      why: `The Devil in your Sky Line names an unusual and genuinely valuable spiritual talent: the capacity to look directly at darkness — your own unconscious material, taboo desire, collective shadow — without flinching away or spiritually bypassing it. Where many paths ask you to transcend the shadow before you've actually met it, your gift is meeting it first. Your divine talent is depth work: the willingness to go into the bound, the hidden, the disowned, and bring back something usable instead of just more fear.`,
    ...
    '16_B': {
      ...
      why: `The Tower in your Sky Line marks a genuine gift for sudden spiritual clarity — insight that arrives all at once, restructuring what you understood as true faster than gradual learning ever could. You're built to receive revelation as lightning rather than as slow accumulation, and alongside that, you carry a real talent for seeing straight through false spiritual structures — dogma, borrowed belief, comfortable illusion — the instant they stop being true, even when everyone around you is still invested in them.`,
    ...
    '17_B': {
      ...
      why: `The Star in your Sky Line marks a genuine wellspring gift — a capacity to generate hope and inspiration that isn't just a personal disposition, it's a resource other people are meant to draw from. In rooms that have lost their bearings, you're often the one whose faith stays lit without needing external proof, and that steadiness is contagious in a way that's hard to manufacture. Your divine talent is transmission: not just holding hope privately, but being a literal source other people can refill themselves from.`,
    ...
    '18_B': {
      ...
      why: `The Moon in your Sky Line marks a real visionary talent — a sensitivity to threshold states, dreams, and the layer of reality that exists between waking and unconscious, where most people feel disoriented and you feel oddly at home. You likely have vivid, meaningful dream life, a natural medium-like porousness to what's unseen, and access to symbolic language that speaks directly rather than needing translation. Your divine gift is fluency in liminal space — genuine comfort navigating what other people find disorienting or frightening.`,
    ...
    '19_B': {
      ...
      why: `The Sun in your Sky Line marks a rare gift: a direct, joyful connection to something larger that doesn't require struggle to access. Where many spiritual paths are built around earning insight through suffering, you carry a natural aptitude for clarity that simply arrives — light, immediate, undramatic. Your divine talent is proof, by example, that depth and ease aren't opposites; that joy itself can be a genuine spiritual practice, not just a byproduct of having survived something hard.`,
    ...
    '20_B': {
      ...
      why: `Judgement in your Sky Line marks a genuine gift for hearing calling clearly — where many people spend years trying to discern their purpose, you have a real aptitude for recognizing a summons when it arrives, distinguishing it from noise or wishful thinking. That clarity is often a gift you can offer others too: something in you can recognize when someone nearby is being called toward their own awakening, sometimes before they can hear it themselves. Your divine talent is vocational hearing — genuine discernment of what's actually being asked of a life.`,
    ...
    '21_B': {
      ...
      why: `The World in your Sky Line marks a genuine talent for spiritual wholeness — the capacity to hold many different dimensions of understanding at once, rather than mastering one narrow lane and stopping there. Where most spiritual growth happens piece by piece, you have a real aptitude for integration itself: weaving different practices, traditions, or ways of knowing into one coherent, embodied whole rather than experiencing them as competing systems. Your divine talent is synthesis at the level of an entire life, not just a single insight.`,
    ...
    '22_B': {
      ...
      why: `The Fool in your Sky Line marks a rare spiritual talent: direct, unmediated access to the sacred, without needing a doctrine, a teacher, or a credential to grant you permission first. Where many spiritual seekers have to earn their way toward openness through years of study, you carry something closer to a natural passport — trust itself functioning as a spiritual technology, letting genuine experience reach you before you've built any framework to explain it. Your divine talent is openness so complete it doesn't require proof.`,
    ...
    '1_C': {
      ...
      why: `The Magician on your Earth Line means your material potential runs on origination — you have a real knack for spotting an opening and turning it into income before anyone else has finished thinking about it. This is entrepreneurial instinct at the level of your actual bank account: resourcefulness that converts attention and initiative directly into material result. Where others need infrastructure before they'll start, you can generate real value from very little.`,
    ...
    '2_C': {
      ...
      why: `The High Priestess on your Earth Line gives you a genuinely intuitive relationship with material timing — a felt sense for when to act and when to hold that often outperforms whatever the visible data suggests. Your financial instincts run deep rather than loud: quiet certainty about a decision arriving before you can fully explain why. This is real material intelligence, just not the kind that shows its work.`,
    ...
    '3_C': {
      ...
      why: `The Empress on your Earth Line means your material abundance is generative rather than transactional — wealth that grows from something you tend and nurture over time, whether that's a creative practice, a business, or a body of work, rather than from a single transaction or grind. You have a real gift for cultivating material resources the way you'd cultivate anything alive: patiently, with genuine care for the process, not just the yield.`,
    ...
    '5_C': {
      ...
      why: `The Hierophant on your Earth Line means your material security is built through inherited or learned systems — proven structures, mentorship, tradition-tested methods rather than improvisation. You have a genuine gift for absorbing how wealth actually gets built from people who've already done it, and applying that knowledge with real discipline. This is material wisdom passed down and put into practice, not reinvented from scratch.`,
    ...
    '6_C': {
      ...
      why: `The Lovers on your Earth Line means your material success is tied directly to alignment — you build real, sustainable wealth only through work and investments that actually reflect your values, and you struggle, often visibly, to profit from anything that doesn't. This is a genuine material discernment: an instinct that steers you away from lucrative-looking options that would cost you something you're not willing to pay.`,
    ...
    '7_C': {
      ...
      why: `The Chariot on your Earth Line means your material security comes from sustained, willed momentum — a financial life driven forward by real discipline rather than luck or windfall. You have a genuine capacity to set a material goal and steer toward it through setbacks that would derail someone with less follow-through. This is wealth-building as an act of sustained navigation, not a single lucky break.`,
    ...
    '8_C': {
      ...
      why: `Justice on your Earth Line ties your material security directly to fairness — real, durable wealth for you comes through balanced transactions, honest dealing, and contracts that actually hold up, rather than through advantage taken or corners cut. You likely have a genuine, almost involuntary aversion to material gain that came at someone else's unfair expense, and a matching gift for structuring deals that are actually equitable.`,
    ...
    '9_C': {
      ...
      why: `The Hermit on your Earth Line means your material security is built through depth rather than breadth — specialized expertise developed largely alone, which becomes genuinely valuable precisely because so few people have gone as deep as you have. You have real material potential in the solitary mastery of a specific craft, subject, or skill, converted into income through the rarity of what you actually know.`,
    ...
    '10_C': {
      ...
      why: `The Wheel of Fortune on your Earth Line ties your material fortune to timing — a genuine capacity to sense when a financial cycle is turning, when to invest and when to hold back, that outperforms rigid, fixed strategies. Your wealth doesn't arrive in a straight line; it arrives in identifiable seasons, and part of your real material gift is reading which season you're actually in.`,
    ...
    '11_C': {
      ...
      why: `Strength on your Earth Line gives you a genuine material endurance — a capacity to hold steady through financial pressure, downturns, or scarcity that would rattle most people, without panicking into rash decisions. This is real resilience at the level of your bank account: patience under material strain, and the steadiness to keep making sound decisions even when the numbers are frightening.`,
    ...
    '12_C': {
      ...
      why: `The Hanged Man on your Earth Line means your material path is genuinely unconventional — real financial breakthroughs for you tend to come from stepping back from the expected route, seeing your career or income differently than the standard advice would suggest. You have a real gift for material patience: the willingness to earn less by conventional measures for a while in exchange for a perspective that eventually pays off in ways a straight line wouldn't have.`,
    ...
    '13_C': {
      ...
      why: `Transformation on your Earth Line means your material growth happens through genuine reinvention — letting an outdated income source, career identity, or financial strategy actually die so a better-fitting one can take its place. You have a real capacity most people lack: the willingness to release material security that's become familiar but limiting, in service of a bigger version that requires the old one to end first.`,
    ...
    '14_C': {
      ...
      why: `Temperance on your Earth Line gives you a genuine material gift for blending — combining multiple income streams, investment strategies, or financial approaches into one sustainable whole rather than betting everything on a single method. You have real patience for letting a diversified financial life mature slowly, trusting that the combination will outperform any single aggressive bet.`,
    ...
    '15_C': {
      ...
      why: `The Devil on your Earth Line gives you an unusually honest, unflinching relationship with material power — you understand, more clearly than most people are willing to admit, exactly how money, status, and security actually work on people, including you. This is real material intelligence: a genuine gift for generating resources and building leverage, undistracted by the polite fictions other people tell themselves about wealth.`,
    ...
    '16_C': {
      ...
      why: `The Tower on your Earth Line gives you a genuine gift for sudden material clarity — an ability to see, often well before other people are willing to, that a job, investment, or financial structure is built on a foundation that won't hold. Your material breakthroughs tend to arrive fast rather than gradually: a sudden, decisive reorganization of your financial life once the illusion holding an unstable structure together finally becomes visible to you.`,
    ...
    '18_C': {
      ...
      why: `The Moon on your Earth Line gives you a genuinely sensitive material intuition — a felt sense for hidden risk or opportunity in a financial situation well before it shows up in any visible data. You often know something is off (or promising) about a deal, a job, an investment, long before you could point to concrete evidence, and that instinct is frequently right.`,
    ...
    '19_C': {
      ...
      why: `The Sun on your Earth Line means your material abundance is tied directly to authenticity and joy — you build real, sustainable wealth most easily through work that genuinely feels like you, offered visibly and without the heaviness of grinding through something you don't believe in. You have a natural, uncomplicated ease with money that most people spend years trying to develop.`,
    ...
    '20_C': {
      ...
      why: `Judgement on your Earth Line means your material life is oriented around a genuine vocational summons — an inner sense, growing harder to ignore, that your current income source no longer matches who you've become, and something truer is asking to be answered. This is a real material gift: the capacity to recognize when it's time to leave a financially adequate but personally outgrown position for one that actually fits.`,
    ...
    '21_C': {
      ...
      why: `The World on your Earth Line means your material path is oriented toward genuine, lasting completion — real financial mastery that comes from seeing a plan through its full cycle rather than perpetually restarting. You have a real capacity most people lack: the ability to actually feel and recognize when a level of material security has been reached, rather than immediately redefining "enough" upward the moment you arrive.`,
    ...
    '22_C': {
      ...
      why: `The Fool on your Earth Line gives you a genuine, uncommon material courage — a willingness to start a financial venture, a new income path, or a real risk without needing a guarantee first. This is trust functioning as financial strategy: real openness to material possibility that isn't waiting for certainty before it moves, which lets you access opportunities that people requiring more proof simply never reach.`,
    ...
    '1_E': {
      ...
      why: `The Magician sits at the absolute center of your matrix, in your Soul Center — your foundation of purpose — and it means your core purpose isn't a fixed destination, it's origination itself. You're here to be a source: someone through whom things get started, willed into being, brought from idea into form. At the deepest level, you feel most like yourself not when you've arrived somewhere, but in the act of beginning something real.`,
    ...
    '2_E': {
      ...
      why: `The High Priestess at the center of your matrix means your foundation of purpose is inner knowing itself — you're here to develop and trust a relationship with truth that doesn't depend on outside confirmation. At your core, you feel most like yourself in moments of quiet certainty, when something in you knows before your mind has caught up. Your soul's work is learning to act from that knowing rather than waiting for permission to believe it.`,
    ...
    '3_E': {
      ...
      why: `The Empress at the center of your matrix means your foundation of purpose is generativity itself — you're here to nurture something into being, whether a creative body of work, a family, a community, or your own unfolding life. At your core, you feel most like yourself when you're actively growing something, tending it with real care rather than rushing its unfolding. This is purpose as cultivation, not achievement.`,
    ...
    '4_E': {
      ...
      why: `The Emperor at the center of your matrix means your foundation of purpose is structure itself — you're here to build something durable, whether a family, an institution, a body of work, or your own inner architecture, that can actually hold weight over time. At your core, you feel most like yourself when you're constructing something meant to last, not chasing whatever's exciting in the moment.`,
    ...
    '5_E': {
      ...
      why: `The Hierophant at the center of your matrix means your foundation of purpose is transmission — you're here to receive something real (wisdom, tradition, hard-won understanding) and carry it forward to whoever needs it next. At your core, you feel most like yourself when you're either learning something deeply or teaching it, part of a lineage that runs through you rather than starting or ending with you.`,
    ...
    '6_E': {
      ...
      why: `The Lovers at the center of your matrix means your foundation of purpose is alignment — you're here to keep choosing, again and again, whatever actually reflects your real values over what's simply easy or expected. At your core, you feel most like yourself in the moment of a clean, values-driven choice, even a hard one. Your soul's work is less about a single destination than about a lifetime of aligned decisions.`,
    ...
    '8_E': {
      ...
      why: `Justice at the center of your matrix means your foundation of purpose is integrity itself — you're here to be someone whose actions and words actually match, consistently, in a world where that's rarer than it should be. At your core, you feel most like yourself when you're being genuinely honest, even when it costs you something. Your soul's deepest orientation is toward truth held steady, not truth wielded as a weapon.`,
    ...
    '9_E': {
      ...
      why: `The Hermit at the center of your matrix means your foundation of purpose is found through withdrawal — you're here to develop a genuine relationship with your own depths, in solitude, before that depth can mean anything to anyone else. At your core, you feel most like yourself in quiet, unhurried reflection, and your sense of purpose tends to clarify in exactly those moments, not in the busy pursuit of it.`,
    ...
    '11_E': {
      ...
      why: `Strength at the center of your matrix means your foundation of purpose is embodied endurance — you're here to develop the capacity to stay present, gentle, and steady under real pressure, rather than dominating it or collapsing beneath it. At your core, you feel most like yourself in the quiet moments of holding something difficult without needing to fight it or flee it.`,
    ...
    '12_E': {
      ...
      why: `The Hanged Man at the center of your matrix means your foundation of purpose is discovered through voluntary surrender — you're here to find meaning not by pushing forward in the expected direction, but by occasionally releasing your grip entirely and letting a different orientation show you something new. At your core, you feel most like yourself in the moments you've stopped forcing an answer and let one arrive instead.`,
    ...
    '13_E': {
      ...
      why: `Transformation at the center of your matrix means your foundation of purpose is genuine metamorphosis — you're here to keep letting old versions of yourself actually die so a truer one can take their place. At your core, you feel most like yourself not in any fixed identity, but in the act of becoming, again and again, willing to release what you were for the sake of what's next.`,
    ...
    '14_E': {
      ...
      why: `Temperance at the center of your matrix means your foundation of purpose is integration itself — you're here to hold seemingly opposed parts of yourself or your life in patient balance, rather than resolving the tension by picking a side. At your core, you feel most like yourself in the space between extremes, where genuine synthesis happens slowly, over time.`,
    ...
    '15_E': {
      ...
      why: `The Devil at the center of your matrix means your foundation of purpose runs directly through your own shadow — you're here to face what's bound, hidden, or disowned in yourself with unusual honesty, and find genuine liberation on the other side of that honesty. At your core, you feel most like yourself not in spite of your darker material, but through actually metabolizing it instead of denying it.`,
    ...
    '16_E': {
      ...
      why: `The Tower at the center of your matrix means your foundation of purpose gets clarified through sudden collapse and rebuilding — you're here to periodically let a false structure in your life come down fast, and to trust that the resulting clarity, however disorienting, is actually pointing you truer. At your core, you feel most like yourself in the aftermath of a real reorganization, once the dust settles and you can see clearly again.`,
    ...
    '18_E': {
      ...
      why: `The Moon at the center of your matrix means your foundation of purpose runs through your emotional and unconscious depths — you're here to trust the parts of yourself that can't be fully explained or justified, letting dreams, feelings, and intuition guide you as much as logic does. At your core, you feel most like yourself when you're honoring what you sense rather than only what you can prove.`,
    ...
    '19_E': {
      ...
      why: `The Sun at the center of your matrix means your foundation of purpose is uncomplicated in a way that can be hard to trust: you're here to be authentically, visibly yourself, and to let the resulting warmth and vitality do their own work in the world. At your core, you feel most like yourself in moments of genuine, unguarded joy — not chasing a bigger mission, but simply radiating who you already are.`,
    ...
    '20_E': {
      ...
      why: `Judgement at the center of your matrix means your foundation of purpose is an ongoing awakening — you're here to keep answering an inner summons toward a fuller version of yourself, again and again, rather than settling permanently into any single identity. At your core, you feel most like yourself in the moments you actually rise to meet a call you could have easily ignored.`,
    ...
    '21_E': {
      ...
      why: `The World at the center of your matrix means your foundation of purpose is genuine completion — you're here to integrate the many pieces of your life and self into an actual, felt wholeness, not to chase achievement after achievement without ever letting yourself land. At your core, you feel most like yourself in moments of real, earned arrival, however temporary.`,
    ...
    '22_E': {
      ...
      why: `The Fool at the center of your matrix means your foundation of purpose isn't a fixed destination at all — it's the ongoing willingness to begin again, with real trust, regardless of what the last chapter did or didn't resolve. At your core, you feel most like yourself standing at the edge of something new, choosing to step forward without needing a guarantee first.`,
    ...
    '1_LOVE': {
      ...
      why: `The Magician governs your relationship channel, meaning intimacy runs on the frequency of origination — you're drawn to partners with real agency, people who turn intention into action, and in return you offer a rare gift: the ability to make a relationship feel alive, to generate momentum in a connection that might otherwise stall. For you, love often starts with genuine excitement, a spark that both people can feel building something together in real time.`,
    ...
    '2_LOVE': {
      ...
      why: `The High Priestess governs your relationship channel, meaning intimacy for you runs on depth and quiet knowing rather than surface chemistry. You're drawn to partners who carry real interiority, and you offer something rare in return: patient, perceptive attention that makes people feel truly seen rather than just looked at. Your love tends to build slowly, through accumulated trust rather than instant certainty.`,
    ...
    '3_LOVE': {
      ...
      why: `The Empress governs your relationship channel, meaning love for you is expressed through nurturing — genuine, generous care that makes a partner feel tended to in a way they may never have experienced before. You're drawn to people you can pour into, and your gift for creating warmth and abundance in a relationship is real and rare.`,
    ...
    '4_LOVE': {
      ...
      why: `The Emperor governs your relationship channel, meaning love for you is expressed through structure and reliability — you build relationships the way you'd build anything meant to last, with real commitment to the container itself: consistency, follow-through, a partner who can trust exactly where they stand with you. You're drawn to partners who value that same solidity.`,
    ...
    '6_LOVE': {
      ...
      why: `The Lovers governing your relationship channel is almost too on the nose — but what it actually means is that your love is built on genuine alignment: shared values, a real sense of choosing each other deliberately rather than falling together by convenience. You're drawn to partners whose core principles genuinely match yours, and the relationship itself becomes an ongoing series of aligned choices rather than one initial spark.`,
    ...
    '7_LOVE': {
      ...
      why: `The Chariot governing your relationship channel means love for you thrives on shared direction — you're drawn to partners who are also going somewhere, who bring their own momentum to the relationship rather than needing you to supply all of it. At your best, love feels like navigating life together, two people steering a shared course with mutual respect for each other's will.`,
    ...
    '8_LOVE': {
      ...
      why: `Justice governing your relationship channel means intimacy for you runs on fairness — you're drawn to partners who follow through on what they say, who hold themselves accountable the way you hold yourself, and you offer a relationship built on genuine reciprocity rather than unspoken imbalance. Trust, for you, is built transaction by transaction, promise by kept promise.`,
    ...
    '9_LOVE': {
      ...
      why: `The Hermit governing your relationship channel means intimacy for you includes real respect for solitude — you're drawn to partners who have their own rich inner life and don't need constant togetherness to feel connected. Your love is patient and deep rather than constant and loud, built in the quiet moments as much as the shared ones.`,
    ...
    '10_LOVE': {
      ...
      why: `The Wheel of Fortune governing your relationship channel means your love life genuinely moves in cycles — periods of real connection followed by periods of solitude or change, relationships that seem to arrive right when you're ready for them. You have a real gift for meeting a relationship's current season honestly, rather than forcing permanence on something that's naturally shifting.`,
    ...
    '11_LOVE': {
      ...
      why: `Strength governing your relationship channel means love for you is expressed through embodied calm — you're the partner who can hold a hard conversation, a difficult season, or a partner's raw emotion without flinching or needing to fix it immediately. Partners often feel safest with you specifically because your steadiness doesn't waver under real pressure.`,
    ...
    '12_LOVE': {
      ...
      why: `The Hanged Man governing your relationship channel means intimacy for you often arrives through surrender rather than pursuit — real connection tends to show up once you've released your grip on how or when it's supposed to happen. You have a genuine gift for seeing a relationship from an angle a partner hadn't considered, patient enough to let understanding unfold rather than forcing resolution.`,
    ...
    '13_LOVE': {
      ...
      why: `Transformation governing your relationship channel means love for you is genuinely metamorphic — real relationships change who you are, and you're drawn to partners capable of that same depth of transformation rather than people who'll keep you exactly as you were. You bring real intensity and a willingness to actually grow because of a connection, not just alongside it.`,
    ...
    '14_LOVE': {
      ...
      why: `Temperance governing your relationship channel means love for you is expressed through patient integration — you're genuinely skilled at blending two different lives, temperaments, or even value systems into something that works for both people, without either partner losing themselves in the process. Your relationships tend to feel balanced, considerate, genuinely fair to both sides.`,
    ...
    '15_LOVE': {
      ...
      why: `The Devil governing your relationship channel means your romantic connections run on real, undeniable magnetism — physical chemistry, material compatibility, an intensity that's honest about desire rather than polite about it. You're drawn to partners who match that intensity, and you offer a rare willingness to actually engage with the less "acceptable" parts of intimacy: desire, power, need.`,
    ...
    '16_LOVE': {
      ...
      why: `The Tower governing your relationship channel means you have real, often unwelcome clarity about your relationships — you sense when something's fundamentally not working well before it would be convenient to admit it, and you're capable of ending things decisively once that clarity fully lands. This honesty, while disruptive, spares you years spent inside a slowly failing connection.`,
    ...
    '18_LOVE': {
      ...
      why: `The Moon governing your relationship channel means intimacy for you runs on emotional and intuitive depth — you sense a connection's truth before you can articulate it, drawn to partners who can meet you in a felt, sometimes wordless understanding. Your relationships carry real emotional richness, a shared inner world that doesn't always need explaining.`,
    ...
    '19_LOVE': {
      ...
      why: `The Sun governing your relationship channel means love for you is meant to feel genuinely light — real, sustainable relationships for you run on authentic joy and ease rather than struggle or proving yourself. You're drawn to partners who can be fully themselves around you, and you offer the same unguarded warmth in return.`,
    ...
    '20_LOVE': {
      ...
      why: `Judgement governing your relationship channel means your romantic connections tend to function as genuine catalysts — partners who call something larger out of you, relationships that coincide with real periods of personal awakening. You're drawn to people who see a fuller version of you than you've fully claimed yet, and you offer that same recognition in return.`,
    ...
    '22_LOVE': {
      ...
      why: `The Fool governing your relationship channel means you carry a genuine, uncommon openness to love — a willingness to step into a real connection without needing certainty about where it'll lead. You offer partners real freshness: presence without an agenda, trust extended before it's been fully earned, which lets intimacy begin faster and more genuinely than caution usually allows.`,
    ...
    '1_MON': {
      ...
      why: `The Magician governs your money channel, meaning your wealth potential is tied directly to work that lets you originate — building something from nothing, launching, creating, initiating. You're not suited to a fixed, pre-built role; your income flows most freely when your profession gives you real room to generate something new rather than maintain something already built.`,
    ...
    '2_MON': {
      ...
      why: `The High Priestess governs your money channel, meaning your ideal profession draws on intuitive, often behind-the-scenes insight — work where your instinct for what's true or what's coming matters more than loud, visible credentials. You're suited to roles that trust your read on a situation, even before it's fully explainable.`,
    ...
    '3_MON': {
      ...
      why: `The Empress governs your money channel, meaning your wealth potential flows through generative, nurturing work — creative fields, caregiving, cultivation of any kind, roles where you get to grow something (a project, a person, a body of work) rather than simply manage an existing system. Your income thrives when your profession lets you actually create.`,
    ...
    '4_MON': {
      ...
      why: `The Emperor governs your money channel, meaning your wealth potential flows through roles that let you build or govern structure — leadership, management, systems-building, work where your capacity for order and responsibility is actually put to use rather than boxed in by someone else's framework. You thrive financially when you're given real authority to organize.`,
    ...
    '5_MON': {
      ...
      why: `The Hierophant governs your money channel, meaning your wealth potential flows through teaching, mentoring, or tradition-rooted work — professions where you're transmitting real, earned knowledge to someone else, whether formally (education, training) or informally (mentorship within any field). Your income thrives when your profession includes passing something on.`,
    ...
    '6_MON': {
      ...
      why: `The Lovers governing your money channel means your wealth potential is directly tied to values-alignment in your profession — you simply cannot generate sustainable income from work that conflicts with what you actually believe, no matter how lucrative it looks on paper. Money flows most easily through career choices made from genuine conviction rather than convenience.`,
    ...
    '7_MON': {
      ...
      why: `The Chariot governs your money channel, meaning your wealth potential flows through work with real, self-directed momentum — a profession where you're visibly moving toward a goal you've set, not just executing someone else's static task list. Your income thrives when your career has genuine forward motion you control.`,
    ...
    '8_MON': {
      ...
      why: `Justice governs your money channel, meaning your wealth potential flows through work grounded in fairness and accountability — law, mediation, ethics-driven business, any profession where your reputation for honest dealing is itself a professional asset. Your income thrives in roles where integrity is actually rewarded, not just expected.`,
    ...
    '9_MON': {
      ...
      why: `The Hermit governs your money channel, meaning your wealth potential flows through specialized, often independent expertise — work that rewards how deep you've gone in one specific area rather than how broadly you network or collaborate. Your income thrives in roles that let you work with real autonomy, converting solitary mastery into a valuable, sought-after skill.`,
    ...
    '10_MON': {
      ...
      why: `The Wheel of Fortune governs your money channel, meaning your wealth potential flows through career flexibility — work that can adapt to cycles and shifting conditions rather than professions demanding rigid permanence. You thrive financially when your career has room to change shape as circumstances turn, rather than punishing you for needing to pivot.`,
    ...
    '11_MON': {
      ...
      why: `Strength governs your money channel, meaning your wealth potential flows through work that draws on steady endurance — professions where staying calm and capable under real pressure is itself the valuable skill, whether that's crisis work, high-stakes coordination, or any role others burn out of faster than you do. Your income thrives where your composure is actually the asset being paid for.`,
    ...
    '12_MON': {
      ...
      why: `The Hanged Man governs your money channel, meaning your wealth potential flows through an unconventional professional path — work you found by stepping back from the expected route and seeing your options from an angle other people hadn't considered. Your income thrives when you trust that different path rather than forcing yourself into a conventional one that doesn't actually fit.`,
    ...
    '13_MON': {
      ...
      why: `Transformation governs your money channel, meaning your wealth potential flows through professional reinvention — real financial growth for you tends to require releasing an outdated career identity or income source so a better-fitting one can take its place. You thrive financially in fields or roles that reward genuine change rather than punishing it.`,
    ...
    '14_MON': {
      ...
      why: `Temperance governs your money channel, meaning your wealth potential flows through professional blending — combining skills, fields, or roles that other people keep siloed, into one integrated career that plays to your full range. Your income thrives when you're not forced to specialize narrowly, but allowed to synthesize.`,
    ...
    '15_MON': {
      ...
      why: `The Devil governs your money channel, meaning your wealth potential flows through work that engages directly with material power — negotiation, finance, sales, any field where understanding what actually drives people materially is the genuine skill being paid for. You thrive financially in roles that don't pretend money and leverage aren't real forces.`,
    ...
    '16_MON': {
      ...
      why: `The Tower governs your money channel, meaning your wealth potential flows through work involving disruption — crisis management, innovation, any field that pays for the ability to see a failing structure clearly and reorganize fast. You thrive financially in roles that value sudden, decisive clarity over slow, incremental process.`,
    ...
    '18_MON': {
      ...
      why: `The Moon governs your money channel, meaning your wealth potential flows through work that draws on intuitive or emotionally attuned insight — creative fields, therapeutic work, anything where reading an unspoken undercurrent is the actual skill. You thrive financially in roles that don't demand you justify every insight with hard data before it's trusted.`,
    ...
    '19_MON': {
      ...
      why: `The Sun governs your money channel, meaning your wealth potential flows most easily through work that genuinely feels like you — authentic, visible, offered without the heaviness of grinding through something that doesn't fit. You thrive financially in professions where your natural personality is actually the asset, not something to suppress for professionalism's sake.`,
    ...
    '20_MON': {
      ...
      why: `Judgement governs your money channel, meaning your wealth potential flows most freely through work tied to a genuine vocational calling — a career that keeps summoning you, growing harder to ignore, even if the practical version of it feels riskier than staying put. You thrive financially once you actually answer that call rather than settling for merely adequate.`,
    ...
    '22_MON': {
      ...
      why: `The Fool governs your money channel, meaning your wealth potential flows through professional risk-taking — a willingness to start a new venture, role, or path without needing certainty first. You thrive financially in careers or ventures that reward genuine courage, letting you access opportunities that people requiring more proof simply never reach.`,
    ...
    '1_F': {
      ...
      why: `The Magician sits in your Paternal Spiritual corner, marking a generational instruction about action and belief: something in your father's line treated spirituality as active rather than passive — faith proven through initiative, will, and the capacity to make things happen, rather than through quiet acceptance. You inherited raw material here, not a finished belief: an orientation toward spiritual agency that's yours to examine and consciously keep or release.`,
    ...
    '2_F': {
      ...
      why: `The High Priestess sits in your Paternal Spiritual corner, marking a generational pattern of intuitive knowing that was likely never given open expression — a paternal line more comfortable with what could be proven than what was simply sensed. You inherited the raw material of that suppressed intuition: a real capacity for inner knowing that may have gone unspoken for at least a generation before you.`,
    ...
    '3_F': {
      ...
      why: `The Empress sits in your Paternal Spiritual corner, marking a generational instruction about generativity and spiritual abundance — something in your father's line treated spiritual nurturing or ease as scarce, perhaps something worked for rather than simply received. You inherited raw material here: a real capacity for spiritual abundance that may have arrived wrapped in an old belief that it has to be difficult to be legitimate.`,
    ...
    '4_F': {
      ...
      why: `The Emperor sits in your Paternal Spiritual corner, marking a generational instruction about spiritual authority and structure — a paternal line that likely held firm, hierarchical beliefs about how faith should be organized and who holds the right to define it. You inherited raw material here: a real respect for spiritual structure that arrived bundled with an unexamined belief about where authority is allowed to live.`,
    ...
    '5_F': {
      ...
      why: `The Hierophant sits in your Paternal Spiritual corner, marking the most literal version of this inheritance: an actual doctrine, formal tradition, or specific set of codified beliefs passed down through your father's line, not just a general spiritual orientation. You inherited raw material here in its most concrete form — real teachings, rules, or a specific framework that was handed to you largely intact.`,
    ...
    '6_F': {
      ...
      why: `The Lovers sit in your Paternal Spiritual corner, marking a generational instruction about spiritual choice and commitment — your father's line likely modeled a specific idea of what devoted, "correct" spiritual commitment looks like, perhaps built around loyalty to one path rather than genuine, examined alignment. You inherited raw material here: real capacity for spiritual devotion that arrived with an inherited definition of what that devotion should look like.`,
    ...
    '7_F': {
      ...
      why: `The Chariot sits in your Paternal Spiritual corner, marking a generational instruction about disciplined spiritual pursuit — your father's line likely modeled faith as something actively steered and pushed toward, with real emphasis on willpower and forward motion. You inherited raw material here: genuine spiritual discipline that arrived bundled with an unexamined belief that stillness or rest is a kind of spiritual failure.`,
    ...
    '8_F': {
      ...
      why: `Justice sits in your Paternal Spiritual corner, marking a generational instruction about moral and spiritual accountability — your father's line likely held firm beliefs about consequence, fairness, and what's owed in the spiritual ledger. You inherited raw material here: a real sense of spiritual integrity that arrived with an inherited standard for exactly how harshly, or how precisely, accounts are supposed to be settled.`,
    ...
    '9_F': {
      ...
      why: `The Hermit sits in your Paternal Spiritual corner, marking a generational instruction about solitary spiritual seeking — your father's line likely modeled faith as something pursued in withdrawal, privately, without much communal sharing. You inherited raw material here: a real capacity for deep, solitary spiritual reflection that arrived with an inherited assumption that spiritual matters simply aren't discussed.`,
    ...
    '10_F': {
      ...
      why: `The Wheel of Fortune sits in your Paternal Spiritual corner, marking a generational instruction about fate and spiritual cycles — your father's line likely held a specific belief about how much control a person actually has over their own turning, whether leaning toward fatalism or toward active participation in one's fortune. You inherited raw material here: a real relationship to spiritual timing that arrived with an inherited answer to a question worth re-asking.`,
    ...
    '11_F': {
      ...
      why: `Strength sits in your Paternal Spiritual corner, marking a generational instruction about spiritual endurance — your father's line likely modeled faith as quiet, uncomplaining fortitude, strength shown through never visibly cracking. You inherited raw material here: real capacity for spiritual resilience that arrived bundled with an unexamined belief that struggle should stay hidden.`,
    ...
    '12_F': {
      ...
      why: `The Hanged Man sits in your Paternal Spiritual corner, marking a generational instruction about spiritual surrender and sacrifice — your father's line likely modeled a specific relationship to giving something up for faith, perhaps one that looked more like quiet martyrdom than genuine, chosen release. You inherited raw material here: a real capacity for spiritual surrender that arrived with an inherited belief about what that surrender is supposed to cost.`,
    ...
    '14_F': {
      ...
      why: `Temperance sits in your Paternal Spiritual corner, marking a generational instruction about spiritual moderation — your father's line likely modeled faith as measured, careful, avoiding extremes, which may have shaded into genuine emotional distance from spiritual intensity altogether. You inherited raw material here: a real capacity for balanced spiritual integration that arrived with an inherited caution against actually feeling anything too deeply.`,
    ...
    '15_F': {
      ...
      why: `The Devil sits in your Paternal Spiritual corner, marking a generational instruction about spiritual repression — your father's line likely held tension between faith and material or bodily desire, perhaps resolved through denial rather than genuine integration. You inherited raw material here: real spiritual depth that arrived bundled with an inherited belief that desire itself is spiritually dangerous.`,
    ...
    '16_F': {
      ...
      why: `The Tower sits in your Paternal Spiritual corner, marking a generational instruction shaped by real spiritual rupture — something in your father's line's faith likely underwent a genuine collapse or crisis that was never fully processed, leaving its aftershock to pass down instead of its resolution. You inherited raw material here: real capacity for spiritual clarity that arrived tangled with an unfinished upheaval.`,
    ...
    '17_F': {
      ...
      why: `The Star sits in your Paternal Spiritual corner, marking a generational instruction about hope itself — your father's line likely modeled a modest, guarded relationship to spiritual optimism, hope kept quiet rather than fully expressed, perhaps to protect against disappointment. You inherited raw material here: real capacity for spiritual renewal that arrived with an inherited caution against hoping too visibly.`,
    ...
    '18_F': {
      ...
      why: `The Moon sits in your Paternal Spiritual corner, marking a generational instruction shaped by unprocessed fear — something in your father's line's spiritual life likely carried real unease that was never directly faced, just quietly passed down as vague unease instead of a fear with a name. You inherited raw material here: real spiritual sensitivity that arrived tangled with an inherited, unnamed dread.`,
    ...
    '19_F': {
      ...
      why: `The Sun sits in your Paternal Spiritual corner, marking a generational instruction about joy in faith — your father's line likely modeled spirituality as a serious, weighty matter, with genuine delight or lightness treated as somehow beside the point. You inherited raw material here: real capacity for radiant, joyful faith that arrived with an inherited assumption that seriousness is what makes belief legitimate.`,
    ...
    '20_F': {
      ...
      why: `Judgement sits in your Paternal Spiritual corner, marking a generational instruction shaped by a postponed spiritual awakening — something in your father's line likely sensed a larger calling toward deeper faith or purpose and set it aside, whether from circumstance or fear. You inherited raw material here: a real capacity to answer that calling, passed down along with the fact that it was once left unaddressed.`,
    ...
    '21_F': {
      ...
      why: `The World sits in your Paternal Spiritual corner, marking a generational instruction shaped by unfinished spiritual completion — your father's line likely worked toward real spiritual wholeness or mastery but never quite arrived at it, the cycle interrupted before its natural end. You inherited raw material here: real capacity for genuine spiritual integration, passed down along with the incompleteness that came before you.`,
    ...
    '22_F': {
      ...
      why: `The Fool sits in your Paternal Spiritual corner, marking a generational instruction about spiritual risk — your father's line likely held real caution around unproven spiritual paths, favoring the tested and familiar over genuine leaps into the unknown. You inherited raw material here: real capacity for spiritual openness and trust that arrived with an inherited wariness of anything too new.`,
    ...
    '1_G': {
      ...
      why: `The Magician sits in your Maternal Spiritual corner, marking a generational transmission of quiet agency — women in your mother's line likely modeled real spiritual capability without ever framing it as such, simply moving through life with a kind of unspoken confidence that things could be willed into being. You inherited this as a felt sense rather than a taught lesson: capability transmitted through example, not explanation.`,
    ...
    '2_G': {
      ...
      why: `The High Priestess sits in your Maternal Spiritual corner, marking a generational transmission of intuitive knowing — women in your mother's line likely trusted their inner sense of things without needing external validation, moving through cycles of clarity and mystery as simply how knowing worked. You inherited this as an embodied trust: knowing that arrives without argument, modeled rather than explained.`,
    ...
    '3_G': {
      ...
      why: `The Empress sits in your Maternal Spiritual corner, marking a generational transmission of nurturing spiritual presence — women in your mother's line likely modeled a warm, generative relationship to faith or meaning, simply living it rather than teaching it directly. You inherited this as felt atmosphere: spiritual abundance transmitted through presence, not instruction.`,
    ...
    '4_G': {
      ...
      why: `The Emperor sits in your Maternal Spiritual corner, marking a generational transmission of quiet structural authority — women in your mother's line likely held real spiritual order and steadiness without ever asserting it loudly, maintaining structure through presence rather than proclamation. You inherited this as an unspoken model: authority that doesn't need to announce itself to be real.`,
    ...
    '5_G': {
      ...
      why: `The Hierophant sits in your Maternal Spiritual corner, marking a generational transmission of relational, informal wisdom — women in your mother's line likely passed down spiritual understanding through relationship and lived example rather than formal doctrine or codified teaching. You inherited this as embedded knowledge: wisdom you absorbed by proximity rather than instruction.`,
    ...
    '6_G': {
      ...
      why: `The Lovers sit in your Maternal Spiritual corner, marking a generational transmission of values shown through lived choice — women in your mother's line likely demonstrated their spiritual priorities through the relationships and commitments they actually made, rather than stating those values outright. You inherited this by watching: values transmitted through example rather than declaration.`,
    ...
    '7_G': {
      ...
      why: `The Chariot sits in your Maternal Spiritual corner, marking a generational transmission of quiet, sustained spiritual will — women in your mother's line likely kept a steady spiritual direction through real difficulty, modeling determination without drama. You inherited this as embodied endurance: forward motion transmitted through simply watching someone keep going.`,
    ...
    '8_G': {
      ...
      why: `Justice sits in your Maternal Spiritual corner, marking a generational transmission of embodied fairness — women in your mother's line likely lived by a clear internal moral compass without ever spelling it out, letting their consistent actions speak for the standard. You inherited this as felt conviction: a sense of right and wrong absorbed by watching, not by being told.`,
    ...
    '10_G': {
      ...
      why: `The Wheel of Fortune sits in your Maternal Spiritual corner, marking a generational transmission of cyclical resilience — women in your mother's line likely moved through real hardship and renewal without dramatizing either, modeling a quiet trust that difficult seasons pass. You inherited this as embodied patience: trust in cycles transmitted through simply watching someone endure and recover.`,
    ...
    '11_G': {
      ...
      why: `Strength sits in your Maternal Spiritual corner, marking a generational transmission of gentle endurance — women in your mother's line likely held real difficulty with a soft, embodied steadiness rather than hardened toughness, modeling a strength that never needed to look fierce to be real. You inherited this as felt permission: the sense that gentleness and real resilience aren't opposites.`,
    ...
    '12_G': {
      ...
      why: `The Hanged Man sits in your Maternal Spiritual corner, marking a generational transmission of receptive waiting — women in your mother's line likely modeled a genuine comfort with not having answers yet, letting understanding arrive in its own time rather than forcing it. You inherited this as embodied patience: the sense that suspension itself can be productive.`,
    ...
    '13_G': {
      ...
      why: `Transformation sits in your Maternal Spiritual corner, marking a generational transmission of quiet reinvention — women in your mother's line likely underwent real personal transformation without much fanfare, simply becoming who they needed to become as circumstances demanded. You inherited this as embodied permission: change transmitted through watching someone quietly become new.`,
    ...
    '14_G': {
      ...
      why: `Temperance sits in your Maternal Spiritual corner, marking a generational transmission of quiet integration — women in your mother's line likely held real contradictions (duty and desire, strength and softness) without ever treating them as a crisis, simply living the blend day to day. You inherited this as embodied ease: the sense that holding two true things at once doesn't require resolution, just steadiness.`,
    ...
    '15_G': {
      ...
      why: `The Devil sits in your Maternal Spiritual corner, marking a generational transmission of unspoken constraint — women in your mother's line likely carried real desire or material want that went largely unvoiced, modeling restraint around wanting rather than open acknowledgment of it. You inherited this as felt limitation: a sense of what's allowed to be wanted, absorbed without ever being explicitly taught.`,
    ...
    '16_G': {
      ...
      why: `The Tower sits in your Maternal Spiritual corner, marking a generational transmission of unprocessed rupture — something in your mother's line likely underwent a real spiritual or emotional collapse that was survived but never discussed, its aftershock passed down as atmosphere rather than story. You inherited this as unnamed residue: real capacity for clarity that arrived tangled with an inherited, silent upheaval.`,
    ...
    '17_G': {
      heading: `You Inherited a Belief That Spiritual Hope Has to Be Kept Modest`,
      why: `The Star sits in your Maternal Spiritual corner, marking a generational transmission of guarded hope — women in your mother's line likely carried real optimism kept close, quietly, rather than fully expressed, perhaps to protect against disappointment. You inherited this as felt caution: renewal transmitted alongside a hedge against hoping too visibly.`,
    ...
    '18_G': {
      ...
      why: `The Moon sits in your Maternal Spiritual corner, marking a generational transmission of deep emotional and intuitive life — women in your mother's line likely carried a rich, sometimes overwhelming inner world, felt more than discussed, modeled through mood and atmosphere rather than explanation. You inherited this as felt inheritance: sensitivity transmitted through emotional proximity, not instruction.`,
    ...
    '19_G': {
      ...
      why: `The Sun sits in your Maternal Spiritual corner, marking a generational transmission of genuine warmth — women in your mother's line likely radiated real vitality and joy simply through how they showed up, without needing to explain or perform it. You inherited this as felt permission: joy transmitted through presence, modeled as simply available rather than earned.`,
    ...
    '20_G': {
      ...
      why: `Judgement sits in your Maternal Spiritual corner, marking a generational transmission of a quiet, unspoken calling — women in your mother's line likely sensed a pull toward something larger than their circumstances allowed, a summons felt but rarely voiced or acted on fully. You inherited this as felt momentum: an awakening passed down along with its own quiet postponement.`,
    ...
    '21_G': {
      ...
      why: `The World sits in your Maternal Spiritual corner, marking a generational transmission of quiet wholeness — women in your mother's line likely carried a real, settled sense of being enough, demonstrated through simply living without constant striving rather than declared outright. You inherited this as felt permission: completeness modeled through presence, not proclaimed through achievement.`,
    ...
    '22_G': {
      ...
      why: `The Fool sits in your Maternal Spiritual corner, marking a generational transmission of quiet resilience through new beginnings — women in your mother's line likely faced real fresh starts, sometimes forced ones, with a kind of unspoken trust that beginning again was simply possible. You inherited this as embodied openness: the sense that starting over doesn't require fanfare or permission, just willingness.`,
    ...
    '1_H': {
      ...
      why: `The Magician sits in your Paternal Material corner, marking a generational instruction about resourcefulness — your father's line likely modeled real material initiative, an ability to generate opportunity or income through sheer will and resourcefulness. You inherited raw material here: genuine capacity to build from scratch, passed down as an assumed baseline rather than a taught skill.`,
    ...
    '2_H': {
      ...
      why: `The High Priestess sits in your Paternal Material corner, marking a generational instruction about private material discernment — your father's line likely made significant financial or practical decisions internally, without much outward deliberation or consultation. You inherited raw material here: real intuitive capacity for material judgment, passed down alongside an assumption that such decisions aren't discussed openly.`,
    ...
    '3_H': {
      ...
      why: `The Empress sits in your Paternal Material corner, marking a generational instruction about material generosity — your father's line likely equated genuine care with material provision, giving generously as the primary language of love. You inherited raw material here: real capacity for material abundance and generosity, passed down alongside an assumption that giving is the main way care gets shown.`,
    ...
    '4_H': {
      ...
      why: `The Emperor sits in your Paternal Material corner, marking a generational instruction about material authority and provision — your father's line likely modeled a very specific structure for what responsible providing looks like: a particular career shape, a particular relationship to control over resources. You inherited raw material here: real capacity for material leadership, passed down alongside a fairly rigid template for what that's supposed to look like.`,
    ...
    '5_H': {
      ...
      why: `The Hierophant sits in your Paternal Material corner, marking a generational instruction about proven material methods — your father's line likely passed down specific, concrete rules about work and money: what a stable career looks like, what counts as responsible spending, which paths are trustworthy. You inherited raw material here in its most literal form: an actual, specific rulebook about material life.`,
    ...
    '6_H': {
      ...
      why: `The Lovers sit in your Paternal Material corner, marking a generational instruction about values in material choices — your father's line likely held clear convictions about which kinds of work or material pursuits were genuinely worthwhile versus merely lucrative. You inherited raw material here: real capacity for values-driven material decisions, passed down alongside a specific, inherited definition of "worthwhile."`,
    ...
    '7_H': {
      ...
      why: `The Chariot sits in your Paternal Material corner, marking a generational instruction about disciplined material pursuit — your father's line likely modeled relentless forward motion toward material goals, real willpower applied to work and provision. You inherited raw material here: genuine capacity for material discipline, passed down alongside an assumption that stopping or resting is a kind of material failure.`,
    ...
    '8_H': {
      ...
      why: `Justice sits in your Paternal Material corner, marking a generational instruction about material fairness — your father's line likely held firm, specific beliefs about ethical work and honest dealing, a standard passed down as the correct way to handle money and resources. You inherited raw material here: real material integrity, alongside a specific, inherited version of what "fair" actually means.`,
    ...
    '9_H': {
      ...
      why: `The Hermit sits in your Paternal Material corner, marking a generational instruction about material self-reliance — your father's line likely modeled handling financial and practical matters independently, without much outward reliance on others. You inherited raw material here: real capacity for material self-sufficiency, passed down alongside an assumption that needing material help signals some kind of failure.`,
    ...
    '10_H': {
      ...
      why: `The Wheel of Fortune sits in your Paternal Material corner, marking a generational instruction about material fate — your father's line likely held a specific belief about how much genuine control a person has over their financial circumstances, whether trusting active effort or leaning toward material fatalism. You inherited raw material here: a real relationship to material timing, alongside an inherited answer to a question worth re-examining.`,
    ...
    '11_H': {
      ...
      why: `Strength sits in your Paternal Material corner, marking a generational instruction about material endurance — your father's line likely modeled providing through real hardship without visibly cracking, quiet fortitude as the expected response to financial pressure. You inherited raw material here: genuine capacity for material resilience, passed down alongside an assumption that struggle should stay hidden.`,
    ...
    '12_H': {
      ...
      why: `The Hanged Man sits in your Paternal Material corner, marking a generational instruction about material patience — your father's line likely modeled a willingness to hold off on conventional material moves, trusting a different timing than the expected path. You inherited raw material here: real capacity for material patience, passed down alongside a caution about whether that patience always resolved into actual action.`,
    ...
    '13_H': {
      ...
      why: `Transformation sits in your Paternal Material corner, marking a generational instruction about material reinvention — your father's line either modeled genuine willingness to release an outdated career or financial strategy for a better one, or clung hard to material identities well past their natural end. You inherited raw material here: a real relationship to material change, alongside whichever version of that pattern was actually modeled.`,
    ...
    '14_H': {
      ...
      why: `Temperance sits in your Paternal Material corner, marking a generational instruction about material balance — your father's line likely modeled careful moderation in work and money, avoiding material extremes in either direction. You inherited raw material here: real capacity for sustainable material balance, passed down alongside a caution against ever taking a bigger material risk.`,
    ...
    '15_H': {
      ...
      why: `The Devil sits in your Paternal Material corner, marking a generational instruction about material power — your father's line likely held real, sometimes uncomfortable dynamics around control, money, and leverage, whether wielding it heavily or being subject to someone else wielding it over them. You inherited raw material here: a real, honest understanding of material power, alongside whatever specific dynamic was actually modeled.`,
    ...
    '16_H': {
      ...
      why: `The Tower sits in your Paternal Material corner, marking a generational instruction shaped by real material rupture — your father's line likely underwent a genuine financial or practical collapse that was survived but never fully processed, its aftershock passed down instead of its resolution. You inherited raw material here: real capacity for material clarity, tangled with an unfinished upheaval.`,
    ...
    '17_H': {
      ...
      why: `The Star sits in your Paternal Material corner, marking a generational instruction about material hope — your father's line likely held modest, guarded material ambitions, hoping for security rather than fully allowing themselves to hope for abundance. You inherited raw material here: real capacity for genuine material renewal and hope, passed down alongside an inherited ceiling on how big that hope was allowed to be.`,
    ...
    '18_H': {
      ...
      why: `The Moon sits in your Paternal Material corner, marking a generational instruction shaped by unprocessed material fear — your father's line likely carried real financial anxiety that was never directly named or discussed, passed down as vague unease rather than a specific, addressable concern. You inherited raw material here: real material sensitivity, tangled with an inherited, unnamed dread.`,
    ...
    '19_H': {
      ...
      why: `The Sun sits in your Paternal Material corner, marking a generational instruction about material seriousness — your father's line likely treated financial and practical matters as weighty, effortful business, with genuine ease or delight around money treated as somehow inappropriate. You inherited raw material here: real capacity for a joyful, light relationship to material life, passed down alongside an inherited assumption that money has to be handled gravely.`,
    ...
    '20_H': {
      ...
      why: `Judgement sits in your Paternal Material corner, marking a generational instruction shaped by unclaimed material potential — your father's line likely sensed a bigger financial or professional possibility and, for whatever reason, didn't fully pursue it. You inherited raw material here: real capacity to answer that call, passed down alongside the fact that it was once left unaddressed.`,
    ...
    '22_H': {
      ...
      why: `The Fool sits in your Paternal Material corner, marking a generational instruction about material risk — your father's line likely held a specific comfort level with financial or practical risk-taking, whether cautious or bold, that got passed down as the assumed baseline. You inherited raw material here: a real relationship to material trust and risk, alongside an inherited calibration of what counts as "too much."`,
    ...
    '1_I': {
      ...
      why: `The Magician sits in your Maternal Material corner, marking a generational transmission of resourceful improvisation — women in your mother's line likely made real, tangible things happen with whatever was actually available, not waiting for ideal conditions. You inherited this as embodied capability: a felt sense that you can generate material results from modest means, modeled through action rather than explanation.`,
    ...
    '2_I': {
      ...
      why: `The High Priestess sits in your Maternal Material corner, marking a generational transmission of intuitive practical management — women in your mother's line likely managed household or material affairs through a felt sense of what was needed, often ahead of any obvious sign. You inherited this as embodied instinct: practical foresight transmitted through watching, not being taught explicitly.`,
    ...
    '3_I': {
      ...
      why: `The Empress sits in your Maternal Material corner, marking a generational transmission of material nurturing — women in your mother's line likely made sure practical needs were met for everyone around them, often quietly and without acknowledgment, as an unquestioned part of daily life. You inherited this as embodied duty: material care transmitted through consistent action.`,
    ...
    '4_I': {
      ...
      why: `The Emperor sits in your Maternal Material corner, marking a generational transmission of quiet material structure — women in your mother's line likely held the practical organization of the household or family's material life together, a real authority exercised without formal recognition. You inherited this as embodied responsibility: structural competence transmitted through simply watching someone keep things running.`,
    ...
    '5_I': {
      ...
      why: `The Hierophant sits in your Maternal Material corner, marking a generational transmission of informal practical wisdom — women in your mother's line likely passed down real, useful material skills through doing rather than teaching: how to stretch a budget, fix something, manage a household, absorbed by watching rather than instruction. You inherited this as embedded competence: practical knowledge transmitted through proximity.`,
    ...
    '6_I': {
      ...
      why: `The Lovers sit in your Maternal Material corner, marking a generational transmission of values-driven material priority — women in your mother's line likely made real, values-based choices about where limited resources actually went, demonstrating priorities through allocation rather than declaration. You inherited this by watching: a felt sense of what genuinely matters materially, transmitted through observed choice.`,
    ...
    '8_I': {
      ...
      why: `Justice sits in your Maternal Material corner, marking a generational transmission of careful material fairness — women in your mother's line likely managed limited resources with a real, consistent sense of equitable distribution, making sure everyone got their genuine share even when there wasn't much to go around. You inherited this as embodied conviction: a felt commitment to material fairness, transmitted through consistent practice.`,
    ...
    '9_I': {
      ...
      why: `The Hermit sits in your Maternal Material corner, marking a generational transmission of self-reliant material competence — women in your mother's line likely developed real, practical self-sufficiency, quietly handling material needs without much outside support because that was simply the reality they navigated. You inherited this as embodied capability: genuine practical independence, transmitted through demonstrated necessity.`,
    ...
    '10_I': {
      ...
      why: `The Wheel of Fortune sits in your Maternal Material corner, marking a generational transmission of material resilience — women in your mother's line likely weathered real financial or practical instability without being undone by it, adapting to each turn as it came. You inherited this as embodied adaptability: a felt capacity to navigate material change, transmitted through watching someone actually survive it.`,
    ...
    '11_I': {
      ...
      why: `Strength sits in your Maternal Material corner, marking a generational transmission of gentle material endurance — women in your mother's line likely held real financial or practical hardship with a soft, embodied steadiness rather than hardened toughness, modeling resilience that never needed to look fierce. You inherited this as felt permission: the sense that gentleness and material endurance aren't opposites.`,
    ...
    '12_I': {
      ...
      why: `The Hanged Man sits in your Maternal Material corner, marking a generational transmission of material patience — women in your mother's line likely endured real practical constraint with a kind of suspended waiting, trusting that circumstances would eventually shift even without a clear timeline. You inherited this as embodied endurance: patience with material limitation, transmitted through watching someone wait it out.`,
    ...
    '13_I': {
      ...
      why: `Transformation sits in your Maternal Material corner, marking a generational transmission of material rebuilding — women in your mother's line likely faced genuine material loss and found a way to reconstruct a practical life afterward, more than once if necessary. You inherited this as embodied resilience: real capacity for material reinvention, transmitted through watching someone actually survive and rebuild.`,
    ...
    '14_I': {
      ...
      why: `Temperance sits in your Maternal Material corner, marking a generational transmission of resourceful balance — women in your mother's line likely developed real skill at making limited material resources cover genuine needs, blending and stretching with patient, practical ingenuity. You inherited this as embodied competence: material balance transmitted through watching someone actually make it work.`,
    ...
    '15_I': {
      ...
      why: `The Devil sits in your Maternal Material corner, marking a generational transmission of material entanglement — women in your mother's line likely navigated real dependence, whether financial reliance on someone else or being relied upon in ways that felt binding, without much room to fully examine the dynamic. You inherited this as felt familiarity: a real, complicated relationship to material dependence, whichever direction it ran.`,
    ...
    '16_I': {
      ...
      why: `The Tower sits in your Maternal Material corner, marking a generational transmission of unprocessed material rupture — women in your mother's line likely survived a real financial or practical collapse that reshaped their circumstances, its story passed down as atmosphere rather than narrative. You inherited this as unnamed residue: real material resilience tangled with an inherited, unspoken upheaval.`,
    ...
    '17_I': {
      ...
      why: `The Star sits in your Maternal Material corner, marking a generational transmission of guarded material hope — women in your mother's line likely held real hope for practical improvement, expressed modestly rather than boldly, perhaps to protect against disappointment during genuinely hard circumstances. You inherited this as felt aspiration: material renewal transmitted alongside an inherited caution about hoping too visibly.`,
    ...
    '18_I': {
      ...
      why: `The Moon sits in your Maternal Material corner, marking a generational transmission of unprocessed material anxiety — women in your mother's line likely carried real financial or practical worry that was felt intensely but rarely discussed directly, transmitted as atmosphere rather than explanation. You inherited this as felt inheritance: material sensitivity tangled with an inherited, unnamed unease.`,
    ...
    '19_I': {
      ...
      why: `The Sun sits in your Maternal Material corner, marking a generational transmission of resilient warmth — women in your mother's line likely maintained real vitality and joy even through genuine material difficulty, modeling that hardship doesn't have to extinguish lightness. You inherited this as felt permission: the sense that material struggle and real joy can coexist.`,
    ...
    '20_I': {
      ...
      why: `Judgement sits in your Maternal Material corner, marking a generational transmission of unclaimed material potential — women in your mother's line likely sensed real practical or financial possibility that circumstances (time, resources, permission) never actually allowed them to pursue fully. You inherited this as felt momentum: material capability passed down alongside its own historical postponement.`,
    ...
    '21_I': {
      ...
      why: `The World sits in your Maternal Material corner, marking a generational transmission of material sufficiency — women in your mother's line likely found a real, settled sense of having enough, even within genuine practical constraint, modeling contentment as something achievable rather than dependent on abundance. You inherited this as felt permission: material wholeness that doesn't require excess to be real.`,
    ...
    '22_I': {
      ...
      why: `The Fool sits in your Maternal Material corner, marking a generational transmission of material risk-taking — women in your mother's line likely took genuine practical chances when circumstances demanded it, moving somewhere new, trying something unproven, trusting that a fresh material start was survivable. You inherited this as embodied courage: real material openness, transmitted through watching someone actually leap.`,
