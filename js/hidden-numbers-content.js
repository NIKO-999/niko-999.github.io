 ...
 *
 * `context` (new field) — one or two plain sentences naming the mechanism
 * (which letters, which count, which reduction) that produced this number.
 * Rendered in its own "WHAT THIS IS" section above MASTERY in
 * DestinyMatrix-v1.html, so `mastery` itself can stay entirely about the
 * person — no formula language, no "this card measures" framing. Mastery
 * was previously written with that explanatory sentence folded into its
 * opening line; this field is where it now lives instead.
 *
 * API:
 *   DHiddenPassionContent.get(num)   -> { title, context, mastery, shadow, invitation } or null
 *   DSubconsciousSelfContent.get(num)-> { title, context, mastery, shadow, invitation } or null
 *   DKarmicLessonContent.get(num)    -> { heading, text } or null (short, list-item form)
 *   DCornerstoneContent.get(num)     -> { title, context, mastery, shadow, invitation } or null
 *   DBridgeContent.get(num)          -> { title, context, mastery, shadow, invitation } or null
 *   DCapstoneContent.get(num)        -> { title, context, mastery, shadow, invitation } or null
 */
...
window.DHiddenPassionContent = (function () {
  const data = {
    1: {
      ...
      context: `One digit outnumbers every other letter in your name, unchosen, simply the shape your own name happens to take. Numerology reads that repetition as a natural talent, one so automatic it rarely registers as a skill at all.`,
      mastery: `Yours is the leadership number: you go first, consistently enough that it stopped registering as a trait and became the water you swim in. You step into direction-setting before anyone's assigned it to you, often without noticing you've done it. Starting something new rarely triggers the hesitation it triggers in other people, and you move into it anyway. You'd probably leave this off a list of your own strengths precisely because it's never once felt like effort. People around you learn to expect you'll be the one who moves first, long before you ever think to claim it as a quality.`,
    ...
    2: {
      ...
      context: `One digit dominates the letter count in your name, unchosen, simply how your own name is built. Numerology reads that dominance as a natural talent — tact and sensitivity running quietly on autopilot.`,
      mastery: `You feel the tension in a room before anyone's named it and defuse it before it becomes a problem. People say things to you they wouldn't say to anyone else, and you rarely register why. Conflict between two other people tends to resolve faster when you're simply present for it — a real, rare skill you'd likely rate as ordinary. You read what's unsaid as easily as what's said, and adjust accordingly without being asked to. That instinct is doing real work in rooms you don't even remember walking into carefully.`,
    ...
    3: {
      ...
      context: `One digit wins by a wide margin in your name's letters, an accident of spelling. Numerology reads that margin as a natural talent for expression — words, humor, presence.`,
      mastery: `A room tends to loosen up once you start talking, and you rarely clock the shift as something you caused. Making people laugh or feel something happens without a run-up. What you'd call "just messing around" is, more often than you think, actual craft. You read a room's mood and adjust your delivery to it almost without thinking, which is exactly what makes it look effortless. People remember the moment you said something more than they remember most of what else happened that day.`,
    ...
    4: {
      ...
      context: `One digit clearly leads in your name's letters, an accident of spelling. Numerology reads that lead as a natural talent for structure — sustaining unglamorous, patient effort for as long as it actually takes.`,
      mastery: `Routines and commitments hold for you the way they don't for most people around you. A long, tedious stretch of work rarely wears you down the way it wears down everyone else. You've probably never described yourself as disciplined, because discipline has never once felt like willpower to you — it's just default behavior. People assign you the parts of a project that require someone to actually still be there in month six, and you rarely notice that's a compliment. What looks like grit to everyone watching just feels, to you, like showing up.`,
    ...
    5: {
      ...
      context: `One digit clearly wins in your name's letters, a by-product of spelling, not choice. Numerology reads that as a natural talent for change — ease with the unfamiliar most people spend years trying to build.`,
      mastery: `New situations rarely rattle you the way they rattle the people around you. Uncertainty registers as interesting more often than it registers as threatening. You'd probably chalk this up to luck or temperament — it's neither. It's a real, developable skill running quietly on autopilot. People watching you walk calmly into something unfamiliar often assume you're simply unbothered, when really you're just already adapting.`,
    ...
    6: {
      ...
      context: `One digit clearly dominates in your name's letters, not chosen, just how your name happens to be built. Numerology reads that as a natural talent for care — an instinct for noticing what a person or space actually needs.`,
      mastery: `You notice what needs tending before anyone's had to ask. Looking after people takes less conscious effort from you than it visibly takes from almost everyone else. You'd probably call this "just how I am" — it's rarer than that framing gives it credit for. The small adjustments you make to keep a space or a person comfortable happen almost before you've decided to make them. People feel looked after around you without always being able to say exactly why.`,
    ...
    7: {
      ...
      context: `One digit clearly leads in your name's letters, an accident of spelling. Numerology reads that as a natural talent for depth — a mind that keeps going past the point where most people accept the first plausible explanation.`,
      mastery: `You reach real understanding of complicated things faster than most people you know, and rarely register the speed as unusual. Surface-level answers leave you visibly unsatisfied in a way they don't for most people. You'd probably describe this as "just how your brain works" — which is exactly why it's easy to undersell. The question you keep circling after everyone else has moved on is usually the one that actually mattered. People bring you the problem nobody else could fully make sense of, more often than you notice they're doing it.`,
    ...
    8: {
      ...
      context: `One digit clearly wins out in your name's letters, a fact of spelling. Numerology reads that as a natural talent for execution — turning ambition into something real and finished.`,
      mastery: `Responsibility lands on you and you handle it without the visible strain it costs most people. Following an ambitious plan all the way through rarely intimidates you the way it intimidates others. You'd probably describe this as "just getting things done" — which undersells exactly how rare it is. The gap between an idea and a finished result is where most people stall, and it's where you're actually most comfortable. People hand you the thing that has to actually happen, not just the thing that sounds good in a meeting.`,
    ...
    9: {
      ...
      context: `One digit clearly dominates in your name's letters, a fact of spelling, not choice. Numerology reads that as a natural talent for broad compassion — real feeling for people well outside your own immediate circle.`,
      mastery: `You feel for people you've never met more readily than most people manage. Causes larger than your own life tend to move you in a way that surprises people who don't know you well. You'd probably call this "just how you're wired" — which is precisely why it's easy to leave undeveloped. Suffering that's happening somewhere far away still registers for you as real, not abstract. That reach is rarer than it feels from the inside, since most people's compassion narrows sharply past their own doorstep.`,
...
window.DSubconsciousSelfContent = (function () {
  const data = {
    1: {
      ...
      context: `This card counts how many of the nine base numbers show up anywhere in your name at all — not what you want or how you appear, just what's present. A low count like yours means the toolkit is small but real.`,
      mastery: `Inside familiar territory, your decisiveness is genuinely striking — no hesitation, no second-guessing. What you do have, you use fully rather than half-heartedly. The handful of instincts you can trust, you trust completely, and it shows in how quickly you move once you recognize the situation. People watching you operate in your own territory rarely see any of the doubt that would slow someone with a wider, less-tested range. That sharpness is a real asset, not a smaller version of someone else's broader toolkit.`,
    ...
    2: {
      ...
      context: `This card counts how many of the nine base numbers show up anywhere in your name — not talent or desire, just presence. Your count sits on the lower side, leaving a compact set of instincts.`,
      mastery: `Routine pressure rarely throws you, and what you rely on, you rely on with real confidence. You tend to know exactly what you're capable of, without the second-guessing a wider, less-tested range can bring. Inside the territory you know, you move with a certainty that reads to other people as genuine competence, because it is. What you've built, you've built solidly, even if it isn't wide.`,
    ...
    3: {
      ...
      context: `This card is a raw count of how many of the nine base numbers actually appear in your name. Yours lands you a genuinely workable range.`,
      mastery: `You handle a fair spread of pressure without it costing you much, and a few specific gaps are probably already known to you. Knowing where those gaps sit is itself a form of competence most people never develop. You move through most ordinary situations without needing to improvise from nothing, drawing on instincts that are actually there rather than guessed at. That self-awareness about your own edges tends to make you more reliable, not less, since you rarely overpromise in territory you already know you haven't covered.`,
    ...
    4: {
      ...
      context: `This card is a raw tally of how many of the nine base numbers appear anywhere in your name — the raw material your composure is built from. Your count lands close to the middle.`,
      mastery: `Most everyday pressure meets a steadiness in you that feels earned rather than accidental. Rare extreme situations still test real edges, just edges further out than a narrower set would allow. That balance means you're rarely either overwhelmed or bored by what a normal day actually asks of you. You cover what actually comes up in an ordinary life without needing to stretch for it, and that dependability is something people around you notice and lean on.`,
    ...
    5: {
      ...
      context: `This card counts how many of the nine base numbers turn up anywhere in your name — not talent, not desire, just raw presence. Your count puts you solidly above the middle.`,
      mastery: `Both familiar and unfamiliar pressure tend to find you reasonably prepared, and genuine surprise happens to you less often than it happens to most people. That preparedness makes you a genuinely calming presence for the people around you in a crisis. You move through situations most people would find rattling with a steadiness that looks, from outside, like natural composure. People notice that almost nothing seems to catch you fully off guard, and they come to rely on that more than they say out loud.`,
    ...
    6: {
      ...
      context: `This card counts how many of the nine base numbers show up in your name at all — the actual raw material behind your composure. A count this high gives you a genuinely broad set of instincts.`,
      mastery: `Very little catches you fully unprepared. People lean on your steadiness specifically in the moments that would rattle most of them, and very different kinds of pressure tend to meet the same reliable footing in you. That breadth also means you can move between very different kinds of people and situations without having to fundamentally change who you are. You're the person other people bring the unpredictable problem to, precisely because so little actually rattles you.`,
    ...
    7: {
      ...
      context: `This card counts how many of the nine base numbers appear anywhere in your name — the raw inventory behind your composure. A count this high leaves you with a toolkit that's rich and nearly complete.`,
      mastery: `Genuine surprise becomes a rare event. Almost any situation, familiar or not, meets real preparation in you, and people notice how seldom you're caught with nothing to offer. That reputation for readiness is earned, built out of an unusually wide and well-tested set of instincts, not luck. People come to you first when something unfamiliar shows up, because they've learned, correctly, that you'll already have something useful to say about it.`,
    ...
    8: {
      ...
      context: `This card is a raw tally of how many of the nine base numbers appear anywhere in your name at all — and a count this high is genuinely rare. Almost every base instinct is present in you somewhere.`,
      mastery: `People come to you specifically because your composure holds when theirs doesn't, and genuine surprise is a rare event for you, not a common one. That depth of instinct is a genuine rarity, not something you should mistake for ordinary. Very little ground exists where you're operating with no reference point whatsoever, and it shows in how rarely you're actually stumped. What looks, from the outside, like effortless capability is really an unusually deep bench that took real living to build.`,
    ...
    9: {
      ...
      context: `This card measures how many of the nine base numbers appear anywhere in your name, and a count of 9 is the maximum the system allows. Every one of the base digits shows up somewhere in you.`,
      mastery: `There's no single instinct entirely absent from your makeup, only differences in how deeply each one has been developed. You rarely enter a situation with nothing at all to draw on, and people notice how consistently you land on your feet across genuinely different kinds of pressure. That completeness is genuinely rare, and it's worth naming as a real asset rather than treating it as ordinary. People trust you in situations they wouldn't trust almost anyone else in, because they've watched you find your footing in more or less everything already.`,
...
window.DCornerstoneContent = (function () {
  const data = {
    1: {
      ...
      context: `Every version of your name opens on the same letter — the one part of your own introduction you don't get to revise. Numerology reads that opening letter as your instinctive first move into anything new.`,
      mastery: `Yours is to lead: walk in, take the initiative, set the direction before anyone else has decided to. A new opportunity reads to you as an invitation, not a threat. You'd usually rather propose the plan than wait for someone else's version of it, and unfamiliar territory tends to bring out more confidence in you than caution. People watching you enter a new situation notice you moving before you've fully thought it through, simply because moving is how you think.`,
    ...
    2: {
      ...
      context: `The letter that opens your name has been fixed since before you had any say in it — the one unchangeable part of your own introduction. Numerology reads that opening letter as your instinctive first move into anything new.`,
      mastery: `Yours is to watch first: read the room, gather information, engage once you actually understand what you're stepping into. A new environment tends to get a quiet observation period from you before you fully join it. You'd rather understand the dynamics of a room than speak into it blind. That patience at the start usually means you enter with a more accurate read than people who spoke first, even if it takes you longer to say anything at all.`,
    ...
    3: {
      ...
      context: `Your name has opened on this same letter every time it's been written, unchosen and unchangeable. Numerology reads that opening letter as your instinctive first move into anything new.`,
      mastery: `Yours is to engage out loud: talk, connect, make an impression right at the start rather than hang back and observe. A new room tends to hear from you fairly quickly, rather than after a long silent stretch. Humor and warmth are your default tools for building rapport at the start of something, and sociability shows up early and easily for you. People remember you from the first conversation, before they've had time to see anything else about you.`,
    ...
    4: {
      ...
      context: `The letter your name opens on has never changed and never will — the one fixed piece of your own introduction. Numerology reads that opening letter as your instinctive first move into anything new.`,
      mastery: `Yours is to build a framework first: structure the approach before committing real momentum to it. A new project tends to get organized before it gets exciting. You're generally more comfortable beginning once there's at least a rough plan in place, and deliberateness, more than eagerness, tends to define how you start things. People handed a half-formed idea by you get something with actual bones already in it, not just enthusiasm.`,
    ...
    5: {
      ...
      context: `Your name has opened on the same letter every single time it's been written, a fact, not a choice. Numerology reads that opening letter as your instinctive first move into anything new.`,
      mastery: `Yours is to try it directly: dive in, adjust based on what you find, rather than planning it out extensively beforehand. A new opportunity tends to get an eager, hands-on response from you before it gets a plan. You learn a situation faster by touching it than by studying it, and enthusiasm, more than caution, defines your early moves. People notice you're already three steps into something while they're still deciding whether to start.`,
    ...
    6: {
      ...
      context: `Your name has opened on this same letter for as long as it's existed, unchosen and unchangeable. Numerology reads that opening letter as your instinctive first move into anything new.`,
      mastery: `Yours runs through the people it affects: who's involved, how a beginning will land on them, before you commit to it purely on your own terms. A new opportunity tends to get filtered through its impact on people close to you before you fully commit to it. Their needs often factor in earlier than your own do, and thoughtfulness, more than self-interest, shapes how you start things. People trust you with a new beginning precisely because you've already thought about what it means for them.`,
    ...
    7: {
      ...
      context: `The letter your name opens on has never once changed — the one fixed note of your own introduction. Numerology reads that opening letter as your instinctive first move into anything new.`,
      mastery: `Yours is to understand it first: resist committing until you've genuinely grasped what you're actually stepping into. A new opportunity gets real scrutiny from you before it gets your commitment. You ask more questions at the outset than most people think to ask, and thoughtfulness, more than speed, defines your early moves. What you finally commit to, you commit to with a clarity most people never bother to earn first.`,
    ...
    8: {
      ...
      context: `Your name has opened on this exact letter every time it's been written, a fact you inherited, not one you chose. Numerology reads that opening letter as your instinctive first move into anything new.`,
      mastery: `Yours runs through the stakes: what's actually at risk, materially and practically, before you commit real effort to it. A new opportunity gets weighed for tangible value before it gets your investment. You think in terms of return more than most people do at the outset, and seriousness, more than instinct, defines how you begin things. People notice you rarely start something you haven't already weighed carefully.`,
    ...
    9: {
      ...
      context: `The letter opening your name has been fixed for as long as your name has existed — the one unchosen constant of your own introduction. Numerology reads that opening letter as your instinctive first move into anything new.`,
      mastery: `Yours runs through scale: how a beginning connects to something larger than the immediate moment. A new opportunity gets weighed for its broader meaning before it gets your commitment. You ask how something fits a bigger picture more than most people think to at the start of a project, and idealism, more than pragmatism, shapes how you begin things. People sense, correctly, that whatever you're starting is in service of something bigger than the task in front of you.`,
...
window.DCapstoneContent = (function () {
  const data = {
    1: {
      ...
      context: `Every formal version of your name closes on the same letter — the last word your own name always gets, whether you notice it or not. Numerology reads that closing letter as how you actually follow through.`,
      mastery: `Yours is decisive: an ending is real to you once it's unmistakably owned, not diffused across a group. Clear, individual credit or responsibility matters to you once something's actually done. A finished result satisfies you more when it's unmistakably yours, and decisiveness tends to show up strongest right at the close of something, not the start. People know a project is actually over once you've said so, because your endings tend to stick.`,
    ...
    2: {
      ...
      context: `Your name closes on this exact letter every time it's written, fixed, not chosen. Numerology reads that closing letter as how you actually follow through.`,
      mastery: `Yours is collaborative: something isn't truly finished for you until everyone involved genuinely agrees it is. Explicit agreement matters to you before you'll call something done. An ending feels incomplete if someone involved still seems uneasy about it, and thoroughness about other people's input tends to show up strongest right at the close. People trust that when you call something finished, no one's been quietly left out of the decision.`,
    ...
    3: {
      ...
      context: `The final letter of your name has never changed — a fact your own name simply carries. Numerology reads that closing letter as how you actually follow through.`,
      mastery: `Yours wants to be felt: an ending that's visible, sometimes celebrated, not quietly folded away without acknowledgment. Some form of recognition matters to you once something's finished, even a small one. A quiet, unremarked ending tends to feel slightly hollow, and showmanship shows up naturally right at the close of things. People know something mattered to you by how much you make sure it's noticed on the way out.`,
    ...
    4: {
      ...
      context: `Your name closes on this same letter every time it's written, a permanent fact of it. Numerology reads that closing letter as how you actually follow through.`,
      mastery: `Yours is structural: something counts as finished only once it's genuinely durable, checked, and built to hold. Real assurance that something will hold up matters to you before you'll move on from it. Loose ends bother you more than they bother most people, and thoroughness tends to define your endings more than your beginnings. People handed something you finished rarely have to come back and ask you to fix it later.`,
    ...
    5: {
      ...
      context: `The last letter of your name has stayed the same every time it's been written, a fixed fact, not a preference. Numerology reads that closing letter as how you actually follow through.`,
      mastery: `Yours is fast: complete the essential work, then move, with little appetite for lingering. Restlessness tends to set in once a project's essentially wrapped. Lingering on something finished appeals to you less than starting the next thing, and momentum, more than closure, defines how your endings feel. People notice you're already onto the next thing before they've finished congratulating you on the last one.`,
    ...
    6: {
      ...
      context: `Your name has closed on this exact letter every time it's been written, fixed, not chosen. Numerology reads that closing letter as how you actually follow through.`,
      mastery: `Yours is relational: an ending isn't complete until the people affected by it are genuinely okay. Checking in on people matters to you once a situation is wrapping up, beyond the practical logistics. An ending feels incomplete if someone involved seems hurt or unsettled by it, and tenderness, more than efficiency, defines how you close things out. People remember that you were the one who circled back to make sure everyone was actually alright.`,
    ...
    7: {
      ...
      context: `Your name closes on the same letter every time it's written, a permanent fact, not a choice. Numerology reads that closing letter as how you actually follow through.`,
      mastery: `Yours is reflective: an ending isn't complete until you genuinely understand what happened and why. Processing a finished project fully matters to you before you'll consider it truly over. Endings tend to prompt real reflection in you, more than they do for most people, and depth, more than speed, defines how you close things out. People come to you afterward wanting to know what you actually learned from it, because you usually already know.`,
    ...
    8: {
      ...
      context: `The final letter of your name has never once changed — a fact it simply carries. Numerology reads that closing letter as how you actually follow through.`,
      mastery: `Yours is results-oriented: something's genuinely finished once there's a clear, measurable outcome to point to. Concrete proof of success matters to you before you'll call a project complete. Ambiguous outcomes unsettle you more than they unsettle most people, and rigor, more than sentiment, defines how you close things out. People trust your read on whether something actually worked, because you rarely call it done without real evidence.`,
    ...
    9: {
      ...
      context: `Your name has closed on this exact letter for as long as it's existed, a fact, not a preference. Numerology reads that closing letter as how you actually follow through.`,
      mastery: `Yours is legacy-minded: an ending matters for what it leaves behind, not just for the immediate result. The broader impact of a finished project tends to occupy you as much as its immediate outcome. Endings prompt you to consider what comes next for everyone involved, not only for you, and generosity, more than urgency, defines how you close things out. People notice that what you finish tends to keep helping others long after you've moved on from it.`,
...
window.DBridgeContent = (function () {
  const data = {
    0: {
      ...
      context: `Reduce the distance between your Life Path and your Expression number down to its simplest form, and for you it lands on zero — no gap at all. The number describing what your life is fundamentally about and the number describing how you naturally act turn out, after reduction, to be the same underlying number.`,
      mastery: `Your daily actions tend to already point toward your deeper purpose without you having to force the connection. People who know you well would probably describe your life as coherent, and you likely spend less energy than most people reconciling who you are with what you're doing. What you do on an ordinary Tuesday and what you'd say your life is actually about turn out, more often than not, to already be the same thing. That coherence is rare enough that most people would have to work for years to build even a fraction of it.`,
    ...
    1: {
      ...
      context: `Take the gap between your Life Path and your Expression number and reduce it, and for you it comes out to almost nothing — a gap of one. What your life is fundamentally about and how you naturally act sit close enough together that closing the remaining space rarely takes much conscious effort.`,
      mastery: `Your instinctive actions usually serve your deeper purpose without much translation required. Small course corrections, when they're needed, tend to come easily, and you probably don't think of yourself as someone who has to "work at" alignment. What you reach for by instinct and what you actually want your life to be about tend to already line up, more often than not. People who watch you make decisions rarely see the visible tension between purpose and impulse that shows up in most people's lives.`,
    ...
    2: {
      ...
      context: `Your Life Path and your Expression number, reduced down to their distance, and you land on two — a light, genuinely manageable gap between what your life is fundamentally about and how you naturally act.`,
      mastery: `You likely notice fairly quickly when your day-to-day actions have drifted from what actually matters to you, and correcting course doesn't usually take long. The gap shows up more as minor friction than real conflict, and most days, purpose and behavior cooperate without much negotiation. That light touch means the maintenance rarely feels like a burden, more like an occasional, easy adjustment. You catch yourself drifting before it's ever become a real problem, which most people only manage after real damage has already been done.`,
    ...
    3: {
      ...
      context: `Measure the distance between your Life Path and your Expression number and you get three — a real, noticeable gap between what your life is fundamentally about and how you naturally act.`,
      mastery: `It's not so wide that it defines your daily experience, but it's wide enough that the two don't automatically line up without you doing something about it. You likely feel a genuine pull in two directions sometimes, one toward what you know matters, one toward what actually comes naturally in the moment. Bridging the two usually takes a deliberate decision rather than an automatic one, and the effort is real but rarely overwhelming. You've gotten reasonably good at noticing which pull you're following in the moment, which is itself a skill most people never develop.`,
    ...
    5: {
      ...
      context: `Take the gap between your Life Path and your Expression number and reduce it and you get five — a wide gap between what your life is fundamentally about and how you naturally act.`,
      mastery: `Left alone, the two genuinely drift; closing the distance is real, ongoing work, not a one-time fix. You likely feel the pull between purpose and instinct fairly often, sometimes as real internal friction rather than mild inconvenience. Actions that come naturally to you don't automatically serve what you actually care about most, and bridging the two probably requires conscious, repeated choice. You've had more practice than most people at noticing the pull and choosing deliberately anyway, which is exactly the muscle this particular gap keeps asking you to use.`,
    ...
    6: {
      ...
      context: `Your Life Path and your Expression number, reduced down to their distance, and you land on six — a substantial gap between what your life is fundamentally about and how you naturally act.`,
      mastery: `The two aren't at war, but they clearly aren't the same conversation either, and bridging them takes real, deliberate architecture, not a quick patch. You likely experience a genuine split, at times, between what you know matters and what you actually reach for. Bridging the two tends to be effortful, ongoing work rather than an occasional correction. Every time you choose the harder, more aligned option over the automatic one, you're doing real work that most people's charts never actually ask of them.`,
    ...
    7: {
      ...
      context: `Measure the distance between your Life Path and your Expression number and you get seven — a deep gap between what your life is fundamentally about and how you naturally act.`,
      mastery: `This isn't a small misalignment; it's a genuine, structural distance that asks for real, ongoing attention if the two are ever going to cooperate reliably. You likely feel real tension, more often than not, between what you're instinctively drawn to do and what you know your life is actually about. Bridging them tends to require deliberate, sustained effort, not a single decision, but a practice. That you keep returning to the practice, even when it's genuinely hard, says more about your actual character than the size of the gap ever will.`,
    ...
    8: {
      ...
      context: `Reduce the distance between your Life Path and your Expression number and you land on eight — the widest gap this reduction can produce.`,
      mastery: `What your life is fundamentally about and how you naturally act sit about as far apart as this system allows, meaning the bridge between them has to be built consciously, deliberately, and more or less continuously. You likely experience a real, recurring split between instinct and purpose, actions that come easily rarely serve what you actually care about most without deliberate redirection. The upside is that the bridge, once built, tends to be unusually strong, precisely because it was never accidental. Few people are asked to do this much conscious construction work on their own life, and fewer still keep showing up for it the way you do.`,
