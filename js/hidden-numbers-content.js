...
window.DHiddenPassionContent = (function () {
  const data = {
    ...
    6: {
      ...
      shadow: `A gift this automatic tends to stay reactive instead of becoming something you consciously direct — real devotion, running on autopilot, doing good work that nobody, including you, is deliberately shaping. It can also mean you extend this care to people who never reciprocate it, simply because giving it costs you so little that you stop noticing the imbalance. Over time, that one-way pattern can quietly hollow out the relationships it was meant to strengthen. You may not notice the imbalance until you're already resentful, since it never once felt like a sacrifice while you were making it.`,
...
window.DCornerstoneContent = (function () {
  const data = {
    ...
    2: {
      ...
      shadow: `Observation mode can run past its usefulness, and a real opportunity can quietly close while you're still gathering information you already have enough of. Caution this early can also read to others as hesitation or disinterest, when it's actually just your particular form of care. Over time, watching from the edge that long can leave you feeling like a spectator in rooms you were fully entitled to join. The gathering itself can start to feel safer than the joining, even once you've genuinely gathered enough.`,
