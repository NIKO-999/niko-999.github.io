...
window.DSubconsciousSelfContent = (function () {
  const data = {
    ...
    4: {
      ...
      mastery: `This card is a raw tally of how many of the nine base numbers appear anywhere in your name — the raw material your composure is built from. Your count lands close to the middle: not narrow, not exhaustive, a genuinely dependable range covering what actually comes up most often in an ordinary life. Most everyday pressure meets a steadiness in you that feels earned rather than accidental, and the rare extreme situations still test real edges, just edges further out than a narrower set would allow. That balance means you're rarely either overwhelmed or bored by what a normal day actually asks of you.`,
    ...
    5: {
      ...
      mastery: `This card measures how many of the nine base numbers turn up anywhere in your name — not talent, not desire, just raw presence. Your count puts you solidly above the middle: a well-rounded set of instincts covering most of what life is likely to throw at you. Both familiar and unfamiliar pressure tend to find you reasonably prepared, and genuine surprise happens to you less often than it happens to most people. That preparedness makes you a genuinely calming presence for the people around you in a crisis.`,
    ...
    6: {
      ...
      mastery: `What this card counts is how many of the nine base numbers show up in your name at all — the actual raw material behind your composure. A count this high gives you a genuinely broad set of instincts, wide enough that very little catches you fully unprepared. People lean on your steadiness specifically in the moments that would rattle most of them, and very different kinds of pressure tend to meet the same reliable footing in you. That breadth also means you can move between very different kinds of people and situations without having to fundamentally change who you are.`,
    ...
    8: {
      ...
      mastery: `This card is a raw tally of how many of the nine base numbers appear anywhere in your name at all — and a count this high is genuinely rare. Almost every base instinct is present in you somewhere, leaving very little ground where you're operating with no reference point whatsoever. People come to you specifically because your composure holds when theirs doesn't, and genuine surprise is a rare event for you, not a common one. That depth of instinct is a genuine rarity, not something you should mistake for ordinary.`,
...
window.DBridgeContent = (function () {
  const data = {
    ...
    1: {
      ...
      mastery: `Take the gap between your Life Path and your Expression number and reduce it, and for you it comes out to almost nothing, a gap of one. What your life is fundamentally about and how you naturally act sit close enough together that closing the remaining space rarely takes much conscious effort. Your instinctive actions usually serve your deeper purpose without much translation required. Small course corrections, when they're needed, tend to come easily, and you probably don't think of yourself as someone who has to "work at" alignment.`,
    ...
    7: {
      ...
      mastery: `Measure the distance between your Life Path and your Expression number and you get seven, a deep gap between what your life is fundamentally about and how you naturally act. This isn't a small misalignment; it's a genuine, structural distance that asks for real, ongoing attention if the two are ever going to cooperate reliably. You likely feel real tension, more often than not, between what you're instinctively drawn to do and what you know your life is actually about. Bridging them tends to require deliberate, sustained effort, not a single decision, but a practice.`,
