...
window.DExpressionContent = (function () {
  const data = {
    ...
    8: {
      ...
      invitation: `Ask yourself, plainly, what you're afraid is true about you on a day with nothing measurable to show. Do one thing today for a reason that has nothing to do with the result it produces. Let it stay unmeasured. Notice that the day still counted.`,
    },
    9: {
    ...
    11: {
      ...
      invitation: `Notice honestly what you're afraid the built version would fail to live up to. Turn today's insight into one concrete step, however small. Build the imperfect version instead of waiting for the perfect one. Notice that grounding it doesn't kill the insight.`,
    },
    22: {
...
window.DSoulUrgeContent = (function () {
  const data = {
    ...
    3: {
      ...
      invitation: `Name, to yourself, what you're afraid would happen if you dropped the performance for a moment. Let the unpolished version of yourself show today, to at least one person. Don't cover it with a joke when it gets uncomfortable. Notice whether the room actually needed the polish.`,
    },
    4: {
    ...
    6: {
      ...
      invitation: `Sit for a moment with what you're afraid would happen if you stopped earning your place. Ask to be cared for today instead of only providing it. Let someone give without you repaying it. Notice that belonging doesn't disappear when you stop purchasing it.`,
    },
    7: {
    ...
    11: {
      ...
      invitation: `Ask yourself, plainly, what you're afraid happens if this insight isn't received right now. Share one insight today without needing it to land perfectly or immediately. Offer it once, then let it go. Notice that it can still matter even if it doesn't land on your timeline.`,
    },
    22: {
      ...
      invitation: `Notice honestly what you're afraid would happen if you declared something finished. Name what "enough" would specifically look like today, in concrete terms. Say the actual number or scale out loud. Notice how close you already are to it.`,
    },
    33: {
...
window.DPersonalityContent = (function () {
  const data = {
    1: {
      ...
      invitation: `Be honest with yourself about what you're afraid would happen if you showed uncertainty on purpose. Let one moment of genuine not-knowing show today, in a new interaction. Say "I'm not sure" instead of defaulting to certainty. Notice that the room doesn't reorganize away from you.`,
    },
    2: {
      ...
      invitation: `Name, to yourself, what you're afraid stating a firm opinion would cost you. Voice one clear opinion today, early, in a first conversation. Say it directly instead of softening it into a suggestion. Notice that firmness doesn't actually undo the ease people feel around you.`,
    },
    3: {
      ...
      invitation: `Sit for a moment with what you're afraid showing real depth would cost the charm. Let one serious thought show through the charm today, early in an interaction. Say it plainly instead of wrapping it in a joke. Notice that the depth adds to the pull instead of dimming it.`,
    },
    4: {
    ...
    5: {
      ...
      invitation: `Ask yourself, plainly, what you're afraid steadiness would cost your excitement. Mention one long-standing commitment in a first conversation today. Say it plainly, not as an aside. Notice that it doesn't dim how interesting you are.`,
    },
    6: {
      ...
      invitation: `Notice honestly what you're afraid stating a boundary early would cost the warmth. State one boundary today, early, in a new relationship. Say it plainly alongside the warmth, not instead of it. Notice that the boundary doesn't undo how cared for people feel.`,
    },
    7: {
      ...
      invitation: `Be honest with yourself about what you're afraid early warmth would cost its authenticity. Offer one small, genuine piece of yourself early in a new interaction today. Don't wait for the trust to be fully earned first. Notice that offering it early doesn't make it any less real.`,
    },
    8: {
      ...
      invitation: `Name, to yourself, what you're afraid softness would cost your command. Let a moment of genuine softness show in a first meeting today. Say it plainly instead of guarding it. Notice that softness doesn't actually undercut how capable you land.`,
    },
    9: {
      ...
      invitation: `Sit for a moment with what you're afraid showing discernment would cost your warmth. Name one clear-eyed, discerning observation about someone today, early in the interaction. Say it plainly alongside the openness. Notice that discernment doesn't actually undercut how generous you seem.`,
    },
    11: {
    ...
    22: {
      ...
      invitation: `Ask yourself, plainly, what you're afraid admitting a limit would cost your reputation. Admit one limit today, early, in a first conversation. Say it plainly instead of managing around it. Notice that the limit doesn't undo how capable you're seen to be.`,
    },
    33: {
      ...
      invitation: `Notice honestly what you're afraid naming a need early would cost the safety you offer. Name one thing you need in a first conversation today, not only offering care. Say it plainly alongside the care you give. Notice that it doesn't make people feel less safe with you.`,
    },
  };
  function get(num) { return data[num] || null; }
  return { get };
...
window.DMaturityContent = (function () {
  const data = {
    ...
    2: {
      ...
      invitation: `Be honest with yourself about what you're afraid stating a need would cost the balance you've built. State one need plainly this season instead of managing carefully around it. Say it directly, without hedging. Notice that the balance holds even when you're not the one absorbing everything.`,
    },
    3: {
      ...
      invitation: `Name, to yourself, what you're afraid the substance alone would fail to do without the charm. Share one serious piece of work this season without softening it into a joke. Let it stand exactly as it is. Notice that it holds up on its own.`,
    },
    4: {
      ...
      invitation: `Sit for a moment with what you're afraid one small change would actually open the door to. Change one plan this season without treating it as a defeat. Let it happen without defending against it. Notice that the stability holds even with the change absorbed.`,
    },
    5: {
    ...
    6: {
      ...
      invitation: `Ask yourself, plainly, what you're afraid releasing control would mean about your care. Release one thing this season you'd normally have managed out of love. Let it unfold without your intervention. Notice that your love holds without the management.`,
    },
    7: {
      ...
      invitation: `Notice honestly what you're afraid sharing this understanding would expose. Teach one thing you know this season instead of simply knowing it privately. Say it to someone who could use it. Notice that the depth survives being shared.`,
    },
    8: {
      ...
      invitation: `Be honest with yourself about what you're afraid an unproductive day would reveal about your worth. Count one thing this season as valuable that produced nothing measurable. Name it out loud as valuable anyway. Notice that your standing doesn't move.`,
    },
    9: {
      ...
      invitation: `Name, to yourself, what you're afraid keeping something for yourself would say about your generosity. Keep one thing this season purely for yourself. Don't give it away out of old habit. Notice that the generosity still counts.`,
    },
    11: {
      ...
      invitation: `Sit for a moment with what you're afraid the finished version would fail to live up to. Complete one inspired idea this season, start to finish. Let it be imperfect rather than staying purely conceptual. Notice that the finished version still carries the insight.`,
    },
    22: {
    ...
    33: {
      ...
      invitation: `Ask yourself, plainly, what you're afraid receiving care would say about the service you offer. Receive one act of care this season without deflecting it. Let it land instead of redirecting it outward. Notice that receiving doesn't undo the devotion.`,
    },
  };
  function get(num) { return data[num] || null; }
  return { get };
