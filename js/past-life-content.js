...
window.DPastLifeContent = (function () {
  ...
  const nodes = {
    ...
    7: {
      ...
      today: `This may show up today as a restlessness that persists even amid genuine accomplishment, or a familiar instinct to fill any pause with the next goal before the current one has been fully metabolized. It could also surface as real difficulty answering, honestly, what a given pursuit is actually for.`,
    },
    ...
    8: {
      ...
      today: `In the present, this may show up as a familiar instinct to grip tighter under pressure rather than to soften, or a pattern of handling difficulty alone even when support is genuinely available. It could also surface as a quiet discomfort with your own force, alongside real difficulty trusting that gentleness might work at least as well.`,
    },
    ...
    9: {
      ...
      today: `This may show up today as a strong pull toward solitude that occasionally tips past what feels restorative into something more like permanent withdrawal, or a familiar reluctance to share hard-won insight until it feels fully, perhaps excessively, refined.`,
    },
    ...
    10: {
      ...
      today: `In the present, this may show up as a felt familiarity with cycles — financial, relational, or otherwise — that seem to repeat with a certain rhythm, alongside a subtler discomfort with the steady, undramatic middle ground that doesn't offer either a clear win or a clear loss.`,
    },
    ...
    11: {
      ...
      today: `This may show up today as a familiar sharpness around perceived unfairness in the world, paired with a subtler blind spot about where a similar inconsistency might exist closer to home. It could also surface as situations that seem to mirror exactly the kind of imbalance you're most attuned to noticing.`,
    },
    ...
    12: {
      ...
      today: `In the present, this may show up as a familiar pattern of staying in unresolved situations well past the point where their lesson feels learned, or a quiet difficulty naming what you actually want rather than simply continuing to wait.`,
    },
    ...
    13: {
      ...
      today: `This may show up today as a familiar tendency to hold on to roles or relationships longer than feels sustainable, or the opposite pattern of leaving abruptly the moment something becomes uncomfortable, before it's actually run its course.`,
    },
    ...
    14: {
      ...
      today: `In the present, this may show up as a familiar cycle between periods of strict discipline and periods of full release, each one framed as the correction for the other, without either settling into something genuinely sustainable.`,
    },
    ...
    15: {
      ...
      today: `This may show up today as compulsive patterns — around control, comfort, or a particular relational dynamic — that register intellectually but haven't yet been looked at with much honesty. It could also surface as a familiar dynamic of either being controlled or quietly controlling someone else.`,
    },
    ...
    16: {
      ...
      today: `In the present, this may show up as a familiar pattern of sudden reversals that, in hindsight, had visible signals beforehand, or a subtler tendency to cling to structures you already suspect may not hold.`,
    },
    ...
    17: {
      ...
      today: `This may show up today as a familiar instinct to shrink right at the moment visibility becomes possible, or a pattern of real talent that stays underdeveloped so it can never be fully judged.`,
    },
    ...
    18: {
      ...
      today: `In the present, this may show up as convincing internal narratives that don't always hold up under closer examination, or a recurring, unsettled sense that something beneath the surface hasn't yet been fully faced.`,
    },
    ...
    19: {
      ...
      today: `This may show up today as an instinct to manage your own difficulty so it doesn't disturb the people around you, or a familiar gap between the version of you that shows up publicly and the one that exists in private.`,
    },
    ...
    20: {
      ...
      today: `In the present, this may show up as a familiar pattern of knowing exactly what needs to happen in a given situation and still finding reasons to delay, or a subtler impatience with other people's slowness to change that may echo your own history with the same hesitation.`,
    },
    ...
    21: {
      ...
      today: `This may show up today as a familiar pattern of nearly finishing things and then quietly extending or complicating them right before the natural end, or a real difficulty receiving acknowledgment for something genuinely accomplished.`,
    },
    ...
    22: {
      ...
      today: `In the present, this may show up as a familiar pull toward the next fresh start exactly when something asks you to stay and continue, or a recognizable pattern of many promising beginnings alongside comparatively few things carried all the way through.`,
    },
