...
window.DHiddenPassionContent = (function () {
  const data = {
    ...
    2: {
      ...
      shadow: `Something this instinctive is easy to leave undeveloped. You lean on raw sensitivity instead of sharpening it further, and a gift running purely on autopilot eventually stalls out below what deliberate practice could have made of it. It can also mean you absorb a room's tension as your job by default, without anyone asking, and quietly resent the position no one actually put you in. Over time, that unspoken duty can leave you drained in a way no one around you can quite see the source of.`,
    ...
    4: {
      ...
      shadow: `A capability this automatic rarely gets aimed anywhere on purpose. It runs quietly in the background instead of being pointed at something that would actually reward this much sustained attention. It can also mean you tolerate a joyless routine far longer than you should, mistaking mere consistency for actual progress. The steadiness itself never fails, so nothing ever forces you to ask whether it's actually taking you somewhere.`,
    ...
    5: {
      ...
      shadow: `Ease this consistent rarely gets refined further. It gets treated as personality rather than something worth deliberately sharpening, and a skill left on autopilot stalls exactly where it started. It can also mean you undersell your own steadiness in a crisis, assuming everyone finds it this easy when almost no one does. That mismatch can leave you genuinely confused when other people describe change as frightening.`,
    ...
    6: {
      ...
      shadow: `A gift this automatic tends to stay reactive instead of becoming something you consciously direct — real devotion, running on autopilot, doing good work that nobody, including you, is deliberately shaping. It can also mean you extend this care to people who never reciprocate it, simply because giving it costs you so little that you stop noticing the imbalance. Over time, that one-way pattern can quietly hollow out the relationships it was meant to strengthen.`,
...
window.DSubconsciousSelfContent = (function () {
  const data = {
    1: {
      ...
      shadow: `Step outside that familiar territory and the confidence thins out fast, sometimes faster than you'd expect from yourself. The danger of a small toolkit is being caught flat-footed the moment a situation asks for an instinct you simply never developed. It can read to others as inconsistency — decisive here, oddly lost there — when it's actually just the honest edge of a narrow set.`,
    ...
    7: {
      ...
      mastery: `This card counts how many of the nine base numbers appear anywhere in your name — the raw inventory behind your composure. A count this high leaves you with a toolkit that's rich and nearly complete: genuine surprise becomes a rare event. Almost any situation, familiar or not, meets real preparation in you, and people notice how seldom you're caught with nothing to offer.`,
      shadow: `Completeness this close to total invites its own quiet trap: an unspoken pressure to always have an answer, even in the rare moments you genuinely don't. That pressure can make the honest "I don't know" harder to say than it should be, for someone this capable.`,
    ...
    8: {
      ...
      mastery: `This card counts how many of the nine base numbers appear anywhere in your name at all — and a count this high is genuinely rare. Almost every base instinct is present in you somewhere, leaving very little ground where you're operating with no reference point whatsoever. People come to you specifically because your composure holds when theirs doesn't, and genuine surprise is a rare event for you, not a common one.`,
      shadow: `The risk of a toolkit this complete is that it can start to feel like actual invulnerability, which makes the rare moment it genuinely fails land far harder than it would for someone more used to hitting real limits. What looks like invulnerability from the outside is, mostly, just a very deep bench, not immunity.`,
...
window.DCornerstoneContent = (function () {
  const data = {
    ...
    2: {
      ...
      shadow: `Observation mode can run past its usefulness, and a real opportunity can quietly close while you're still gathering information you already have enough of. Caution this early can also read to others as hesitation or disinterest, when it's actually just your particular form of care.`,
    ...
    3: {
      ...
      shadow: `Talking before you've fully thought something through can mean making an impression before you actually understand what you've stepped into. It can also mean people form a first read of you based on charm alone, before they've seen the substance that's actually there underneath it.`,
    ...
    4: {
      ...
      shadow: `Planning can tip into stalling, with the plan itself quietly standing in for the actual start rather than preparing you for it. It can also mean you miss windows that reward speed over structure, because the plan simply wasn't finished yet when the moment actually opened.`,
    ...
    5: {
      ...
      shadow: `Jumping in without any real foundation can look like readiness when it's actually just eagerness, a distinction that tends to surface later than you'd want. It can also mean you abandon a genuinely promising start once the initial novelty wears off, before the real work has even begun.`,
    ...
    6: {
      ...
      shadow: `Consideration for others can quietly delay a beginning that was genuinely yours to make, deferring something good simply because it wasn't unanimously convenient. It can also mean you rarely find out what you'd choose if no one else's reaction were part of the calculation.`,
    ...
    7: {
      ...
      shadow: `Analysis can run past the point of usefulness, and a genuinely good opportunity can pass you by while you're still working to fully understand it. It can also mean you use the search for understanding as a socially acceptable reason to keep avoiding an actual decision.`,
    ...
    8: {
      ...
      shadow: `A sharp eye for stakes can quietly filter out something genuinely meaningful, simply because its payoff wasn't immediately obvious in material terms. It can also mean you delay starting things you actually want, waiting for a business case that some genuinely good beginnings will never provide.`,
    ...
    9: {
      ...
      shadow: `A focus this wide can miss the practical, immediate details right in front of you, a beginning beautifully framed and poorly grounded. It can also make ordinary, smaller-scale beginnings feel not worth your attention, even when they're exactly the ones that need it.`,
...
window.DCapstoneContent = (function () {
  const data = {
    ...
    2: {
      ...
      shadow: `Waiting for full agreement can mean never quite closing something out, because there's always one more approval left to gather before it counts as done. It can also hand real decision-making power to whichever person is slowest to sign off, simply because you won't finish without them.`,
    ...
    3: {
      ...
      shadow: `Wanting the bigger, more visible finish can delay the actual ending, or leave you frustrated when a genuinely good ending doesn't get the recognition you feel it earned. It can also mean you privately rank your endings by how much notice they got, rather than by what they actually accomplished.`,
    ...
    4: {
      ...
      shadow: `The pursuit of durability can mean never quite reaching an actual finish, because there's always one more detail that could theoretically be made more solid. It can also mean you hold a finished thing back from the people waiting on it, in service of a completeness only you can see the gap in.`,
      invitation: `Call one thing finished this week at "solid enough" instead of "perfectly certain." Ship it before the last check feels fully done. You are allowed to want durability and still accept a reasonable stopping point. Where has certainty-seeking kept something from ever being called done?`,
    },
    5: {
      ...
      shadow: `Moving fast can leave a project's less exciting final details unattended, technically done, but not actually finished. It can also mean you deny yourself the satisfaction of a completed thing, moving on before you've actually let it register as accomplished.`,
    ...
    6: {
      ...
      shadow: `Concern for how an ending lands can delay a needed one, prolonging something past its natural close just to soften the impact. It can also mean you absorb other people's discomfort about an ending as your own responsibility to manage, even when it genuinely isn't.`,
    ...
    7: {
      ...
      shadow: `Reflection can outlast the practical ending it was meant to process, analyzing something that's genuinely already done. It can also mean you keep revisiting a closed chapter privately long after everyone else has moved on, mistaking that rumination for necessary understanding.`,
    ...
    8: {
      ...
      shadow: `Needing a measurable result can mean discounting a genuinely meaningful ending simply because its value was harder to quantify. It can also mean you rush past the human side of a finish, the part that isn't on the scoreboard, in favor of the number that is.`,
    ...
    9: {
      ...
      shadow: `A focus this wide can miss the immediate, practical details right in front of you, an ending well-considered in theory, loose in the actual particulars. It can also delay a close that simply needed to happen now, while you weigh implications that were never actually yours to resolve.`,
...
window.DBridgeContent = (function () {
  const data = {
    ...
    1: {
      ...
      shadow: `A gap this small is easy to stop noticing entirely, and the one place it does show up can go unaddressed simply because it's too minor to seem worth the attention. Because the fit is so close, you may also assume it will always stay that way without checking, until the one thread finally pulls.`,
    ...
    2: {
      ...
      shadow: `A distance this manageable can be ignored precisely because it's manageable, letting small, repeated drift accumulate into something bigger than any single instance would suggest. Because each individual gap feels trivial, you may not notice the pattern until several of them have stacked up.`,
    ...
    3: {
      ...
      shadow: `A gap this size, left unattended, tends to widen slowly, small, repeated choices to act on impulse instead of purpose, each one small enough to excuse, until the distance is bigger than it started. Left long enough, it can start to feel like two competing versions of you rather than one person with a manageable gap.`,
    ...
    4: {
      ...
      shadow: `A gap this size, without ongoing attention, can settle into two separate tracks that stop actively talking to each other, a life that technically functions but has quietly split into a "what I want" side and a "what I do" side. That split can feel invisible from the inside, precisely because both tracks are still moving.`,
    ...
    5: {
      ...
      shadow: `Left unattended, a gap this wide tends to produce a life that looks active and busy on the surface while quietly drifting further from what actually matters underneath it. The busyness itself can become a cover, something that lets the drift go unnoticed because there's always visible activity to point to.`,
    ...
    6: {
      ...
      shadow: `A gap this size, without real attention, can produce a life that runs efficiently on autopilot while drifting steadily away from anything that would actually feel meaningful in hindsight. Instinctive action and deeper purpose can pull hard enough in different directions that ignoring the tension isn't really an option, even when it's tempting.`,
    ...
    7: {
      ...
      shadow: `Left unattended, a gap this deep tends to produce real internal conflict, a life that technically works but quietly feels like it's being lived by two different people taking turns. The two can feel like separate forces rather than a single coherent pull, which makes any single fix feel inadequate to the actual scale of the gap.`,
