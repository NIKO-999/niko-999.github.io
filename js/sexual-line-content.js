...
window.DSexualLineContent = (function () {
  ...
  const codes = {
    ...
    'Gentle Lovers': {
      ...
      path: `This may shift by noticing one moment reassurance is offered this week, and deliberately letting it land and stay, rather than seeking it again shortly after.`,
    },
    ...
    'Seekers of Perfection': {
      ...
      path: `This may shift by staying curious about one specific imperfection in a current connection this week, rather than filing it as proof the connection is wrong.`,
    },
    ...
    'Vengeful Dominators': {
      ...
      path: `This may shift by explicitly checking a partner's actual comfort before pursuing what you want, and letting their honest answer genuinely change your approach.`,
    },
    ...
    'Disillusioned Cynics': {
      ...
      path: `This may shift by choosing consistency over contrast in one interaction this week, even when the old instinct to unsettle things flares up.`,
    },
    ...
    'Rebellious Servants': {
      ...
      path: `This may shift by naming one preference of your own this week, and holding it even inside a relationship built around total accommodation.`,
    },
    ...
    'Forbidden Dreamers': {
      ...
      path: `This may shift by noticing one moment jealousy arises without real evidence, and voicing the underlying fear directly instead of acting to control the situation.`,
    },
    ...
    'Possessive Punishers': {
      ...
      path: `This may shift by asking directly the next time suspicion flares, and letting the honest answer — whatever it is — actually settle the moment.`,
    },
    ...
    'Detached Lovers': {
      ...
      path: `This may shift by letting one moment of genuine emotional stake show through this week, rather than the usual practiced distance.`,
    },
    ...
    'Versatile Lovers': {
      ...
      path: `This may shift by noticing one steady, unchanging part of a relationship this week, and letting it be enough without reaching to reinvent it.`,
    },
    ...
    'Vulnerable Rebels': {
      ...
      path: `This may shift by letting one piece of real vulnerability show to a partner this week, instead of meeting the moment with the usual toughened front.`,
    },
    ...
    'Aimless Lover': {
      ...
      path: `This may shift by naming, out loud, what you actually want from one current connection, rather than letting it remain undefined.`,
    },
    ...
    'Awakening Through Crisis': {
      ...
      path: `This may shift by bringing full, deliberate attention to one calm, uneventful moment with a partner this week, rather than waiting for drama to feel engaged.`,
    },
    ...
    'Pioneer of Desire': {
      ...
      path: `This may shift by bringing genuine curiosity to one familiar, routine moment with a partner, treating it as unexplored rather than already fully known.`,
    },
    ...
    'Masked Provocateurs': {
      ...
      path: `This may shift by letting the gap between the two selves narrow slightly with one trusted person, showing a little more of what's usually kept private.`,
    },
    ...
    'Magnetic Seducers': {
      ...
      path: `This may shift by choosing one connection and deliberately letting the ambiguity drop, offering clarity instead of continued pursuit.`,
    },
    ...
    'Nostalgics of the Past': {
      ...
      path: `This may shift by noticing one moment of comparing a current connection to a past one, and deliberately letting the present be judged only on its own terms.`,
    },
    ...
    'Nostalgic Visionaries': {
      ...
      path: `This may shift by naming one way a current connection is quietly being measured against an ideal, and choosing to meet the real version of it instead.`,
    },
    ...
    'Changeable Explorers': {
      ...
      path: `This may shift by deliberately looking for what's still unexplored in one already-familiar connection, rather than looking outward for something new.`,
    },
    ...
    'Unsatisfied Romantics': {
      ...
      path: `This may shift by choosing one existing connection and going deliberately deeper into it this week, rather than adding something new to the mix.`,
    },
    ...
    'Devoted Servants': {
      ...
      path: `This may shift by naming one of your own needs directly to a partner this week, rather than continuing to route all attention toward theirs.`,
    },
    ...
    'Lovers of Contrasts': {
      ...
      path: `This may shift by noticing one quality you usually seek in a contrasting partner, and practicing developing a small piece of it in yourself directly.`,
    },
    ...
    'Extreme Lovers': {
      ...
      path: `This may shift by choosing one moderate, undramatic act of closeness this week, and letting it be enough without needing to escalate it.`,
    },
    ...
    'Idealistic Revolutionaries': {
      ...
      path: `This may shift by staying close through one area of genuine difference in belief with a partner this week, rather than treating it as disqualifying.`,
    },
    ...
    'Cycle of the Past': {
      ...
      path: `This may shift by naming specifically which past pattern feels most familiar right now, and consciously choosing one different response to it this time.`,
    },
    ...
    'Disillusioned Hunter': {
      ...
      path: `This may shift by choosing one already-secured connection and deliberately investing in what comes after the chase, rather than looking for the next pursuit.`,
    },
