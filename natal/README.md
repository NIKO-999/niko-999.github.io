...
- **Chiron** comes from `js/chiron-data.js`, a table of yearly state vectors (1850–2150) produced by n-body integration and fitted to observed sign ingresses and a Swiss Ephemeris reference position (within ~2′ from 2001 to 2019). Positions between table years use Kepler propagation.
- **Houses**: Placidus, Koch, Regiomontanus, Porphyry, Equal and Whole Sign, including intercepted signs. Polar latitudes fall back to Porphyry.
- **Aspects**: major and minor, with orbs, applying/separating and a grid. Patterns detected: Grand Trine, T-Square, Grand Cross, Yod and stelliums.
