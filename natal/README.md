...
- **Progressions**: secondary progressions (angles by solar arc in right ascension), progressed aspects to the natal chart, the progressed lunation phase, a progressed Moon timeline, progressed Sun chapters and progressed stations.
- **Solar return**: the exact return moment for any year, at the birthplace or another city, with the return chart and yearly themes.
- **Synastry**: a bi-wheel, inter-aspects, house overlays both ways and compatibility scores for a second saved person.
