...
window.DTalentContent = (function () {
  ...
  const archetypes = {
    ...
    CREATIVITY_ART: {
      ...
      shadow: `Where this gets complicated is when you start needing the reaction more than you trust the work. You might notice yourself shrinking a piece to make it safer, more likely to land well, more predictably liked — trading the truth of it for approval. Visibility can start to feel like the whole point, instead of the natural result of expressing something real. If an audience keeps feeling lukewarm, it's worth checking whether the work itself got quietly softened somewhere along the way.`,
